...
const Do = 8205;
function cf(s, e, t = !0, i = !0) {
  return (t ? ga : ff)(s, e, i);
}
function ga(s, e, t) {
  if (e == s.length) return e;
  e && ya(s.charCodeAt(e)) && ba(s.charCodeAt(e - 1)) && e--;
  let i = xs(s, e);
  for (e += Bo(i); e < s.length; ) {
    let n = xs(s, e);
    if (i == Do || n == Do || t && hf(n))
      e += Bo(n), i = n;
    else if (To(n)) {
...
class H {
  ...
  */
  replace(e, t, i) {
    ...
    return this.decompose(
      ...
      1
      /* Open.From */
    ), Qe.from(n, this.length - (t - e) + i.length);
  }
  /**
  ...
  */
  eq(e) {
    ...
    if (e.length != this.length || e.lines != this.lines)
      return !1;
    let t = this.scanIdentical(e, 1), i = this.length - this.scanIdentical(e, -1), n = new xi(this), r = new xi(e);
    for (let o = t, l = t; ; ) {
  ...
  */
  static of(e) {
    ...
    return e.length == 1 && !e[0] ? H.empty : e.length <= 32 ? new _(e) : Qe.from(_.split(e, []));
  }
}
class _ extends H {
  ...
  lineInner(e, t, i, n) {
    for (let r = 0; ; r++) {
      ...
      if ((t ? i : l) >= e)
        return new df(n, l, i, o);
      n = l + 1, i++;
    }
  }
  decompose(e, t, i, n) {
    let r = e <= 0 && t >= this.length ? this : new _(Po(this.text, e, t), Math.min(t, this.length) - Math.max(0, e));
    if (n & 1) {
      let o = i.pop(), l = kn(r.text, o.text.slice(), 0, r.length);
      if (l.length <= 32)
  ...
  replace(e, t, i) {
    ...
    [e, t] = ti(this, e, t);
    let n = kn(this.text, kn(i.text, Po(this.text, 0, e)), t), r = this.length + i.length - (t - e);
    return n.length <= 32 ? new _(n, r) : Qe.from(_.split(n, []), r);
  }
...
`) {
  ...
  static split(e, t) {
    let i = [], n = -1;
    for (let r of e)
      i.push(r), n += r.length + 1, i.length == 32 && (t.push(new _(i, n)), i = [], n = -1);
    return n > -1 && t.push(new _(i, n)), t;
  }
}
class Qe extends H {
  constructor(e, t) {
      ...
      for (let n = 0, r = 0; n < this.children.length; n++) {
        ...
        if (e >= r && t <= l) {
          ...
          if (a.lines < h >> 4 && a.lines > h >> 6) {
            ...
            return c[n] = a, new Qe(c, this.length - (t - e) + i.length);
          }
    ...
    function f(d) {
      ...
      if (d.lines > r && d instanceof Qe)
        for (let m of d.children)
          f(m);
      else d.lines > o && (a > o || !a) ? (u(), l.push(d)) : d instanceof _ && a && (p = c[c.length - 1]) instanceof _ && d.lines + p.lines <= 32 ? (a += d.lines, h += d.length + 1, c[c.length - 1] = new _(p.text.concat(d.text), p.length + 1 + d.length)) : (a + d.lines > n && u(), a += d.lines, h += d.length + 1, c.push(d));
    }
    function u() {
...
class xi {
  ...
  nextInner(e, t) {
    for (this.done = this.lineBreak = !1; ; ) {
      let i = this.nodes.length - 1, n = this.nodes[i], r = this.offsets[i], o = r >> 1, l = n instanceof _ ? n.text.length : n.children.length;
      if (o == (t > 0 ? l : 0)) {
        if (i == 0)
...
typeof Symbol < "u" && (H.prototype[Symbol.iterator] = function() {
  return this.iter();
}, xi.prototype[Symbol.iterator] = xa.prototype[Symbol.iterator] = ka.prototype[Symbol.iterator] = function() {
  return this;
});
class df {
  /**
...
function ye(s, e) {
  let t = s.charCodeAt(e);
  if (!mf(t) || e + 1 == s.length)
    return t;
  let i = s.charCodeAt(e + 1);
  return pf(i) ? (t - 55296 << 10) + (i - 56320) + 65536 : t;
}
function zr(s) {
...
class ee extends tt {
  ...
  */
  apply(e) {
    ...
    return Xs(this, (t, i, n, r, o) => e = e.replace(n, n + (i - t), o), !1), e;
  }
  mapDesc(e, t = !1) {
  ...
  filter(e) {
    ...
    e: for (let o = 0, l = 0; ; ) {
      ...
      for (; l < a || l == a && r.len == 0; ) {
        ...
        he(t, c, f), f > 0 && pt(i, t, r.text), r.forward(c), l += c;
      }
      let h = e[o++];
      for (; l < h; ) {
        if (r.done)
        ...
        he(t, c, -1), he(n, c, r.ins == -1 ? -1 : r.off == 0 ? r.ins : 0), r.forward(c), l += c;
      }
    }
    return {
      changes: new ee(t, i),
  ...
  static of(e, t, i) {
    ...
    function h(c) {
      if (Array.isArray(c))
        ...
        if (f == u && m == 0)
          return;
        f < o && a(), f > o && he(n, f - o, -1), he(n, u - f, m), pt(r, n, p), o = u;
      }
    }
    return h(e), a(!l), l;
  }
    ...
    for (let n = 0; n < e.length; n++) {
      ...
      if (typeof r == "number")
        ...
        if (r.length == 1)
          ...
          for (; i.length < n; )
            i.push(H.empty);
          i[n] = H.of(r.slice(1)), t.push(r[0], i[n].length);
        }
      }
    }
    return new ee(t, i);
...
function Js(s, e, t, i = !1) {
  let n = [], r = i ? [] : null, o = new Mi(s), l = new Mi(e);
  for (let a = -1; ; ) {
    ...
    if (o.ins == -1 && l.ins == -1) {
      ...
      for (he(n, l.ins, -1); h; ) {
        ...
        o.ins >= 0 && a < o.i && o.len <= c && (he(n, 0, o.ins), r && pt(r, n, o.text), a = o.i), o.forward(c), h -= c;
      }
      l.next();
    } else if (o.ins >= 0) {
      let h = 0, c = o.len;
      for (; c; )
        if (l.ins == -1) {
          ...
          break;
      he(n, h, a < o.i ? o.ins : 0), r && a < o.i && pt(r, n, o.text), a = o.i, o.forward(o.len - c);
    } else {
      if (o.done && l.done)
        return r ? ee.createSet(n, r) : tt.create(n);
      throw new Error("Mismatched change set lengths");
    }
  }
}
function wa(s, e, t = !1) {
  let i = [], n = t ? [] : null, r = new Mi(s), o = new Mi(e);
  for (let l = !1; ; ) {
    if (r.done && o.done)
      return n ? ee.createSet(i, n) : tt.create(i);
    if (r.ins == 0)
      he(i, r.len, 0, l), r.next();
    else if (o.len == 0 && !o.done)
      he(i, 0, o.ins, l), n && pt(n, i, o.text), o.next();
    else {
      if (r.done || o.done)
        throw new Error("Mismatched change set lengths");
      {
        ...
        if (r.ins == -1) {
          ...
          he(i, a, c, l), n && c && pt(n, i, o.text);
        } else o.ins == -1 ? (he(i, r.off ? 0 : r.len, a, l), n && pt(n, i, r.textBit(a))) : (he(i, r.off ? 0 : r.len, o.off ? 0 : o.ins, l), n && !o.off && pt(n, i, o.text));
...
class Pt {
  ...
  */
  map(e, t = -1) {
    let i, n;
    return this.empty ? i = n = e.mapPos(this.from, t) : (i = e.mapPos(this.from, 1), n = e.mapPos(this.to, -1)), i == this.from && n == this.to ? this : new Pt(i, n, this.flags);
  }
  /**
...
class b {
  ...
  */
  static cursor(e, t = 0, i, n) {
    return Pt.create(e, e, (t == 0 ? 0 : t < 0 ? 8 : 16) | (i == null ? 7 : Math.min(6, i)) | (n ?? 16777215) << 6);
  }
  /**
  ...
  static normalized(e, t = 0) {
    ...
    for (let n = 1; n < e.length; n++) {
      ...
      if (r.empty ? r.from <= o.to : r.from < o.to) {
        ...
        n <= t && t--, e.splice(--n, 2, r.anchor > r.head ? b.range(a, l) : b.range(l, a));
      }
    }
    return new b(e, t);
  }
...
class T {
  constructor(e, t, i, n, r) {
    this.combine = e, this.compareInput = t, this.compare = i, this.isStatic = n, this.id = qr++, this.default = e([]), this.extensions = typeof r == "function" ? r(this) : r;
  }
  /**
...
class wn {
  constructor(e, t, i, n) {
    this.dependencies = e, this.facet = t, this.type = i, this.value = n, this.id = qr++;
  }
  dynamicSlot(e) {
    var t;
    ...
    return {
      ...
      update(f, u) {
        if (a && u.docChanged || h && (u.docChanged || u.selection) || Zs(f, c)) {
          let d = i(f);
          if (l ? !Ro(d, f.values[o], n) : !n(d, f.values[o]))
      ...
      reconfigure: (f, u) => {
        ...
        if (p != null) {
          let m = Bn(u, p);
          if (this.dependencies.every((g) => g instanceof T ? u.facet(g) === f.facet(g) : g instanceof ae ? u.field(g, !1) == f.field(g, !1) : !0) || (l ? Ro(d = i(f), m, n) : n(d = i(f), m)))
...
class ae {
  ...
  */
  static define(e) {
    let t = new ae(qr++, e.create, e.update, e.compare || ((i, n) => i === n), e);
  ...
  */
  slot(e) {
    ...
    return {
      ...
      reconfigure: (i, n) => {
        let r = i.facet(Yi), o = n.facet(Yi), l;
...
class Dn {
  ...
  static resolve(e, t, i) {
    ...
    for (let u of yf(e, t, o))
      u instanceof ae ? n.push(u) : (r[u.facet.id] || (r[u.facet.id] = [])).push(u);
    ...
    for (let u in r) {
      ...
      if (d.every(
        ...
        l[p.id] = h.length << 1, h.push((g) => gf(g, p, d));
      }
    }
    let f = h.map((u) => u(l));
...
function yf(s, e, t) {
  ...
  return r(s, Dt.default), i.reduce((o, l) => o.concat(l));
}
function ki(s, e) {
  if (e & 1)
    return 2;
...
const Ca = /* @__PURE__ */ T.define(), tr = /* @__PURE__ */ T.define({
  combine: (s) => s.some((e) => e),
  static: !0
}), Aa = /* @__PURE__ */ T.define({
  combine: (s) => s.length ? s[0] : void 0,
  static: !0
}), Ma = /* @__PURE__ */ T.define(), Oa = /* @__PURE__ */ T.define(), Ta = /* @__PURE__ */ T.define(), Da = /* @__PURE__ */ T.define({
...
function Ba(s, e, t) {
  var i;
  let n, r, o;
  return t ? (n = e.changes, r = ee.empty(e.changes.length), o = s.changes.compose(e.changes)) : (n = e.changes.map(s.changes), r = s.changes.mapDesc(e.changes, !0), o = s.changes.compose(n)), {
    changes: o,
    selection: e.selection ? e.selection.map(r) : (i = s.selection) === null || i === void 0 ? void 0 : i.map(n),
    effects: R.mapEffects(s.effects, n).concat(R.mapEffects(e.effects, r)),
...
function ir(s, e, t) {
  let i = e.selection, n = Qt(e.annotations);
  return e.userEvent && (n = n.concat(te.userEvent.of(e.userEvent))), {
    changes: e.changes instanceof ee ? e.changes : ee.of(e.changes || [], t, s.facet(Aa)),
...
function Pa(s, e, t) {
  let i = ir(s, e.length ? e[0] : {}, s.doc.length);
  e.length && e[0].filter === !1 && (t = !1);
  for (let r = 1; r < e.length; r++) {
    e[r].filter === !1 && (t = !1);
    let o = !!e[r].sequential;
    i = Ba(i, ir(s, e[r], o ? i.changes.newLength : s.doc.length), o);
  }
...
function wf(s) {
  ...
  if (t !== !0) {
    let n, r;
    if (t === !1)
      r = s.changes.invertedDesc, n = ee.empty(e.doc.length);
    else {
      let o = s.changes.filter(t);
      n = o.changes, r = o.filtered.mapDesc(o.changes).invertedDesc;
    }
    s = te.create(e, n, s.selection && s.selection.map(r), R.mapEffects(s.effects, r), s.annotations, s.scrollIntoView);
  }
  let i = e.facet(Oa);
  for (let n = i.length - 1; n >= 0; n--) {
    let r = i[n](s);
    r instanceof te ? s = r : Array.isArray(r) && r.length == 1 && r[0] instanceof te ? s = r[0] : s = Pa(e, Qt(r), !1);
  }
  return s;
}
function vf(s) {
  let e = s.startState, t = e.facet(Ta), i = s;
  for (let n = t.length - 1; n >= 0; n--) {
    let r = t[n](s);
    r && Object.keys(r).length && (i = Ba(i, ir(e, r, s.changes.newLength), !0));
  }
  return i == s ? s : te.create(e, s.changes, s.selection, i.effects, i.annotations, i.scrollIntoView);
}
const Sf = [];
function Qt(s) {
  return s == null ? Sf : Array.isArray(s) ? s : [s];
}
var Q = /* @__PURE__ */ (function(s) {
  return s[s.Word = 0] = "Word", s[s.Space = 1] = "Space", s[s.Other = 2] = "Other", s;
})(Q || (Q = {}));
const Cf = /[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/;
let nr;
try {
...
function Af(s) {
  ...
  for (let e = 0; e < s.length; e++) {
    let t = s[e];
    if (/\w/.test(t) || t > "" && (t.toUpperCase() != t.toLowerCase() || Cf.test(t)))
      return !0;
  }
  return !1;
}
...
class F {
  ...
  */
  applyTransaction(e) {
    ...
    for (let l of e.effects)
      l.is(ss.reconfigure) ? (t && (n = /* @__PURE__ */ new Map(), t.compartments.forEach((a, h) => n.set(h, a)), t = null), n.set(l.value.compartment, l.value.extension)) : l.is(R.reconfigure) ? (t = null, i = l.value) : l.is(R.appendConfig) && (t = null, i = Qt(i).concat(l.value));
    let r;
    t ? r = e.startState.values.slice() : (t = Dn.resolve(i, n, this), r = new F(t, this.doc, this.selection, t.dynamicSlots.map(() => null), (a, h) => h.reconfigure(a, this), null).values);
  ...
  */
  changeByRange(e) {
    let t = this.selection, i = e(t.ranges[0]), n = this.changes(i.changes), r = [i.range], o = Qt(i.effects);
    for (let l = 1; l < t.ranges.length; l++) {
      let a = e(t.ranges[l]), h = this.changes(a.changes), c = h.map(n);
      for (let u = 0; u < l; u++)
        r[u] = r[u].map(c);
      let f = n.mapDesc(h, !0);
      r.push(a.range.map(f)), n = n.compose(c), o = R.mapEffects(o, c).concat(R.mapEffects(Qt(a.effects), f));
    }
    return {
      changes: n,
  ...
  */
  toJSON(e) {
    ...
    if (e)
      for (let i in e) {
        let n = e[i];
        n instanceof ae && this.config.address[n.id] != null && (t[i] = n.spec.toJSON(this.field(e[i]), this));
      }
    return t;
  }
  /**
  ...
  */
  static create(e = {}) {
    let t = Dn.resolve(e.extensions || [], /* @__PURE__ */ new Map()), i = e.doc instanceof H ? e.doc : H.of((e.doc || "").split(t.staticFacet(F.lineSeparator) || _s)), n = e.selection ? e.selection instanceof b ? e.selection : b.single(e.selection.anchor, e.selection.head) : b.single(0);
    return va(n, i.length), t.staticFacet(tr) || (n = n.asSingle()), new F(t, i, n, t.dynamicSlots.map(() => null), (r, o) => o.create(r), null);
  }
  /**
...
F.languageData = Ca;
F.changeFilter = Ma;
F.transactionFilter = Oa;
F.transactionExtender = Ta;
...
class jr {
  ...
  map(e, t) {
    ...
    return { mapped: i.length ? new jr(n, r, i, l) : null, pos: o };
  }
}
class N {
  constructor(e, t, i, n) {
  ...
  */
  update(e) {
    ...
    let l = new La(this, null, -1).goto(0), a = 0, h = [], c = new ot();
    for (; l.value || a < t.length; )
      if (a < t.length && (l.from - t[a].from || l.startSide - t[a].value.startSide) >= 0) {
        let f = t[a++];
        c.addInner(f.from, f.to, f.value) || h.push(f);
      } else l.rangeIndex == 1 && l.chunkIndex < this.chunk.length && (a == t.length || this.chunkEnd(l.chunkIndex) < t[a].from) && (!o || n > this.chunkEnd(l.chunkIndex) || r < this.chunkPos[l.chunkIndex]) && c.addChunk(this.chunkPos[l.chunkIndex], this.chunk[l.chunkIndex]) ? l.nextChunk() : ((!o || n > l.to || r < l.from || o(l.from, l.to, l.value)) && (c.addInner(l.from, l.to, l.value) || h.push(sr.create(l.from, l.to, l.value))), l.next());
    return c.finishInner(this.nextLayer.isEmpty && !h.length ? N.empty : this.nextLayer.update({ add: h, filter: o, filterFrom: n, filterTo: r }));
  }
  /**
  ...
  */
  map(e) {
    ...
    return t.length == 0 ? r : new N(i, t, r || N.empty, n);
  }
  /**
  ...
  */
  static compare(e, t, i, n, r = -1) {
    ...
    i.iterGaps((f, u, d) => Eo(h, f, c, u, d, n)), i.empty && i.length == 0 && Eo(h, 0, c, 0, 0, n);
  }
  /**
  ...
  */
  static of(e, t = !1) {
    let i = new ot();
    for (let n of e instanceof sr ? [e] : t ? Of(e) : e)
  ...
  */
  static join(e) {
    ...
    for (let i = e.length - 2; i >= 0; i--)
      for (let n = e[i]; n != N.empty; n = n.nextLayer)
        t = new N(n.chunkPos, n.chunk, t, Math.max(n.maxPoint, t.maxPoint));
    return t;
  }
}
  ...
  static from(e, t = null, i = -1) {
    ...
    for (let r = 0; r < e.length; r++)
      for (let o = e[r]; !o.isEmpty; o = o.nextLayer)
        o.maxPoint >= i && n.push(new La(o, t, i, r));
    return n.length == 1 ? n[0] : new Oi(n);
  }
  get startSide() {
    return this.value ? this.value.startSide : 0;
  }
...
class fi {
  ...
  addActive(e) {
    ...
    for (; t < this.activeRank.length && (r - this.activeRank[t] || n - this.activeTo[t]) > 0; )
      t++;
    Xi(this.active, t, i), Xi(this.activeTo, t, n), Xi(this.activeRank, t, r), e && Xi(e, t, this.cursor.from), this.minActive = Io(this.active, this.activeTo);
  }
...
function Eo(s, e, t, i, n, r) {
  s.goto(e), t.goto(i);
  let o = i + n, l = i, a = i - e, h = !!r.boundChange;
  for (let c = !1; ; ) {
    let f = s.to + a - t.to, u = f || s.endSide - t.endSide, d = u < 0 ? s.to + a : t.to, p = Math.min(d, o);
    if (s.point || t.point ? (s.point && t.point && Kr(s.point, t.point) && or(s.activeForPoint(s.to), t.activeForPoint(t.to)) || r.comparePoint(l, p, s.point, t.point), c = !1) : (c && r.boundChange(l), p > l && !or(s.active, t.active) && r.compareRange(l, p, s.active, t.active), h && p < o && (f || s.openEnd(d) != t.openEnd(d)) && (c = !0)), d > o)
      break;
...
function li(s, e, t = s.length) {
  let i = 0;
  for (let n = 0; n < t && n < s.length; )
    s.charCodeAt(n) == 9 ? (i += e - i % e, n++) : (i++, n = ne(s, n));
  return i;
}
function lr(s, e, t, i) {
  for (let n = 0, r = 0; ; ) {
    ...
    if (n == s.length)
      break;
    r += s.charCodeAt(n) == 9 ? t - r % t : 1, n = ne(s, n);
  }
...
`);
  ...
  static mount(e, t, i) {
    let n = e[hr], r = i && i.nonce;
    n ? r && n.setNonce(r) : n = new Tf(e, r), n.mount(Array.isArray(t) ? t : [t], e);
  }
}
...
var kt = {
  ...
  221: "}",
  222: '"'
}, Df = typeof navigator < "u" && /Mac/.test(navigator.platform), Bf = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
for (var oe = 0; oe < 10; oe++) kt[48 + oe] = kt[96 + oe] = String(oe);
for (var oe = 1; oe <= 24; oe++) kt[oe + 111] = "F" + oe;
for (var oe = 65; oe <= 90; oe++)
  kt[oe] = String.fromCharCode(oe + 32), Ti[oe] = String.fromCharCode(oe);
for (var ws in kt) Ti.hasOwnProperty(ws) || (Ti[ws] = kt[ws]);
function Pf(s) {
  var e = Df && s.metaKey && s.shiftKey && !s.ctrlKey && !s.altKey || Bf && s.shiftKey && s.key && s.key.length == 1 || s.key == "Unidentified", t = !e && s.key || (s.shiftKey ? Ti : kt)[s.keyCode] || s.key || "Unidentified";
...
function q() {
  ...
  for (; e < arguments.length; e++) Ea(s, arguments[e]);
  return s;
}
function Ea(s, e) {
  if (typeof e == "string")
    ...
    for (var t = 0; t < e.length; t++) Ea(s, e[t]);
  else
...
const fr = /* @__PURE__ */ /Edge\/(\d+)/.exec(de.userAgent), Ia = /* @__PURE__ */ /MSIE \d/.test(de.userAgent), ur = /* @__PURE__ */ /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(de.userAgent), rs = !!(Ia || ur || fr), Ho = !rs && /* @__PURE__ */ /gecko\/(\d+)/i.test(de.userAgent), vs = !rs && /* @__PURE__ */ /Chrome\/(\d+)/.exec(de.userAgent), Rf = "webkitFontSmoothing" in cr.documentElement.style, dr = !rs && /* @__PURE__ */ /Apple Computer/.test(de.vendor), Vo = dr && (/* @__PURE__ */ /Mobile\/\w+/.test(de.userAgent) || de.maxTouchPoints > 2);
var O = {
  mac: Vo || /* @__PURE__ */ /Mac/.test(de.platform),
  windows: /* @__PURE__ */ /Win/.test(de.platform),
  linux: /* @__PURE__ */ /Linux|X11/.test(de.platform),
  ie: rs,
  ie_version: Ia ? cr.documentMode || 6 : ur ? +ur[1] : fr ? +fr[1] : 0,
  gecko: Ho,
  ...
  webkit_version: Rf ? +(/* @__PURE__ */ /\bAppleWebKit\/(\d+)/.exec(de.userAgent) || [0, 0])[1] : 0,
  safari: dr,
  ...
  */
  static replace(e) {
    ...
    if (e.isBlockGap)
      ...
      let { start: r, end: o } = Na(e, t);
      i = (r ? t ? -3e8 : -1 : 5e8) - 1, n = (o ? t ? 2e8 : 1 : -6e8) + 1;
    }
    return new Nt(e, i, n, t, e.widget || null, !0);
  }
  /**
...
class Nt extends B {
  constructor(e, t, i, n, r, o) {
    super(t, i, r, e), this.block = n, this.isReplace = o, this.mapMode = n ? t <= 0 ? pe.TrackBefore : pe.TrackAfter : pe.TrackDel;
  }
  ...
  eq(e) {
    return e instanceof Nt && If(this.widget, e.widget) && this.block == e.block && this.startSide == e.startSide && this.endSide == e.endSide;
  }
  range(e, t = e) {
...
function wi(s, e) {
  if (!e.anchorNode)
    return !1;
  try {
    return pr(s, e.anchorNode);
  } catch {
    return !1;
  }
}
function vn(s) {
  return s.nodeType == 3 ? Pi(s, 0, s.nodeValue.length).getClientRects() : s.nodeType == 1 ? s.getClientRects() : [];
}
function vi(s, e, t, i) {
  return t ? qo(s, e, t, i, -1) || qo(s, e, t, i, 1) : !1;
}
function wt(s) {
  for (var e = 0; ; e++)
  ...
  for (let c = s, f = !1; c && !f; )
    if (c.nodeType == 1) {
      ...
      if (n == "nearest")
        ...
        let x = e.bottom - e.top, k = u.bottom - u.top;
        y = (n == "center" && x <= k ? e.top + x / 2 - k / 2 : n == "start" || n == "center" && t < 0 ? e.top - o : e.bottom - k + o) - u.top;
      }
      if (i == "nearest" ? e.left < u.left ? (g = e.left - (u.left + r), t > 0 && e.right > u.right + g && (g = e.right - u.right + r)) : e.right > u.right && (g = e.right - u.right + r, t < 0 && e.left < u.left + g && (g = e.left - (u.left + r))) : g = (i == "center" ? e.left + (e.right - e.left) / 2 - (u.right - u.left) / 2 : i == "start" == l ? e.left - r : e.right - (u.right - u.left) + r) - u.left, g || y)
        if (d)
          ...
          if (y) {
            let M = c.scrollTop;
            c.scrollTop += y / m, k = (c.scrollTop - M) * m;
          }
          if (g) {
            let M = c.scrollLeft;
          ...
          e = {
            ...
            right: e.right - x,
            bottom: e.bottom - k
          }, x && Math.abs(x - g) < 1 && (i = "nearest"), k && Math.abs(k - y) < 1 && (n = "nearest");
        }
      if (d)
        break;
...
class We {
  ...
  static before(e, t) {
    return new We(e.parentNode, wt(e), t);
  }
  static after(e, t) {
    return new We(e.parentNode, wt(e) + 1, t);
  }
}
...
const qf = /* @__PURE__ */ qa("88888888888888888888888888888888888666888888787833333333337888888000000000000000000000000008888880000000000000000000000000088888888888888888888888888888888888887866668888088888663380888308888800000000000000000000000800000000000000000000000000000008"), $f = /* @__PURE__ */ qa("4444448826627288999999999992222222222222222222222222222222222222222222222229999999999999999999994444444444644222822222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222999999949999999229989999223333333333"), mr = /* @__PURE__ */ Object.create(null), Ke = [];
for (let s of ["()", "[]", "{}"]) {
  let e = /* @__PURE__ */ s.charCodeAt(0), t = /* @__PURE__ */ s.charCodeAt(1);
  mr[e] = t, mr[t] = -e;
}
function $a(s) {
  return s <= 247 ? qf[s] : 1424 <= s && s <= 1524 ? 2 : 1536 <= s && s <= 1785 ? $f[s - 1536] : 1774 <= s && s <= 2220 ? 4 : 8192 <= s && s <= 8204 ? 256 : 64336 <= s && s <= 65023 ? 4 : 1;
}
const Kf = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac\ufb50-\ufdff]/;
class Xe {
  /**
...
function Ka(s, e) {
  ...
  for (let t = 0; t < s.length; t++) {
    let i = s[t], n = e[t];
    if (i.from != n.from || i.to != n.to || i.direction != n.direction || !Ka(i.inner, n.inner))
      return !1;
  }
  return !0;
}
...
function Uf(s, e, t, i, n) {
  let r = n == 1 ? 2 : 1;
  for (let o = 0, l = 0, a = 0; o <= i.length; o++) {
    let h = o ? i[o - 1].to : e, c = o < i.length ? i[o].from : t;
    for (let f = h, u, d, p; f < c; f++)
      if (d = mr[u = s.charCodeAt(f)])
        if (d < 0) {
          for (let m = l - 3; m >= 0; m -= 3)
            if (Ke[m + 1] == -d) {
              let g = Ke[m + 2], y = g & 2 ? n : g & 4 ? g & 1 ? r : n : 0;
              y && (K[f] = K[Ke[m]] = y), l = m;
              break;
            }
        } else {
  ...
  for (let n = 0, r = i; n <= t.length; n++) {
    ...
    for (let a = o; a < l; ) {
      ...
      if (h == 256) {
        ...
        for (let p = c, m = n, g = m ? t[m - 1].to : s; p > a; )
          p == g && (p = t[--m].from, g = m ? t[m - 1].to : s), K[--p] = d;
        a = c;
      } else
        r = h, a++;
    }
...
function gr(s, e, t, i, n, r, o) {
  ...
  if (i % 2 == n % 2)
    for (let a = e, h = 0; a < t; ) {
      ...
      e: for (; ; )
        if (h < r.length && p == r[h].from) {
          ...
          if (h++, u)
            ...
            yr(s, g ? i + 1 : i, n, m.inner, m.from, m.to, o), a = m.to;
          }
          p = m.to;
        } else {
      ...
      u ? gr(s, a, p, i + 1, n, u, o) : a < p && o.push(new Xe(a, p, d)), a = p;
    }
  else
    for (let a = t, h = r.length; a > e; ) {
      ...
      e: for (; ; )
        if (h && p == r[h - 1].to) {
          ...
          if (u)
            ...
            let g = m.direction == Wt != !(d % 2);
            yr(s, g ? i + 1 : i, n, m.inner, m.from, m.to, o), a = m.from;
          }
          p = m.from;
        } else {
      ...
      u ? gr(s, p, a, i + 1, n, u, o) : p < a && o.push(new Xe(p, a, d)), a = p;
    }
}
function yr(s, e, t, i, n, r, o) {
  let l = e % 2 ? 2 : 1;
  jf(s, n, r, i, l), Uf(s, n, r, i, l), Gf(n, r, i, l), gr(s, n, r, e, t, i, o);
}
function Qf(s, e, t) {
  if (!s)
    return [new Xe(0, 0, e == Qr ? 1 : 0)];
  if (e == Wt && !t.length && !Kf.test(s))
    return ja(s.length);
  if (t.length)
    for (; s.length > K.length; )
      K[K.length] = 256;
  let i = [], n = e == Wt ? 0 : 1;
  return yr(s, n, n, t, 0, s.length, i), i;
}
function ja(s) {
  return [new Xe(0, s, 0)];
}
...
function Yf(s, e, t, i, n) {
  var r;
  let o = i.head - s.from, l = Xe.find(e, o, (r = i.bidiLevel) !== null && r !== void 0 ? r : -1, i.assoc), a = e[l], h = a.side(n, t);
  if (o == h) {
    let u = l += n ? 1 : -1;
    if (u < 0 || u >= e.length)
      return null;
  ...
  let c = ne(s.text, o, a.forward(n, t));
  (c < a.from || c > a.to) && (c = h), Ua = s.text.slice(Math.min(o, c), Math.max(o, c));
  let f = l == (n ? e.length - 1 : 0) ? null : e[l + (n ? 1 : -1)];
  return f && c == h && f.level + (n ? 0 : 1) < a.level ? b.cursor(f.side(!n, t) + s.from, f.forward(n, t) ? 1 : -1, f.level) : b.cursor(c + s.from, a.forward(n, t) ? -1 : 1, a.level);
}
function _f(s, e, t) {
  for (let i = e; i < t; i++) {
    let n = $a(s.charCodeAt(i));
    if (n == 1)
      return Wt;
    if (n == 2 || n == 4)
      return Qr;
...
const Ga = /* @__PURE__ */ T.define(), Qa = /* @__PURE__ */ T.define(), Ya = /* @__PURE__ */ T.define(), _a = /* @__PURE__ */ T.define(), br = /* @__PURE__ */ T.define(), Xa = /* @__PURE__ */ T.define(), Ja = /* @__PURE__ */ T.define(), Yr = /* @__PURE__ */ T.define(), _r = /* @__PURE__ */ T.define(), Za = /* @__PURE__ */ T.define({
  combine: (s) => s.some((e) => e)
}), eh = /* @__PURE__ */ T.define({
  combine: (s) => s.some((e) => e)
...
const Ji = /* @__PURE__ */ R.define({ map: (s, e) => s.map(e) }), ih = /* @__PURE__ */ R.define();
function me(s, e, t) {
  let i = s.facet(_a);
  i.length ? i[0](e) : window.onerror && window.onerror(String(e), t, void 0, void 0, e) || (t ? console.error(t + ":", e) : console.error(e));
}
const rt = /* @__PURE__ */ T.define({ combine: (s) => s.length ? s[0] : !0 });
let Xf = 0;
...
class J {
  constructor(e, t, i, n, r) {
    this.id = e, this.create = t, this.domEventHandlers = i, this.domEventObservers = n, this.baseExtensions = r(this), this.extension = this.baseExtensions.concat(Kt.of({ plugin: this, arg: void 0 }));
  }
  /**
  ...
  */
  static fromClass(e, t) {
    return J.define((i, n) => new e(i, n), t);
  }
}
class Ss {
  constructor(e) {
...
const nh = /* @__PURE__ */ T.define(), Xr = /* @__PURE__ */ T.define(), os = /* @__PURE__ */ T.define(), sh = /* @__PURE__ */ T.define(), Jr = /* @__PURE__ */ T.define(), $i = /* @__PURE__ */ T.define(), rh = /* @__PURE__ */ T.define();
function Ko(s, e) {
  let t = s.state.facet(rh);
  if (!t.length)
    return t;
  ...
  return N.spans(i, e.from, e.to, {
    ...
    span(r, o, l, a) {
      ...
      for (let u = l.length - 1; u >= 0; u--, a--) {
        ...
        if (d == null && (d = _f(e.text, h, c)), a > 0 && f.length && (p = f[f.length - 1]).to == h && p.direction == d)
          p.to = c, f = p.inner;
        else {
...
const oh = /* @__PURE__ */ T.define();
function Zr(s) {
  let e = 0, t = 0, i = 0, n = 0;
  for (let r of s.state.facet(oh)) {
    let o = r(s);
...
class En {
  constructor(e, t, i) {
    ...
    let n = [];
    this.changes.iterChangedRanges((r, o, l, a) => n.push(new Be(r, o, l, a))), this.changedRanges = n;
  }
  /**
  @internal
  */
...
class Z {
  ...
  domPosFor(e, t) {
    ...
    return new We(this.parent.dom, i + (n ? 1 : 0), e == 0 || e == this.length);
  }
  markDirty(e) {
...
class ii extends ls {
  ...
  static start(e, t, i) {
    let n = new ii(t || document.createElement("div"), e);
  ...
  resolveInline(e, t, i) {
    ...
    function a(c, f) {
      for (let u = 0, d = 0; u < c.children.length && d <= f; u++) {
        ...
        m >= f && (p.isComposite() ? a(p, f - d) : (!o || o.isHidden && (t > 0 || i && eu(o, p))) && (m > f || p.flags & 32) ? (o = p, l = f - d) : (d < f || p.flags & 16 && !p.isHidden) && (n = p, r = f - d)), d = m;
      }
    }
    a(this, e);
    let h = (t < 0 ? n : o) || n || o;
  ...
  coordsIn(e, t) {
    ...
    return i ? i.tile.coordsIn(Math.max(0, i.offset), t) : Zf(this);
  }
  domIn(e, t) {
    ...
    if (i) {
      ...
      if (this.dom.contains(n.dom))
        return n.isText() ? new We(n.dom, Math.min(n.dom.nodeValue.length, r)) : n.domPosFor(r, n.flags & 16 ? 1 : n.flags & 32 ? -1 : t);
...
class Rt extends Z {
  ...
  coordsIn(e, t) {
    ...
    e > i && (e = i);
    let n = e, r = e, o = 0;
    e == 0 && t < 0 || e == i && t >= 0 ? O.chrome || O.gecko || (e ? (n--, o = 1) : r < i && (r++, o = -1)) : t < 0 ? n-- : r < i && r++;
    let l = Pi(this.dom, n, r).getClientRects();
    if (!l.length)
      return null;
...
class Ft extends Z {
  ...
  static of(e, t, i, n, r) {
    return r || (r = e.toDOM(t), e.editable || (r.contentEditable = "false")), new Ft(r, i, e, n);
  }
}
class In extends Z {
  constructor(e) {
...
class nu {
  ...
  addText(e, t, i, n) {
    ...
    if (l && l.isText() && !(l.flags & 8) && l.length + e.length < 512) {
      ...
      o.append(n || Rt.of(e, (r = this.cache.find(Rt)) === null || r === void 0 ? void 0 : r.dom));
  ...
  addComposition(e, t) {
    ...
    for (let l = t.marks.length - 1; l >= 0; l--) {
      ...
      if (h instanceof xe && h.mark.eq(a.mark))
        h.dom != a.dom && h.setDOM(Cs(a.dom)), n = h;
      else {
  ...
  addLineStart(e, t) {
    var i;
    e || (e = lh);
    let n = ii.start(e, t || ((i = this.cache.find(ii)) === null || i === void 0 ? void 0 : i.dom), !!t);
  ...
  ensureMarks(e, t) {
    ...
    for (let r = e.length - 1; r >= 0; r--) {
      let o = e[r], l;
      if (t > 0 && (l = n.lastChild) && l instanceof xe && l.mark.eq(o))
        n = l, t--;
      else {
  ...
  updateBlockWrappers() {
    ...
    for (let e = this.blockWrappers; e.value && e.from <= this.pos; e.next())
      if (e.to >= this.pos) {
        let t = new iu(e.from, e.to, e.value, e.rank), i = this.wrappers.length;
...
class ou {
  constructor(e, t, i, n, r) {
    this.view = e, this.decorations = n, this.disallowBlockEffectsFor = r, this.openWidget = !1, this.openMarks = 0, this.cache = new ru(e), this.text = new su(e.state.doc), this.builder = new nu(this.cache, new as(e, e.contentDOM), N.iter(i)), this.cache.reused.set(
      t,
      2
      /* Reused.DOM */
    ), this.old = new tu(t), this.reuseWalker = {
      skip: (o, l, a) => {
  ...
  preserve(e, t, i) {
    let n = hu(this.old), r = this.openMarks;
  ...
  emit(e, t) {
    let i = null, n = this.builder, r = 0, o = N.spans(this.decorations, e, t, {
      point: (l, a, h, c, f, u) => {
        if (h instanceof Nt) {
          ...
          if (r = c.length, f > c.length)
            ...
            let d = h.widget || (h.block ? ni.block : ni.inline), p = lu(h), m = this.cache.findWidget(d, a - l, p) || Ft.of(d, this.view, a - l, p);
  ...
  getCompositionContext(e) {
    ...
    for (let n = e.parentNode; ; n = n.parentNode) {
      ...
      if (n == this.view.contentDOM)
        break;
      r instanceof xe ? t.push(r) : r != null && r.isLine() ? i = r : n.nodeName == "DIV" && !i && n != this.view.contentDOM ? i = new ii(n, lh) : t.push(xe.of(new zi({ tagName: n.nodeName.toLowerCase(), attributes: Ef(n) }), n));
    }
...
const lh = { class: "cm-line" };
function au(s, e) {
  let t = e.spec.attributes, i = e.spec.class;
  return !t && !i || (s || (s = { class: "cm-line" }), t && Ur(t, s), i && (s.class += " " + i)), s;
}
function hu(s) {
  let e = [];
...
const As = /* @__PURE__ */ new class extends ct {
  toDOM() {
...
class Go {
  ...
  update(e) {
    ...
    let n = -1;
    this.view.inputState.composing >= 0 && !this.view.observer.editContext && (!((t = this.domChanged) === null || t === void 0) && t.newSel ? n = this.domChanged.newSel.head : !bu(e.changes, this.hasComposition) && !e.selectionSet && (n = e.state.selection.main.head));
    let r = n > -1 ? fu(this.view, e.changes, n) : null;
    ...
    this.updateDeco();
    let a = pu(o, this.decorations, e.changes);
    a.length && (i = Be.extendWithRanges(i, a));
    let h = gu(l, this.blockWrappers, e.changes);
  ...
  updateInner(e, t) {
    ...
    i.ignore(() => {
      if (t || e.length) {
        let o = this.tile, l = new ou(this.view, o, this.blockWrappers, this.decorations, this.dynamicDecorationMap);
    ...
    if (this.view.viewport.from || this.view.viewport.to < this.view.state.doc.length)
      for (let r of this.tile.children)
        r.isWidget() && r.widget instanceof Ms && n.push(r.dom);
    i.updateGaps(n);
  }
  updateEditContextFormatting(e) {
    ...
    for (let t of e.transactions)
      for (let i of t.effects)
        i.is(ih) && (this.editContextFormatting = i.value);
  }
  // Sync the DOM selection to this.state.selection
  updateSelection(e = !1, t = !1) {
    (e || !this.view.observer.selectionRange.focusNode) && this.view.observer.readSelectionRange();
    let { dom: i } = this.tile, n = this.view.root.activeElement, r = n == i, o = !r && !(this.view.state.facet(rt) || i.tabIndex > -1) && wi(i, this.view.observer.selectionRange) && !(n && i.contains(n));
    if (!(r || t || o))
      return;
    let l = this.forceSelection;
    this.forceSelection = !1;
    let a = this.view.state.selection.main, h, c;
    if (a.empty ? c = h = this.inlineDOMNearPos(a.anchor, a.assoc || 1) : (c = this.inlineDOMNearPos(a.head, a.head == a.from ? 1 : -1), h = this.inlineDOMNearPos(a.anchor, a.anchor == a.from ? 1 : -1)), O.gecko && a.empty && !this.hasComposition && cu(h)) {
    ...
    (l || !f.focusNode || (!vi(h.node, h.offset, f.anchorNode, f.anchorOffset) || !vi(c.node, c.offset, f.focusNode, f.focusOffset)) && !this.suppressWidgetCursorChange(f, a)) && (this.view.observer.ignore(() => {
      O.android && O.chrome && i.contains(f.focusNode) && yu(f.focusNode, i) && (i.blur(), i.focus({ preventScroll: !0 }));
      let u = Bi(this.view.root);
      if (u) if (a.empty) {
        if (O.gecko) {
          let d = uu(h.node, h.offset);
          if (d && d != 3) {
            let p = (d == 1 ? Va : za)(h.node, h.offset);
  ...
  enforceCursorAssoc() {
    if (this.hasComposition)
      return;
    let { view: e } = this, t = e.state.selection.main, i = Bi(e.root), { anchorNode: n, anchorOffset: r } = e.observer.selectionRange;
  ...
  coordsAt(e, t) {
    let { tile: i, offset: n } = this.tile.resolveBlock(e, t);
    return i.isWidget() ? i.widget instanceof Ms ? null : i.coordsInWidget(n, t, !0) : i.coordsIn(n, t);
  }
  lineAt(e, t) {
  ...
  measureVisibleLineHeights(e) {
    let t = [], { from: i, to: n } = e, r = this.view.contentDOM.clientWidth, o = r > Math.max(this.view.scrollDOM.clientWidth, this.minWidth) + 1, l = -1, a = this.view.textDirection == j.LTR, h = 0, c = (f, u, d) => {
      for (let p = 0; p < f.children.length && !(u > n); p++) {
        let m = f.children[p], g = u + m.length, y = m.dom.getBoundingClientRect(), { height: x } = y;
        if (d && !p && (h += y.top - d.top), m instanceof gt)
          g > i && c(m, u, y);
        else if (u >= i && (h > 0 && t.push(-h), t.push(x + h), h = 0, o)) {
          let k = m.dom.lastChild, M = k ? vn(k) : [];
          if (M.length) {
            let w = M[M.length - 1], A = a ? w.right - y.left : y.right - w.left;
  ...
  updateDeco() {
    let e = 1, t = this.view.state.facet(os).map((r) => (this.dynamicDecorationMap[e++] = typeof r == "function") ? r(this.view) : r), i = !1, n = this.view.state.facet(Jr).map((r, o) => {
      let l = typeof r == "function";
      return l && (i = !0), l ? r(this.view) : r;
    });
    for (n.length && (this.dynamicDecorationMap[e++] = i, t.push(N.join(n))), this.decorations = [
    ...
    this.blockWrappers = this.view.state.facet(sh).map((r) => typeof r == "function" ? r(this.view) : r);
  }
  scrollIntoView(e) {
    if (e.isSnapshot) {
    ...
    Wf(this.view.scrollDOM, o, t.head < t.anchor ? -1 : 1, e.x, e.y, Math.max(Math.min(e.xMargin, l), -l), Math.max(Math.min(e.yMargin, a), -a), this.view.textDirection == j.LTR);
  }
  lineHasWidget(e) {
...
function ah(s, e) {
  ...
  if (!t.focusNode)
    return null;
  let i = Va(t.focusNode, t.focusOffset), n = za(t.focusNode, t.focusOffset), r = i || n;
...
function fu(s, e, t) {
  ...
  return { range: new Be(a.mapPos(r), a.mapPos(o), r, o), text: n };
}
function uu(s, e) {
...
function pu(s, e, t) {
  let i = new du();
  return N.compare(s, e, t, i), i.changes;
}
class mu {
  constructor() {
    this.changes = [];
...
function xu(s, e, t = 1) {
  ...
  let o = r, l = r;
  t < 0 ? o = ne(n.text, r, !1) : l = ne(n.text, r);
...
function ku(s, e, t, i, n) {
  ...
  return t.from + lr(o, r, s.state.tabSize);
}
function kr(s, e, t) {
  ...
  if (Array.isArray(i.type)) {
    ...
    for (let r of i.type) {
      ...
      if (!(r.to < e)) {
        if (r.from < e && r.to > e)
          return r;
        (!n || r.type == le.Text && (n.type != r.type || (t < 0 ? r.from < e : r.to > e))) && (n = r);
      }
    }
    return n || i;
  }
...
function wu(s, e, t, i) {
  let n = kr(s, e.head, e.assoc || -1), r = !i || n.type != le.Text || !(s.lineWrapping || n.widgetLineBreaks) ? null : s.coordsAtPos(e.assoc < 0 && e.head > n.from ? e.head - 1 : e.head);
  if (r) {
...
function Su(s, e, t, i) {
  ...
  let o = e.goalColumn, l, a = s.contentDOM.getBoundingClientRect(), h = s.coordsAtPos(n, (e.empty ? e.assoc : 0) || (t ? 1 : -1)), c = s.documentTop;
  if (h)
  ...
  let f = a.left + o, u = i ?? s.viewState.heightOracle.textHeight >> 1, d = wr(s, { x: f, y: l + u * r }, !1, r);
...
function Os(s, e, t) {
  let i = Si(s.state.facet($i).map((n) => n(s)), t.from, e.head > t.from ? -1 : 1);
...
function wr(s, e, t, i) {
  ...
  for (; ; ) {
    ...
    if (a > s.viewState.docHeight)
      return new _e(s.state.doc.length, -1);
  ...
  return (!c || c.length != h.length) && (c = s.docView.lineAt(h.from, -2)), new Cu(s, o, l, s.textDirectionAt(h.from)).scanTile(c, h.from);
}
class Cu {
  constructor(e, t, i, n) {
  ...
  baseDirAt(e, t) {
    ...
    return n[Xe.find(n, e - i.from, -1, t)].level == this.baseDir;
  }
  dirAt(e, t) {
    let { line: i, spans: n } = this.bidiSpansAt(e);
    return n[Xe.find(n, e - i.from, -1, t)].dir;
  }
  ...
  // will be child tiles.
  scan(e, t) {
    let i = 0, n = e.length - 1, r = /* @__PURE__ */ new Set(), o = this.bidiIn(e[0], e[n]), l, a, h = -1, c = 1e9, f;
    e: for (; i < n; ) {
      let d = n - i, p = i + n >> 1;
      t: if (r.has(p)) {
      ...
      if (m)
        for (let g = 0; g < m.length; g++) {
          ...
          if (y.bottom < this.y)
            ...
            let k = y.left > this.x ? this.x - y.left : y.right < this.x ? this.x - y.right : 0, M = Math.abs(k);
            M < c && (h = p, c = M, f = y), k && (x = k < 0 == (this.baseDir == j.LTR) ? -1 : 1);
          }
          x == -1 && (!o || this.baseDirAt(e[p], 1)) ? n = p : x == 1 && (!o || this.baseDirAt(e[p + 1], -1)) && (i = p + 1);
        }
    }
    if (!f) {
  ...
  scanText(e, t) {
    ...
    return n.after ? new _e(i[n.i + 1], -1) : new _e(i[n.i], 1);
  }
  scanTile(e, t) {
    if (!e.length)
      return new _e(t, 1);
    ...
    return r.isText() ? this.scanText(r, o) : r.isComposite() ? this.scanTile(r, o) : n.after ? new _e(i[n.i + 1], -1) : new _e(o, 1);
  }
}
const gi = "￿";
class Au {
  ...
  readRange(e, t) {
    ...
    for (let n = e; ; ) {
      ...
      this.readNode(n);
      let o = Z.get(n), l = n.nextSibling;
      if (l == t) {
        o != null && o.breakAfter && !l && i != this.view.contentDOM && this.lineBreak();
        break;
      }
      let a = Z.get(l);
      (o && a ? o.breakAfter : (o ? o.breakAfter : Rn(n)) || Rn(l) && (n.nodeName != "BR" || o != null && o.isWidget()) && this.text.length > r) && !Ou(l, t) && this.lineBreak(), n = l;
    }
  ...
  findPointInside(e, t) {
    for (let i of this.points)
      (e.nodeType == 3 ? i.node == e : e.contains(i.node)) && (i.pos = this.text.length + (Mu(e, i.node, i.offset) ? t : 0));
  }
}
function Mu(s, e, t) {
  for (; ; ) {
...
class Tu {
  constructor(e, t, i, n) {
    ...
    if (e.state.readOnly && t > -1)
      this.newSel = null;
    else if (t > -1 && (this.bounds = ch(e.docView.tile, t, i, 0))) {
      let l = r || o ? [] : Bu(e), a = new Au(l, e);
      a.readRange(this.bounds.startDOM, this.bounds.endDOM), this.text = a.text, this.newSel = Pu(l, this.bounds.from);
    } else {
...
function fh(s, e) {
  ...
  if (e.bounds) {
    ...
    (r === 8 || O.android && e.text.length < l - o) && (a = n.to, h = "end");
    let c = uh(s.state.doc.sliceString(o, l, gi), e.text, a - o, h);
    c && (O.chrome && r == 13 && c.toB == c.from + 2 && e.text.slice(c.from, c.toB) == gi + gi && c.toB--, t = {
      from: o + c.from,
      to: o + c.toA,
      insert: H.of(e.text.slice(c.from, c.toB).split(gi))
    });
  } else i && (!s.hasFocus && s.state.facet(rt) || Wn(i, n)) && (i = null);
  if (!t && !i)
    return !1;
  if (!t && e.typeOver && !n.empty && i && i.main.empty ? t = { from: n.from, to: n.to, insert: s.state.doc.slice(n.from, n.to) } : (O.mac || O.android) && t && t.from == t.to && t.from == n.head - 1 && /^\. ?$/.test(t.insert.toString()) && s.contentDOM.getAttribute("autocorrect") == "off" ? (i && t.insert.length == 2 && (i = b.single(i.main.anchor - 1, i.main.head - 1)), t = { from: t.from, to: t.to, insert: H.of([t.insert.toString().replace(".", " ")]) }) : t && t.from >= n.from && t.to <= n.to && (t.from != n.from || t.to != n.to) && n.to - n.from - (t.to - t.from) <= 4 ? t = {
    from: n.from,
    to: n.to,
    insert: s.state.doc.slice(n.from, t.from).append(t.insert).append(s.state.doc.slice(t.to, n.to))
  } : s.state.doc.lineAt(n.from).to < n.to && s.docView.lineHasWidget(n.to) && s.inputState.insertingTextAt > Date.now() - 50 ? t = {
    from: n.from,
    to: n.to,
    insert: s.state.toText(s.inputState.insertingText)
  } : O.chrome && t && t.from == t.to && t.from == n.head && t.insert.toString() == `
 ` && s.lineWrapping && (i && (i = b.single(i.main.anchor - 1, i.main.head - 1)), t = { from: n.from, to: n.to, insert: H.of([" "]) }), t)
    return eo(s, t, i, r);
  if (i && !Wn(i, n)) {
    let o = !1, l = "select";
    return s.inputState.lastSelectionTime > Date.now() - 50 && (s.inputState.lastSelectionOrigin == "select" && (o = !0), l = s.inputState.lastSelectionOrigin, l == "select.pointer" && (i = hh(s.state.facet($i).map((a) => a(s)), i))), s.dispatch({ selection: i, scrollIntoView: o, userEvent: l }), !0;
  } else
    return !1;
}
function eo(s, e, t, i = -1) {
  if (O.ios && s.inputState.flushIOSKey(e))
    return !0;
  let n = s.state.selection.main;
  if (O.android && (e.to == n.to && // GBoard will sometimes remove a space it just inserted
  // after a completion when you press enter
  (e.from == n.from || e.from == n.from - 1 && s.state.sliceDoc(e.from, n.from) == " ") && e.insert.length == 1 && e.insert.lines == 2 && _t(s.contentDOM, "Enter", 13) || (e.from == n.from - 1 && e.to == n.to && e.insert.length == 0 || i == 8 && e.insert.length < e.to - e.from && e.to > n.head) && _t(s.contentDOM, "Backspace", 8) || e.from == n.from && e.to == n.to + 1 && e.insert.length == 0 && _t(s.contentDOM, "Delete", 46)))
    return !0;
  let r = e.insert.toString();
  s.inputState.composing >= 0 && s.inputState.composing++;
  let o, l = () => o || (o = Du(s, e, t));
  return s.state.facet(Xa).some((a) => a(s, e.from, e.to, r, l)) || s.dispatch(l()), !0;
}
function Du(s, e, t) {
  let i, n = s.state, r = n.selection.main, o = -1;
  if (e.from == e.to && e.from < r.from || e.from > r.to) {
    let a = e.from < r.from ? -1 : 1, h = a < 0 ? r.from : r.to, c = Si(n.facet($i).map((f) => f(s)), h, a);
    e.from == c && (o = c);
  }
  if (o > -1)
    i = {
    ...
    if (n.selection.ranges.length > 1 && (s.inputState.composing >= 0 || s.inputState.compositionPendingChange) && e.to <= r.to + 10 && e.to >= r.to - 10) {
      let c = s.state.sliceDoc(e.from, e.to), f, u = t && ah(s, t.main.head);
      if (u) {
      ...
      i = n.changeByRange((p) => {
        ...
        m >= f.from && g <= f.to)
          return { range: p };
        let y = n.changes({ from: g, to: m, insert: e.insert }), x = p.to - r.to;
        return {
          changes: y,
...
function Bu(s) {
  ...
  return t && (e.push(new Yo(t, i)), (n != t || r != i) && e.push(new Yo(n, r))), e;
}
function Pu(s, e) {
  if (s.length == 0)
    return null;
...
class Ru {
  ...
  constructor(e) {
    this.view = e, this.lastKeyCode = 0, this.lastKeyTime = 0, this.lastTouchTime = 0, this.lastFocusTime = 0, this.lastScrollTop = 0, this.lastScrollLeft = 0, this.pendingIOSKey = void 0, this.tabFocusMode = -1, this.lastSelectionOrigin = null, this.lastSelectionTime = 0, this.lastContextMenu = 0, this.scrollHandlers = [], this.handlers = /* @__PURE__ */ Object.create(null), this.composing = -1, this.compositionFirstChange = null, this.compositionEndedAt = 0, this.compositionPendingKey = !1, this.compositionPendingChange = !1, this.insertingText = "", this.insertingTextAt = 0, this.mouseSelection = null, this.draggedContent = null, this.handleEvent = this.handleEvent.bind(this), this.notifiedFocused = e.hasFocus, O.safari && e.contentDOM.addEventListener("input", () => null), O.gecko && Gu(e.contentDOM.ownerDocument);
  }
  handleEvent(e) {
  ...
  ensureHandlers(e) {
    let t = Lu(e), i = this.handlers, n = this.view.contentDOM;
    for (let r in t)
      if (r != "scroll") {
  ...
  keydown(e) {
    if (this.lastKeyCode = e.keyCode, this.lastKeyTime = Date.now(), e.keyCode == 9 && this.tabFocusMode > -1 && (!this.tabFocusMode || Date.now() <= this.tabFocusMode))
      return !0;
    if (this.tabFocusMode > 0 && e.keyCode != 27 && ph.indexOf(e.keyCode) < 0 && (this.tabFocusMode = -1), O.android && O.chrome && !e.synthetic && (e.keyCode == 13 || e.keyCode == 8))
      return this.view.observer.delayAndroidKey(e.key, e.keyCode), !0;
    let t;
    return O.ios && !e.synthetic && !e.altKey && !e.metaKey && ((t = dh.find((i) => i.keyCode == e.keyCode)) && !e.ctrlKey || Eu.indexOf(e.key) > -1 && e.ctrlKey && !e.shiftKey) ? (this.pendingIOSKey = t || e, setTimeout(() => this.flushIOSKey(), 250), !0) : (e.keyCode != 229 && this.view.observer.forceFlush(), !1);
  }
  flushIOSKey(e) {
...
], Eu = "dthko", ph = [16, 17, 18, 20, 91, 92, 224, 225], Zi = 6;
function en(s) {
...
class Nu {
  constructor(e, t, i, n) {
    this.view = e, this.startEvent = t, this.style = i, this.mustSelect = n, this.scrollSpeed = { x: 0, y: 0 }, this.scrolling = -1, this.lastEvent = t, this.scrollParents = Ff(e.contentDOM), this.atoms = e.state.facet($i).map((o) => o(e));
    let r = e.contentDOM.ownerDocument;
    r.addEventListener("mousemove", this.move = this.move.bind(this)), r.addEventListener("mouseup", this.up = this.up.bind(this)), this.extend = t.shiftKey, this.multiple = e.state.facet(F.allowMultipleSelections) && Wu(e, t), this.dragging = Hu(e, t) && yh(t) == 1 ? null : !1;
  }
  start(e) {
  ...
  move(e) {
    if (e.buttons == 0)
      return this.destroy();
    if (this.dragging || this.dragging == null && Iu(this.startEvent, e) < 10)
      return;
    ...
    let a = Zr(this.view);
    e.clientX - a.left <= n + Zi ? t = -en(n - e.clientX) : e.clientX + a.right >= o - Zi && (t = en(e.clientX - o)), e.clientY - a.top <= r + Zi ? i = -en(r - e.clientY) : e.clientY + a.bottom >= l - Zi && (i = en(e.clientY - l)), this.setScrollSpeed(t, i);
  }
  up(e) {
  ...
  select(e) {
    let { view: t } = this, i = hh(this.atoms, this.style.get(e, this.extend, this.multiple));
...
const He = /* @__PURE__ */ Object.create(null), Ee = /* @__PURE__ */ Object.create(null), mh = O.ie && O.ie_version < 15 || O.ios && O.webkit_version < 604;
function zu(s) {
...
He.keydown = (s, e) => (s.inputState.setSelectionOrigin("select"), e.keyCode == 27 && s.inputState.tabFocusMode != 0 && (s.inputState.tabFocusMode = Date.now() + 2e3), !1);
Ee.touchstart = (s, e) => {
...
He.mousedown = (s, e) => {
  if (s.observer.flush(), s.inputState.lastTouchTime > Date.now() - 2e3)
    return !1;
  let t = null;
  for (let i of s.state.facet(Ya))
    if (t = i(s, e), t)
      break;
  if (!t && e.button == 0 && (t = $u(s, e)), t) {
    let i = !s.hasFocus;
    s.inputState.startMouseSelection(new Nu(s, e, t, i)), i && s.observer.ignore(() => {
      Fa(s.contentDOM);
...
const qu = O.ie && O.ie_version <= 11;
let Jo = null, Zo = 0, el = 0;
function yh(s) {
  if (!qu)
    return s.detail;
  let e = Jo, t = el;
  return Jo = s, el = Date.now(), Zo = !e || t > Date.now() - 400 && Math.abs(e.clientX - s.clientX) < 2 && Math.abs(e.clientY - s.clientY) < 2 ? (Zo + 1) % 3 : 1;
}
function $u(s, e) {
  let t = s.posAndSideAtCoords({ x: e.clientX, y: e.clientY }, !1), i = yh(e), n = s.state.selection;
  return {
    update(r) {
      r.docChanged && (t.pos = r.changes.mapPos(t.pos), n = n.map(r.changes));
    },
    get(r, o, l) {
      let a = s.posAndSideAtCoords({ x: r.clientX, y: r.clientY }, !1), h, c = Xo(s, a.pos, a.assoc, i);
      if (t.pos != a.pos && !o) {
        let f = Xo(s, t.pos, t.assoc, i), u = Math.min(f.from, c.from), d = Math.max(f.to, c.to);
        c = u < c.from ? b.range(u, d) : b.range(d, u);
      }
      return o ? n.replaceRange(n.main.extend(c.from, c.to)) : l && i == 1 && n.ranges.length > 1 && (h = Ku(n, a.pos)) ? h : l ? n.addRange(c) : b.create([c]);
    }
  };
}
function Ku(s, e) {
  for (let t = 0; t < s.ranges.length; t++) {
    ...
    if (i <= e && n >= e)
      return b.create(s.ranges.slice(0, t).concat(s.ranges.slice(t + 1)), s.mainIndex == t ? 0 : s.mainIndex - (s.mainIndex > t ? 1 : 0));
  }
  return null;
}
He.dragstart = (s, e) => {
  ...
  let { inputState: i } = s;
  return i.mouseSelection && (i.mouseSelection.dragging = !0), i.draggedContent = t, e.dataTransfer && (e.dataTransfer.setData("Text", hs(s.state, _r, s.state.sliceDoc(t.from, t.to))), e.dataTransfer.effectAllowed = "copyMove"), !1;
};
He.dragend = (s) => (s.inputState.draggedContent = null, !1);
function tl(s, e, t, i) {
  if (t = hs(s.state, Yr, t), !t)
    return;
  let n = s.posAtCoords({ x: e.clientX, y: e.clientY }, !1), { draggedContent: r } = s.inputState, o = i && r && Fu(s, e) ? { from: r.from, to: r.to } : null, l = { from: n, insert: t }, a = s.state.changes(o ? [o, l] : l);
  s.focus(), s.dispatch({
    changes: a,
...
He.drop = (s, e) => {
  ...
  if (t && t.length) {
    let i = Array(t.length), n = 0, r = () => {
      ++n == t.length && tl(s, e, i.filter((o) => o != null).join(s.state.lineBreak), !1);
    };
...
He.paste = (s, e) => {
  ...
  return t ? (gh(s, t.getData("text/plain") || t.getData("text/uri-list")), !0) : (zu(s), !1);
};
function ju(s, e) {
...
function Uu(s) {
  ...
  return { text: hs(s, _r, e.join(s.lineBreak)), ranges: t, linewise: i };
}
let vr = null;
He.copy = He.cut = (s, e) => {
  if (!wi(s.contentDOM, s.observer.selectionRange))
    return !1;
  let { text: t, ranges: i, linewise: n } = Uu(s.state);
  if (!t && !n)
    return !1;
  vr = n ? t : null, e.type == "cut" && !s.state.readOnly && s.dispatch({
    changes: i,
    scrollIntoView: !0,
    userEvent: "delete.cut"
  });
  let r = mh ? null : e.clipboardData;
  return r ? (r.clearData(), r.setData("text/plain", t), !0) : (ju(s, t), !1);
};
const bh = /* @__PURE__ */ ht.define();
function xh(s, e) {
  let t = [];
  for (let i of s.facet(Ja)) {
    let n = i(s, e);
    n && t.push(n);
  }
  return t.length ? s.update({ effects: t, annotations: bh.of(!0) }) : null;
}
function kh(s) {
  setTimeout(() => {
    let e = s.hasFocus;
...
Ee.compositionstart = Ee.compositionupdate = (s) => {
...
He.beforeinput = (s, e) => {
  ...
  if ((e.inputType == "insertText" || e.inputType == "insertCompositionText") && (s.inputState.insertingText = e.data, s.inputState.insertingTextAt = Date.now()), e.inputType == "insertReplacementText" && s.observer.editContext) {
    ...
    if (r && o.length) {
      ...
      return eo(s, { from: a, to: h, insert: s.state.toText(r) }, null), !0;
    }
  }
  let n;
  if (O.chrome && O.android && (n = dh.find((r) => r.inputType == e.inputType)) && (s.observer.delayAndroidKey(n.key, n.keyCode), n.key == "Backspace" || n.key == "Delete")) {
  ...
  return O.ios && e.inputType == "deleteContentForward" && s.observer.flushSoon(), O.safari && e.inputType == "insertText" && s.inputState.composing >= 0 && setTimeout(() => Ee.compositionend(s, e), 20), !1;
};
const il = /* @__PURE__ */ new Set();
function Gu(s) {
  il.has(s) || (il.add(s), s.addEventListener("copy", () => {
...
class ge {
  ...
  applyChanges(e, t, i, n) {
    ...
    for (let l = n.length - 1; l >= 0; l--) {
      let { fromA: a, toA: h, fromB: c, toB: f } = n[l], u = r.lineAt(a, G.ByPosNoHeight, i.setDoc(t), 0, 0), d = u.to >= h ? u : r.lineAt(h, G.ByPosNoHeight, i, 0, 0);
      for (f += d.to - h, h = d.to; l > 0 && u.from <= n[l - 1].toA; )
        a = n[l - 1].fromA, c = n[l - 1].fromB, l--, a < u.from && (u = r.lineAt(a, G.ByPosNoHeight, i, 0, 0));
      c += u.from - a, a = u.from;
  ...
  static of(e) {
    ...
    let o = 0;
    return e[t - 1] == null ? (o = 1, t--) : e[t] == null && (o = 1, i++), new Xu(ge.of(e.slice(0, t)), o, ge.of(e.slice(i)));
  }
}
function Fn(s, e) {
  return s == e ? s : (s.constructor != e.constructor && (si = !0), e);
}
ge.prototype.size = 1;
const _u = /* @__PURE__ */ B.replace({});
class wh extends ge {
  constructor(e, t, i) {
  ...
  blockAt(e, t, i, n) {
    return this.spaceAbove && e < i + this.spaceAbove ? new Ne(n, 0, i, this.spaceAbove, _u) : this.mainBlock(i, n);
  }
  lineAt(e, t, i, n, r) {
  ...
  forEachLine(e, t, i, n, r, o) {
    e <= r + this.length && t >= r && o(this.lineAt(0, G.ByPos, i, n, r));
  }
  setMeasuredHeight(e) {
...
class Ae extends wh {
  ...
  replace(e, t, i) {
    let n = i[0];
    return i.length == 1 && (n instanceof Ae || n instanceof re && n.flags & 4) && Math.abs(this.length - n.length) < 10 ? (n instanceof re ? n = new Ae(n.length, this.height, this.spaceAbove) : n.height = this.height, this.outdated || (n.outdated = !1), n) : ge.of(i);
  }
  updateHeight(e, t = 0, i = !1, n) {
...
class re extends ge {
  ...
  lineAt(e, t, i, n, r) {
    ...
    return new Ne(h.from, h.length, Math.max(n, Math.min(u, n + this.height - c)), c, 0);
  }
  forEachLine(e, t, i, n, r, o) {
  ...
  replace(e, t, i) {
    ...
    if (n > 0) {
      let r = i[i.length - 1];
      r instanceof re ? i[i.length - 1] = new re(r.length + n) : i.push(null, new re(n - 1));
    }
    if (e > 0) {
      let r = i[0];
  ...
  updateHeight(e, t = 0, i = !1, n) {
    ...
    if (n && n.from <= t + this.length && n.more) {
      ...
      for (n.from > t && o.push(new re(n.from - t - 1).updateHeight(e, t)); l <= r && n.more; ) {
...
class Xu extends ge {
  ...
  lineAt(e, t, i, n, r) {
    let o = n + this.left.height, l = r + this.left.length + this.break, a = t == G.ByHeight ? e < o : e < l, h = a ? this.left.lineAt(e, t, i, n, r) : this.right.lineAt(e, t, i, o, l);
  ...
  forEachLine(e, t, i, n, r, o) {
    ...
    if (this.break)
      ...
      let h = this.lineAt(a, G.ByPos, i, n, r);
...
function rl(s, e) {
  let t, i;
  s[e] == null && (t = s[e - 1]) instanceof re && (i = s[e + 1]) instanceof re && s.splice(e - 1, 3, new re(t.length + 1 + i.length));
}
const Ju = 5;
class to {
  constructor(e, t) {
  ...
  span(e, t) {
    if (this.lineStart > -1) {
      ...
      n instanceof Ae ? n.length += i - this.pos : (i > this.pos || !this.isCovered) && this.nodes.push(new Ae(i - this.pos, -1, 0)), this.writtenTo = i, t > i && (this.nodes.push(null), this.writtenTo++, this.lineStart = -1);
    }
    this.pos = t;
  }
  point(e, t, i) {
    if (e < t || i.heightRelevant) {
      ...
      let o = t - e;
      i.block ? this.addBlock(new wh(o, n, i)) : (o || r || n >= Ju) && this.addLineDeco(n, r, o);
  ...
  static build(e, t, i, n) {
    let r = new to(i, e);
    return N.spans(t, i, n, r, 0), r.finish(i);
  }
}
function Zu(s, e, t) {
  let i = new ed();
  return N.compare(s, e, t, i, 0), i.changes;
}
class ed {
  constructor() {
    this.changes = [];
  ...
  comparePoint(e, t, i, n) {
    (e < t || i && i.heightRelevant || n && n.heightRelevant) && Yt(e, t, this.changes, 5);
  }
}
function td(s, e) {
...
class ol {
  constructor(e) {
    ...
    this.heightOracle = new Qu(t), this.stateDeco = al(e), this.heightMap = ge.empty().applyChanges(this.stateDeco, H.empty, this.heightOracle.setDoc(e.doc), [new Be(0, 0, 0, e.doc.length)]);
  ...
  update(e, t = null) {
    ...
    let n = e.changedRanges, r = Be.extendWithRanges(n, Zu(i, this.stateDeco, e ? e.changes : ee.empty(this.state.doc.length))), o = this.heightMap.height, l = this.scrolledToBottom ? null : this.scrollAnchorAt(this.scrollTop);
    ...
    this.viewport = a, e.flags |= this.updateForViewport(), (h || !e.changes.empty || e.flags & 2) && this.updateViewportLines(), (this.lineGaps.length || this.viewport.to - this.viewport.from > 4e3) && this.updateLineGaps(this.ensureLineGaps(this.mapLineGaps(this.lineGaps, e.changes))), e.flags |= this.computeVisibleRanges(e.changes), t && (this.scrollTarget = t), !this.mustEnforceCursorAssoc && (e.selectionSet || e.focusChanged) && e.view.lineWrapping && e.state.selection.main.empty && e.state.selection.main.assoc && !e.state.facet(eh) && (this.mustEnforceCursorAssoc = !0);
  }
  measure(e) {
    ...
    let h = 0, c = 0;
    if (l.width && l.height) {
      let { scaleX: M, scaleY: w } = Wa(t, l);
      (M > 5e-3 && Math.abs(this.scaleX - M) > 5e-3 || w > 5e-3 && Math.abs(this.scaleY - w) > 5e-3) && (this.scaleX = M, this.scaleY = w, h |= 16, o = a = !0);
    }
    ...
    this.scrollTop != d && (this.scrollAnchorHeight = -1, this.scrollTop = d), this.scrolledToBottom = Ha(e.scrollDOM);
    let p = (this.printing ? nd : td)(t, this.paddingTop), m = p.top - this.pixelViewport.top, g = p.bottom - this.pixelViewport.bottom;
    this.pixelViewport = p;
    let y = this.pixelViewport.bottom > this.pixelViewport.top && this.pixelViewport.right > this.pixelViewport.left;
    if (y != this.inView && (this.inView = y, y && (a = !0)), !this.inView && !this.scrollTarget && !id(e.dom))
      return 0;
    let x = l.width;
    if ((this.contentDOMWidth != x || this.editorHeight != e.scrollDOM.clientHeight) && (this.contentDOMWidth = l.width, this.editorHeight = e.scrollDOM.clientHeight, h |= 16), a) {
      ...
      if (n.mustRefreshForHeights(M) && (o = !0), o || n.lineWrapping && Math.abs(x - this.contentDOMWidth) > n.charWidth) {
        let { lineHeight: w, charWidth: A, textHeight: S } = e.docView.measureTextSize();
        o = w > 0 && n.refresh(r, w, A, S, Math.max(5, x / A), M), o && (e.docView.minWidth = 0, h |= 16);
      }
      m > 0 && g > 0 ? c = Math.max(m, g) : m < 0 && g < 0 && (c = Math.min(m, g)), sl();
      for (let w of this.viewports) {
        let A = w.from == this.viewport.from ? M : e.docView.measureVisibleLineHeights(w);
        this.heightMap = (o ? ge.empty().applyChanges(this.stateDeco, H.empty, this.heightOracle, [new Be(0, 0, 0, e.state.doc.length)]) : this.heightMap).updateHeight(n, 0, o, new Yu(w.from, A));
      }
      si && (h |= 2);
    }
  ...
  getViewport(e, t) {
    let i = 0.5 - Math.max(-0.5, Math.min(0.5, e / 1e3 / 2)), n = this.heightMap, r = this.heightOracle, { visibleTop: o, visibleBottom: l } = this, a = new tn(n.lineAt(o - i * 1e3, G.ByHeight, r, 0, 0).from, n.lineAt(l + (1 - i) * 1e3, G.ByHeight, r, 0, 0).to);
    if (t) {
      let { head: h } = t.range;
      if (h < a.from || h > a.to) {
        let c = Math.min(this.editorHeight, this.pixelViewport.bottom - this.pixelViewport.top), f = n.lineAt(h, G.ByPos, r, 0, 0), u;
        t.y == "center" ? u = (f.top + f.bottom) / 2 - c / 2 : t.y == "start" || t.y == "nearest" && h < a.from ? u = f.top : u = f.bottom - c, a = new tn(n.lineAt(u - 1e3 / 2, G.ByHeight, r, 0, 0).from, n.lineAt(u + c + 1e3 / 2, G.ByHeight, r, 0, 0).to);
      }
    }
    return a;
  }
  mapViewport(e, t) {
    ...
    return new tn(this.heightMap.lineAt(i, G.ByPos, this.heightOracle, 0, 0).from, this.heightMap.lineAt(n, G.ByPos, this.heightOracle, 0, 0).to);
  }
  ...
  viewportIsAppropriate({ from: e, to: t }, i = 0) {
    if (!this.inView)
      return !0;
    let { top: n } = this.heightMap.lineAt(e, G.ByPos, this.heightOracle, 0, 0), { bottom: r } = this.heightMap.lineAt(t, G.ByPos, this.heightOracle, 0, 0), { visibleTop: o, visibleBottom: l } = this;
  ...
  mapLineGaps(e, t) {
    ...
    let i = [];
    for (let n of e)
      t.touchesRange(n.from, n.to) || i.push(new Ts(t.mapPos(n.from), t.mapPos(n.to), n.size, n.displaySize));
    return i;
  }
  ...
  ensureLineGaps(e, t) {
    ...
    let l = [], a = (c, f, u, d) => {
      ...
      let g = od(e, (y) => y.from >= u.from && y.to <= u.to && Math.abs(y.from - c) < r && Math.abs(y.to - f) < r && !m.some((x) => y.from < x && y.to > x));
      if (!g) {
        if (f < u.to && t && i && t.visibleRanges.some((k) => k.from <= f && k.to >= f)) {
          let k = t.moveToLineBoundary(b.cursor(f), !1, !0).head;
          k > c && (f = k);
        }
      ...
      if (i) {
        ...
        if (u != null) {
          let x = sn(f, u), k = ((this.visibleBottom - this.visibleTop) / 2 + m) / c.height;
          g = x - k, y = x + k;
        } else
          g = (this.visibleTop - c.top - m) / c.height, y = (this.visibleBottom - c.top + m) / c.height;
        d = nn(f, g), p = nn(f, y);
      } else {
        let m = f.total * this.heightOracle.charWidth, g = n * this.heightOracle.charWidth, y = 0;
        if (m > 2e6)
          for (let A of e)
        ...
        let x = this.pixelViewport.left + y, k = this.pixelViewport.right + y, M, w;
        if (u != null) {
          let A = sn(f, u), S = ((k - x) / 2 + g) / m;
          M = A - S, w = A + S;
        } else
          M = (x - g) / m, w = (k + g) / m;
        d = nn(f, M), p = nn(f, w);
  ...
  updateLineGaps(e) {
    Ts.same(e, this.lineGaps) || (this.lineGaps = e, this.lineGapDeco = B.set(e.map((t) => t.draw(this, this.heightOracle.lineWrapping))));
  }
...
function nn({ total: s, ranges: e }, t) {
  if (t <= 0)
    return e[0].from;
  if (t >= 1)
...
function al(s) {
  let e = s.facet(os).filter((i) => typeof i != "function"), t = s.facet(Jr).filter((i) => typeof i != "function");
...
function yi(s, e) {
  ...
  return new Ne(s.from, s.length, t, i - t, Array.isArray(s._content) ? s._content.map((n) => yi(n, e)) : s._content);
}
const rn = /* @__PURE__ */ T.define({ combine: (s) => s.join(" ") }), Sr = /* @__PURE__ */ T.define({ combine: (s) => s.indexOf(!0) > -1 }), Cr = /* @__PURE__ */ xt.newName(), vh = /* @__PURE__ */ xt.newName(), Sh = /* @__PURE__ */ xt.newName(), Ch = { "&light": "." + vh, "&dark": "." + Sh };
function Ar(s, e, t) {
  return new xt(e, {
    finish(i) {
...
class hd {
  constructor(e) {
    this.view = e, this.active = !1, this.editContext = null, this.selectionRange = new Hf(), this.selectionChanged = !1, this.delayedFlush = -1, this.resizeTimeout = -1, this.queue = [], this.delayedAndroidKey = null, this.flushingAndroidKey = -1, this.lastChange = 0, this.scrollTargets = [], this.intersection = null, this.resizeScroll = null, this.intersecting = !1, this.gapIntersection = null, this.gaps = [], this.printQuery = null, this.parentCheck = -1, this.dom = e.contentDOM, this.observer = new MutationObserver((t) => {
      for (let i of t)
        this.queue.push(i);
    ...
    !(O.chrome && O.chrome_version < 126) && (this.editContext = new fd(e), e.state.facet(rt) && (e.contentDOM.editContext = this.editContext.editContext)), Ds && (this.onCharData = (t) => {
      this.queue.push({
        target: t.target,
        type: "characterData",
  ...
  onSelectionChange(e) {
    ...
    if (i.state.facet(rt) ? i.root.activeElement != this.dom : !wi(this.dom, n))
      return;
  ...
  readSelectionRange() {
    ...
    if (!t)
      return !1;
    let i = O.safari && e.root.nodeType == 11 && e.root.activeElement == this.dom && cd(this.view, t) || t;
    if (!i || this.selectionRange.eq(i))
      return !1;
    let n = wi(this.dom, i);
    return n && !this.selectionChanged && e.inputState.lastFocusTime > Date.now() - 200 && e.inputState.lastTouchTime < Date.now() - 300 && zf(this.dom, i) ? (this.view.inputState.lastFocusTime = 0, e.docView.updateSelection(), !1) : (this.selectionRange.setRange(i), n && (this.selectionChanged = !0), !0);
  }
  ...
  start() {
    this.active || (this.observer.observe(this.dom, ad), Ds && this.dom.addEventListener("DOMCharacterDataModified", this.onCharData), this.active = !0);
  }
  stop() {
  ...
  readChange() {
    let { from: e, to: t, typeOver: i } = this.processRecords(), n = this.selectionChanged && wi(this.dom, this.selectionRange);
    if (e < 0 && !n)
      return null;
  ...
  flush(e = !0) {
    ...
    let i = this.view.state, n = fh(this.view, t);
    return this.view.state == i && (t.domChanged || t.newSel && !Wn(this.view.state.selection, t.newSel.main)) && this.view.update([]), n;
  }
  readMutation(e) {
    ...
    if (t.markDirty(e.type == "attributes"), e.type == "childList") {
      let i = hl(t, e.previousSibling || e.target.previousSibling, -1), n = hl(t, e.nextSibling || e.target.nextSibling, 1);
      return {
...
function cl(s, e) {
  ...
  return vi(o.node, o.offset, n, r) && ([t, i, n, r] = [n, r, t, i]), { anchorNode: t, anchorOffset: i, focusNode: n, focusOffset: r };
}
function cd(s, e) {
  ...
  return s.contentDOM.addEventListener("beforeinput", i, !0), s.dom.ownerDocument.execCommand("indent"), s.contentDOM.removeEventListener("beforeinput", i, !0), t ? cl(s, t) : null;
}
class fd {
  constructor(e) {
    ...
    this.handlers.textupdate = (i) => {
      ...
      let c = uh(e.state.sliceDoc(l, a), i.text, (h ? n.from : n.to) - l, h ? "end" : null);
      if (!c) {
        let u = b.single(this.toEditorPos(i.selectionStart), this.toEditorPos(i.selectionEnd));
        Wn(u, n) || e.dispatch({ selection: u, userEvent: "select" });
        return;
      }
      let f = {
        from: c.from + l,
      ...
      for (let r of i.getTextFormats()) {
        ...
        if (!/none/i.test(o) && !/none/i.test(l)) {
          ...
          if (a < h) {
            ...
            n.push(B.mark({ attributes: { style: c } }).range(a, h));
          }
        }
      }
      e.dispatch({ effects: ih.of(B.set(n)) });
...
class D {
  ...
  */
  constructor(e = {}) {
    ...
    let { dispatch: i } = e;
    this.dispatchTransactions = e.dispatchTransactions || i && ((n) => n.forEach((r) => i(r, this))) || ((n) => this.update(n)), this.dispatch = this.dispatch.bind(this), this._root = e.root || Vf(e.parent) || document, this.viewState = new ol(e.state || F.create(e)), e.scrollTo && e.scrollTo.is(Ji) && (this.viewState.scrollTarget = e.scrollTo.value.clip(this.viewState.state)), this.plugins = this.state.facet(Kt).map((n) => new Ss(n));
    for (let n of this.plugins)
      n.update(this);
    this.observer = new hd(this), this.inputState = new Ru(this), this.inputState.ensureHandlers(this.plugins), this.docView = new Go(this), this.mountStyles(), this.updateAttrs(), this.updateState = 0, this.requestMeasure(), !((t = document.fonts) === null || t === void 0) && t.ready && document.fonts.ready.then(() => {
  ...
  */
  update(e) {
    ...
    e.some((u) => u.annotation(bh)) ? (this.inputState.notifiedFocused = o, l = 1) : o != this.inputState.notifiedFocused && (this.inputState.notifiedFocused = o, a = xh(r, o), a || (l = 1));
    ...
    n = En.create(this, r, e), n.flags |= l;
    ...
    if (n.startState.facet(rn) != n.state.facet(rn) && (this.viewState.mustMeasureContent = !0), (t || i || f || this.viewState.mustEnforceCursorAssoc || this.viewState.mustMeasureContent) && this.requestMeasure(), t && this.docViewUpdate(), !n.empty)
    ...
    (a || c) && Promise.resolve().then(() => {
      a && this.state == a.startState && this.dispatch(a), c && !fh(this, c) && h.force && _t(this.contentDOM, h.key, h.keyCode);
    });
  }
  /**
  ...
  */
  get themeClasses() {
    return Cr + " " + (this.state.facet(Sr) ? Sh : vh) + " " + this.state.facet(rn);
  }
  updateAttrs() {
    let e = ul(this, nh, {
    ...
    let i = this.observer.ignore(() => {
      let n = zo(this.contentDOM, this.contentAttrs, t), r = zo(this.dom, this.editorAttrs, e);
      return n || r;
    });
  ...
  mountStyles() {
    ...
    xt.mount(this.root, this.styleModules.concat(ld).reverse(), e ? { nonce: e } : void 0);
  }
  readMeasured() {
  ...
  */
  moveByGroup(e, t) {
    return Os(this, e, Qo(this, e, t, (i) => vu(this, e.head, i)));
  }
  /**
  ...
  */
  visualLineSide(e, t) {
    ...
    return b.cursor(r.side(t, n) + e.from, r.forward(!t, n) ? 1 : -1);
  }
  /**
  ...
  */
  moveVertically(e, t, i) {
    return Os(this, e, Su(this, e, t, i));
  }
  /**
  ...
  */
  ...
  posAndSideAtCoords(e, t = !0) {
    return this.readMeasured(), wr(this, e, t);
  }
  /**
  ...
  */
  coordsAtPos(e, t = 1) {
    ...
    if (!i || i.left == i.right)
      return i;
    let n = this.state.doc.lineAt(e), r = this.bidiSpans(n), o = r[Xe.find(r, e - n.from, -1, t)];
  ...
  */
  bidiSpans(e) {
    ...
    for (let r of this.bidiCache)
      if (r.from == e.from && r.dir == t && (r.fresh || Ka(r.isolates, i = Ko(this, e))))
        return r.order;
    i || (i = Ko(this, e));
    let n = Qf(e.text, t, i);
  ...
  */
  static theme(e, t) {
    let i = xt.newName(), n = [rn.of(i), mi.of(Ar(`.${i}`, e))];
    return t && t.dark && n.push(Sr.of(!0)), n;
  }
  /**
  ...
  */
  static baseTheme(e) {
    return Vt.lowest(mi.of(Ar("." + Cr, e, Ch)));
  }
  /**
...
D.perLineTextDirection = Za;
D.exceptionSink = _a;
D.updateListener = br;
D.editable = rt;
D.mouseSelectionStyle = Ya;
D.dragMovesSelection = Qa;
D.clickAddsSelectionRange = Ga;
D.decorations = os;
D.blockWrappers = sh;
D.outerDecorations = Jr;
D.atomicRanges = $i;
D.bidiIsolatedRanges = rh;
D.scrollMargins = oh;
D.darkTheme = Sr;
D.cspNonce = /* @__PURE__ */ T.define({ combine: (s) => s.length ? s[0] : "" });
D.contentAttributes = Xr;
D.editorAttributes = nh;
...
const dd = O.mac ? "mac" : O.windows ? "win" : O.linux ? "linux" : "key";
function pd(s, e) {
  const t = s.split(/-(?!$)/);
  let i = t[t.length - 1];
  i == "Space" && (i = " ");
...
const md = /* @__PURE__ */ Vt.default(/* @__PURE__ */ D.domEventHandlers({
  keydown(s, e) {
    return Mh(Ah(e.state), s, e, "editor");
  }
})), no = /* @__PURE__ */ T.define({ enables: md }), dl = /* @__PURE__ */ new WeakMap();
function Ah(s) {
  let e = s.facet(no), t = dl.get(e);
  return t || dl.set(e, t = bd(e.reduce((i, n) => i.concat(n), []))), t;
}
function gd(s, e, t) {
  return Mh(Ah(s.state), e, s, t);
}
let dt = null;
const yd = 4e3;
function bd(s, e = dd) {
  let t = /* @__PURE__ */ Object.create(null), i = /* @__PURE__ */ Object.create(null), n = (o, l) => {
    ...
    var f, u;
    let d = t[o] || (t[o] = /* @__PURE__ */ Object.create(null)), p = l.split(/ (?!$)/).map((y) => pd(y, e));
    for (let y = 1; y < p.length; y++) {
      ...
      n(x, !0), d[x] || (d[x] = {
        ...
        stopPropagation: !1,
        run: [(k) => {
          let M = dt = { view: k, prefix: x, scope: o };
          return setTimeout(() => {
            dt == M && (dt = null);
          }, yd), !0;
        }]
...
function Mh(s, e, t, i) {
  Mr = e;
  let n = Pf(e), r = ye(n, 0), o = Ye(r) == n.length && n != " ", l = "", a = !1, h = !1, c = !1;
  dt && dt.view == t && dt.scope == i && (l = dt.prefix + " ", ph.indexOf(e.keyCode) < 0 && (h = !0, dt = null));
  ...
  return d && (u(d[l + on(n, e, !o)]) ? a = !0 : o && (e.altKey || e.metaKey || e.ctrlKey) && // Ctrl-Alt may be used for AltGr on Windows
  !(O.windows && e.ctrlKey && e.altKey) && // Alt-combinations on macOS tend to be typed characters
  !(O.mac && e.altKey && !(e.ctrlKey || e.metaKey)) && (p = kt[e.keyCode]) && p != n ? (u(d[l + on(p, e, !0)]) || e.shiftKey && (m = Ti[e.keyCode]) != n && m != p && u(d[l + on(m, e, !1)])) && (a = !0) : o && e.shiftKey && u(d[l + on(n, e, !0)]) && (a = !0), !a && u(d._any) && (a = !0)), h && (a = !0), a && c && e.stopPropagation(), Mr = null, a;
}
class Ki {
  /**
  ...
  static forRange(e, t, i) {
    if (i.empty) {
      ...
      if (!n)
        return [];
      let r = Oh(e);
      return [new Ki(t, n.left - r.left, n.top - r.top, null, n.bottom - n.top)];
    } else
      return xd(e, t, i);
  }
}
function Oh(s) {
  ...
  return { left: (s.textDirection == j.LTR ? e.left : e.right - s.scrollDOM.clientWidth * s.scaleX) - s.scrollDOM.scrollLeft * s.scaleX, top: e.top - s.scrollDOM.scrollTop * s.scaleY };
}
function pl(s, e, t, i) {
...
function xd(s, e, t) {
  if (t.to <= s.viewport.from || t.from >= s.viewport.to)
    return [];
  let i = Math.max(t.from, s.viewport.from), n = Math.min(t.to, s.viewport.to), r = s.textDirection == j.LTR, o = s.contentDOM, l = o.getBoundingClientRect(), a = Oh(s), h = o.querySelector(".cm-line"), c = h && window.getComputedStyle(h), f = l.left + (c ? parseInt(c.paddingLeft) + Math.min(0, parseInt(c.textIndent)) : 0), u = l.right - (c ? parseInt(c.paddingRight) : 0), d = kr(s, i, 1), p = kr(s, n, -1), m = d.type == le.Text ? d : null, g = p.type == le.Text ? p : null;
  if (m && (s.lineWrapping || d.widgetLineBreaks) && (m = pl(s, i, 1, m)), g && (s.lineWrapping || p.widgetLineBreaks) && (g = pl(s, n, -1, g)), m && g && m.from == g.from && m.to == g.to)
    return x(k(t.from, t.to, m));
  {
    let w = m ? k(t.from, null, m) : M(d, !1), A = g ? k(null, t.to, g) : M(p, !0), S = [];
    return (m || d).to < (g || p).from - (m && g ? 1 : 0) || d.widgetLineBreaks > 1 && w.bottom + s.defaultLineHeight / 2 < A.top ? S.push(y(f, w.bottom, u, A.top)) : w.bottom < A.top && s.elementAtHeight((w.bottom + A.top) / 2).type == le.Text && (w.bottom = A.top = (w.bottom + A.top) / 2), x(w).concat(S).concat(x(A));
  }
  function y(w, A, S, L) {
    return new Ki(e, w - a.left, A - a.top, Math.max(0, S - w), L - A);
  }
  function x({ top: w, bottom: A, horizontal: S }) {
    let L = [];
    for (let W = 0; W < S.length; W += 2)
      L.push(y(S[W], w, S[W + 1], A));
    return L;
  }
  function k(w, A, S) {
    let L = 1e9, W = -1e9, $ = [];
    function I(V, U, ue, ve, qe) {
      let se = s.coordsAtPos(V, V == S.to ? -2 : 2), Oe = s.coordsAtPos(ue, ue == S.from ? 2 : -2);
    ...
    let P = w ?? S.from, z = A ?? S.to;
    for (let V of s.visibleRanges)
      if (V.to > P && V.from < z)
        for (let U = Math.max(V.from, P), ue = Math.min(V.to, z); ; ) {
          let ve = s.state.doc.lineAt(U);
          for (let qe of s.bidiSpans(ve)) {
            let se = qe.from + ve.from, Oe = qe.to + ve.from;
            if (se >= ue)
              break;
            Oe > U && I(Math.max(se, U), w == null && se <= P, Math.min(Oe, ue), A == null && Oe >= z, qe.dir);
          }
          if (U = ve.to + 1, U >= ue)
            break;
        }
    return $.length == 0 && I(P, w == null, z, A == null, s.textDirection), { top: L, bottom: W, horizontal: $ };
  }
  function M(w, A) {
    let S = l.top + (A ? w.top : w.bottom);
...
function Dh(s) {
  return s.startState.facet(Ri) != s.state.facet(Ri);
}
const Sd = /* @__PURE__ */ Th({
  above: !0,
  markers(s) {
    let { state: e } = s, t = e.facet(Ri), i = [];
    for (let n of e.selection.ranges) {
      let r = n == e.selection.main;
      if (n.empty || t.drawRangeCursor) {
        let o = r ? "cm-cursor cm-cursor-primary" : "cm-cursor cm-cursor-secondary", l = n.empty ? n : b.cursor(n.head, n.head > n.anchor ? -1 : 1);
        for (let a of Ki.forRange(s, o, l))
          i.push(a);
      }
    }
    return i;
  ...
  update(s, e) {
    ...
    let t = Dh(s);
    return t && ml(s.state, e), s.docChanged || s.selectionSet || t;
  },
  mount(s, e) {
    ml(e.state, s);
  },
...
function ml(s, e) {
  e.style.animationDuration = s.facet(Ri).cursorBlinkRate + "ms";
}
const Cd = /* @__PURE__ */ Th({
  above: !1,
  markers(s) {
    return s.state.selection.ranges.map((e) => e.empty ? [] : Ki.forRange(s, "cm-selectionBackground", e)).reduce((e, t) => e.concat(t));
  },
  update(s, e) {
    return s.docChanged || s.selectionSet || s.viewportChanged || Dh(s);
  },
  class: "cm-selectionLayer"
}), Ad = /* @__PURE__ */ Vt.highest(/* @__PURE__ */ D.theme({
  ".cm-line": {
  ...
  update(s, e) {
    return s != null && (s = e.changes.mapPos(s)), e.effects.reduce((t, i) => i.is(Bh) ? i.value : t, s);
  }
}), Md = /* @__PURE__ */ J.fromClass(class {
  constructor(s) {
    this.view = s, this.cursor = null, this.measureReq = { read: this.readPos.bind(this), write: this.drawCursor.bind(this) };
  }
  update(s) {
    var e;
    let t = s.state.field(bi);
    t == null ? this.cursor != null && ((e = this.cursor) === null || e === void 0 || e.remove(), this.cursor = null) : (this.cursor || (this.cursor = this.view.scrollDOM.appendChild(document.createElement("div")), this.cursor.className = "cm-dropCursor"), (s.startState.field(bi) != t || s.docChanged || s.geometryChanged) && this.view.requestMeasure(this.measureReq));
  }
  readPos() {
    let { view: s } = this, e = s.state.field(bi), t = e != null && s.coordsAtPos(e);
    if (!t)
      return null;
  ...
  setDropPos(s) {
    this.view.state.field(bi) != s && this.view.dispatch({ effects: Bh.of(s) });
  }
}, {
  eventObservers: {
    dragover(s) {
...
function gl(s, e, t, i, n) {
  e.lastIndex = 0;
  for (let r = s.iterRange(t, i), o = t, l; !r.next().done; o += r.value.length)
    if (!r.lineBreak)
...
class Dd {
  ...
  */
  createDeco(e) {
    ...
    for (let { from: n, to: r } of Td(e, this.maxLength))
      gl(e.state.doc, this.regexp, n, r, (o, l) => this.addMatch(l, e, o, i));
    return t.finish();
  }
  /**
...
const Or = /x/.unicode != null ? "gu" : "g", Bd = /* @__PURE__ */ new RegExp(`[\0-\b
--­؜​‎‏\u2028\u2029‭‮⁦⁧⁩\uFEFF￹-￼]`, Or), Pd = {
  0: "null",
  7: "bell",
  8: "backspace",
...
function Rd() {
  ...
  if (Bs == null && typeof document < "u" && document.body) {
    ...
    Bs = ((s = e.tabSize) !== null && s !== void 0 ? s : e.MozTabSize) != null;
  }
  return Bs || !1;
}
const An = /* @__PURE__ */ T.define({
  combine(s) {
    ...
    return (e.replaceTabs = !Rd()) && (e.specialChars = new RegExp("	|" + e.specialChars.source, Or)), e.addSpecialChars && (e.specialChars = new RegExp(e.specialChars.source + "|" + e.addSpecialChars.source, Or)), e;
  }
});
function Ld(s = {}) {
  return [An.of(s), Ed()];
...
let yl = null;
function Ed() {
  return yl || (yl = J.fromClass(class {
    constructor(s) {
      this.view = s, this.decorations = B.none, this.decorationCache = /* @__PURE__ */ Object.create(null), this.decorator = this.makeDecorator(s.state.facet(An)), this.decorations = this.decorator.createDeco(s);
    }
    makeDecorator(s) {
      return new Dd({
        regexp: s.specialChars,
        decoration: (e, t, i) => {
          let { doc: n } = t.state, r = ye(e[0], 0);
          if (r == 9) {
            let o = n.lineAt(i), l = t.state.tabSize, a = li(o.text, l, i - o.from);
            return B.replace({
              widget: new Fd((l - a % l) * this.view.defaultCharacterWidth / this.view.scaleX)
            });
          }
          return this.decorationCache[r] || (this.decorationCache[r] = B.replace({ widget: new Wd(s, r) }));
        },
        boundary: s.replaceTabs ? void 0 : /[^]/
      });
    }
    update(s) {
      let e = s.state.facet(An);
      s.startState.facet(An) != e ? (this.decorator = this.makeDecorator(e), this.decorations = this.decorator.createDeco(s.view)) : this.decorations = this.decorator.updateDeco(s, this.decorations);
    }
  }, {
...
const Id = "•";
function Nd(s) {
  return s >= 32 ? Id : s == 10 ? "␤" : String.fromCharCode(9216 + s);
}
class Wd extends ct {
  constructor(e, t) {
  ...
  toDOM(e) {
    let t = Nd(this.code), i = e.state.phrase("Control character") + " " + (Pd[this.code] || "0x" + this.code.toString(16)), n = this.options.render && this.options.render(this.code, i, t);
    if (n)
      return n;
...
const Vd = /* @__PURE__ */ B.line({ class: "cm-activeLine" }), zd = /* @__PURE__ */ J.fromClass(class {
  constructor(s) {
  ...
  getDeco(s) {
    ...
    for (let i of s.state.selection.ranges) {
      ...
      n.from > e && (t.push(Vd.range(n.from)), e = n.from);
    }
    return B.set(t);
  }
}, {
...
function qd(s, e, t) {
  ...
  if (e.off > Tr || t.off > Tr || e.col < 0 || t.col < 0) {
    ...
    for (let a = i; a <= n; a++) {
      let h = s.doc.line(a), c = lr(h.text, o, s.tabSize, !0);
      if (c < 0)
        r.push(b.cursor(h.to));
      else {
        let f = lr(h.text, l, s.tabSize);
...
function bl(s, e) {
  let t = s.posAtCoords({ x: e.clientX, y: e.clientY }, !1), i = s.state.doc.lineAt(t), n = t - i.from, r = n > Tr ? -1 : n == i.length ? $d(s, e.clientX) : li(i.text, s.state.tabSize, t - i.from);
  return { line: i.number, col: r, off: n };
}
function Kd(s, e) {
  let t = bl(s, e), i = s.state.selection;
  return t ? {
    update(n) {
      if (n.docChanged) {
...
function jd(s) {
  ...
  return D.mouseSelectionStyle.of((t, i) => e(i) ? Kd(t, i) : null);
}
const Ud = {
  Alt: [18, (s) => !!s.altKey],
...
function Qd(s = {}) {
  let [e, t] = Ud[s.key || "Alt"], i = J.fromClass(class {
    constructor(n) {
  ...
  return [
    ...
    D.contentAttributes.of((n) => {
      var r;
      return !((r = n.plugin(i)) === null || r === void 0) && r.isDown ? Gd : null;
    })
  ];
}
const ln = "-10000px";
...
const Ps = /* @__PURE__ */ T.define({
  combine: (s) => {
    var e, t, i;
    return {
      position: O.ios ? "absolute" : ((e = s.find((n) => n.position)) === null || e === void 0 ? void 0 : e.position) || "fixed",
      parent: ((t = s.find((n) => n.parent)) === null || t === void 0 ? void 0 : t.parent) || null,
      tooltipSpace: ((i = s.find((n) => n.tooltipSpace)) === null || i === void 0 ? void 0 : i.tooltipSpace) || Yd
    };
  }
}), xl = /* @__PURE__ */ new WeakMap(), so = /* @__PURE__ */ J.fromClass(class {
  constructor(s) {
    ...
    this.position = e.position, this.parent = e.parent, this.classes = s.themeClasses, this.createContainer(), this.measureReq = { read: this.readMeasure.bind(this), write: this.writeMeasure.bind(this), key: this }, this.resizeObserver = typeof ResizeObserver == "function" ? new ResizeObserver(() => this.measureSoon()) : null, this.manager = new Ph(s, ro, (t, i) => this.createTooltip(t, i), (t) => {
  ...
  update(s) {
    ...
    let t = e || s.geometryChanged, i = s.state.facet(Ps);
  ...
  readMeasure() {
    ...
    let i = this.view.scrollDOM.getBoundingClientRect(), n = Zr(this.view);
    return {
      visible: {
        left: i.left + n.left,
        top: i.top + n.top,
  ...
  writeMeasure(s) {
    ...
    for (let l = 0; l < this.manager.tooltips.length; l++) {
      ...
      let d = a.arrow ? h.dom.querySelector(".cm-tooltip-arrow") : null, p = d ? 7 : 0, m = u.right - u.left, g = (e = xl.get(h)) !== null && e !== void 0 ? e : u.bottom - u.top, y = h.offset || Xd, x = this.view.textDirection == j.LTR, k = u.width > i.right - i.left ? x ? i.left : i.right - u.width : x ? Math.max(i.left, Math.min(f.left - (d ? 14 : 0) + y.x, i.right - m)) : Math.min(Math.max(i.left, f.left - m + (d ? 14 : 0) - y.x), i.right - m), M = this.above[l];
      !a.strictSide && (M ? f.top - g - p - y.y < i.top : f.bottom + g + p + y.y > i.bottom) && M == i.bottom - f.bottom > f.top - i.top && (M = this.above[l] = !M);
      let w = (M ? f.top - i.top : i.bottom - f.bottom) - p;
      if (w < g && h.resize !== !1) {
        if (w < this.view.defaultLineHeight) {
          c.style.top = ln;
          continue;
        }
        xl.set(h, g), c.style.height = (g = w) / r + "px";
      } else c.style.height && (c.style.height = "");
      let A = M ? f.top - g - p - y.y : f.bottom + p + y.y, S = k + m;
      if (h.overlap !== !0)
        for (let L of o)
          L.left < S && L.right > k && L.top < A + g && L.bottom > A && (A = M ? L.top - g - 2 - p : L.bottom + p + 2);
      if (this.position == "absolute" ? (c.style.top = (A - s.parent.top) / r + "px", kl(c, (k - s.parent.left) / n)) : (c.style.top = A / r + "px", kl(c, k / n)), d) {
        let L = f.left + (x ? y.x : -y.x) - (k + 14 - 7);
        d.style.left = L / n + "px";
      }
      h.overlap !== !0 && o.push({ left: k, top: A, right: S, bottom: A + g }), c.classList.toggle("cm-tooltip-above", M), c.classList.toggle("cm-tooltip-below", !M), h.positioned && h.positioned(s.space);
    }
  }
  maybeMeasure() {
...
}), Xd = { x: 0, y: 0 }, ro = /* @__PURE__ */ T.define({
  enables: [so, _d]
...
class cs {
  ...
  constructor(e) {
    this.view = e, this.mounted = !1, this.dom = document.createElement("div"), this.dom.classList.add("cm-tooltip-hover"), this.manager = new Ph(e, Vn, (t, i) => this.createHostedView(t, i), (t) => t.dom.remove());
  }
...
const Jd = /* @__PURE__ */ ro.compute([Vn], (s) => {
  let e = s.facet(Vn);
...
class Zd {
  ...
  mousemove(e) {
    ...
    if (n.length && r && !ep(r.dom, e) || this.pending) {
      let { pos: o } = n[0] || this.pending, l = (i = (t = n[0]) === null || t === void 0 ? void 0 : t.end) !== null && i !== void 0 ? i : o;
      (o == l ? this.view.posAtCoords(this.lastMove) != o : !tp(this.view, o, l, e.clientX, e.clientY)) && (this.view.dispatch({ effects: this.setHover.of([]) }), this.pending = null);
    }
  }
  mouseleave(e) {
...
function ep(s, e) {
  ...
  return e.clientX >= t - an && e.clientX <= i + an && e.clientY >= n - an && e.clientY <= r + an;
}
function tp(s, e, t, i, n, r) {
...
const np = /* @__PURE__ */ R.define(), wl = /* @__PURE__ */ T.define({
  combine(s) {
    let e, t;
    for (let i of s)
...
function oo(s, e) {
  let t = s.plugin(Lh), i = t ? t.specs.indexOf(e) : -1;
  return i > -1 ? t.panels[i] : null;
}
const Lh = /* @__PURE__ */ J.fromClass(class {
  constructor(s) {
    this.input = s.state.facet(Li), this.specs = this.input.filter((t) => t), this.panels = this.specs.map((t) => t(s));
    let e = s.state.facet(wl);
    this.top = new hn(s, !0, e.topContainer), this.bottom = new hn(s, !1, e.bottomContainer), this.top.sync(this.panels.filter((t) => t.top)), this.bottom.sync(this.panels.filter((t) => !t.top));
    for (let t of this.panels)
      t.dom.classList.add("cm-panel"), t.mount && t.mount();
  }
  update(s) {
    let e = s.state.facet(wl);
    this.top.container != e.topContainer && (this.top.sync([]), this.top = new hn(s.view, !0, e.topContainer)), this.bottom.container != e.bottomContainer && (this.bottom.sync([]), this.bottom = new hn(s.view, !1, e.bottomContainer)), this.top.syncClasses(), this.bottom.syncClasses();
    let t = s.state.facet(Li);
    if (t != this.input) {
  ...
  provide: (s) => D.scrollMargins.of((e) => {
    let t = e.plugin(s);
...
function sp(s, e) {
  let t, i = new Promise((o) => t = o), n = (o) => rp(o, e, t);
  s.state.field(Rs, !1) ? s.dispatch({ effects: Eh.of(n) }) : s.dispatch({ effects: R.appendConfig.of(Rs.init(() => [n])) });
  let r = Ih.of(n);
  return { close: r, result: i.then((o) => ((s.win.queueMicrotask || ((a) => s.win.setTimeout(a, 10)))(() => {
    s.state.field(Rs).indexOf(n) > -1 && s.dispatch({ effects: r });
  }), o)) };
}
const Rs = /* @__PURE__ */ ae.define({
  ...
  update(s, e) {
    for (let t of e.effects)
      t.is(Eh) ? s = [t.value].concat(s) : t.is(Ih) && (s = s.filter((i) => i != t.value));
    return s;
  },
  provide: (s) => Li.computeN([s], (e) => e.field(s))
}), Eh = /* @__PURE__ */ R.define(), Ih = /* @__PURE__ */ R.define();
function rp(s, e, t) {
...
at.prototype.mapMode = pe.TrackBefore;
at.prototype.startSide = at.prototype.endSide = -1;
at.prototype.point = !0;
const Mn = /* @__PURE__ */ T.define(), op = /* @__PURE__ */ T.define(), lp = {
  class: "",
...
const hp = /* @__PURE__ */ J.fromClass(class {
  constructor(s) {
    this.view = s, this.domAfter = null, this.prevViewport = s.viewport, this.dom = document.createElement("div"), this.dom.className = "cm-gutters cm-gutters-before", this.dom.setAttribute("aria-hidden", "true"), this.dom.style.minHeight = this.view.contentHeight / this.view.scaleY + "px", this.gutters = s.state.facet(Ci).map((e) => new Al(s, e)), this.fixed = !s.state.facet(Sl);
  ...
  update(s) {
    ...
    this.view.state.facet(Sl) != !this.fixed && (this.fixed = !this.fixed, this.dom.style.position = this.fixed ? "sticky" : "", this.domAfter && (this.domAfter.style.position = this.fixed ? "sticky" : "")), this.prevViewport = s.view.viewport;
  }
  syncGutters(s) {
    let e = this.dom.nextSibling;
    s && (this.dom.remove(), this.domAfter && this.domAfter.remove());
    let t = N.iter(this.view.state.facet(Mn), this.view.viewport.from), i = [], n = this.gutters.map((r) => new cp(r, this.view.viewport, -this.view.documentPadding.top));
  ...
  updateGutters(s) {
    let e = s.startState.facet(Ci), t = s.state.facet(Ci), i = s.docChanged || s.heightChanged || s.viewportChanged || !N.eq(s.startState.facet(Mn), s.state.facet(Mn), s.view.viewport.from, s.view.viewport.to);
    if (e == t)
      ...
      for (let r of t) {
        let o = e.indexOf(r);
        o < 0 ? n.push(new Al(this.view, r)) : (this.gutters[o].update(s), n.push(this.gutters[o]));
      }
...
class Al {
  constructor(e, t) {
    ...
    this.markers = Cl(t.markers(e)), t.initialSpacer && (this.spacer = new Wh(e, 0, 0, [t.initialSpacer(e)]), this.dom.appendChild(this.spacer.dom), this.spacer.dom.style.cssText += "visibility: hidden; pointer-events: none");
  }
  update(e) {
    let t = this.markers;
...
class Wh {
  ...
  update(e, t, i, n) {
    this.height != t && (this.height = t, this.dom.style.height = t + "px"), this.above != i && (this.dom.style.marginTop = (this.above = i) ? i + "px" : ""), fp(this.markers, n) || this.setMarkers(e, n);
  }
  setMarkers(e, t) {
...
const up = /* @__PURE__ */ T.define(), dp = /* @__PURE__ */ T.define(), jt = /* @__PURE__ */ T.define({
  combine(s) {
    return it(s, { formatNumber: String, domEventHandlers: {} }, {
...
function Es(s, e) {
  return s.state.facet(jt).formatNumber(e, s.state);
}
const pp = /* @__PURE__ */ Ci.compute([jt], (s) => ({
  class: "cm-lineNumbers",
  renderEmptyElements: !1,
  markers(e) {
    return e.state.facet(up);
  },
  lineMarker(e, t, i) {
    return i.some((n) => n.toDOM) ? null : new Ls(Es(e, e.state.doc.lineAt(t.from).number));
  },
  widgetMarker: (e, t, i) => {
    for (let n of e.state.facet(dp)) {
      let r = n(e, t, i);
      if (r)
        return r;
    }
  ...
  domEventHandlers: s.facet(jt).domEventHandlers,
  side: "before"
}));
function mp(s = {}) {
  return [
...
const gp = /* @__PURE__ */ new class extends at {
  constructor() {
    super(...arguments), this.elementClass = "cm-activeLineGutter";
  }
}(), yp = /* @__PURE__ */ Mn.compute(["selection"], (s) => {
  let e = [], t = -1;
  for (let i of s.selection.ranges) {
    let n = s.doc.lineAt(i.head).from;
    n > t && (t = n, e.push(gp.range(n)));
  }
  return N.of(e);
});
function bp() {
...
class we {
  ...
  */
  static define(e) {
    let t = e.props && e.props.length ? /* @__PURE__ */ Object.create(null) : kp, i = (e.top ? 1 : 0) | (e.skipped ? 2 : 0) | (e.error ? 4 : 0) | (e.name == null ? 8 : 0), n = new we(e.name || "", t, e.id, i);
    if (e.props) {
  ...
  */
  extend(...e) {
    ...
    for (let i of this.types) {
      ...
      t.push(n ? new we(i.name, n, i.id, i.flags) : i);
    }
    return new lo(t);
  }
}
...
class X {
  ...
  */
  cursorAt(e, t = 0, i = 0) {
    let n = cn.get(this) || this.topNode, r = new Pr(n);
  ...
  */
  iterate(e) {
    let { enter: t, leave: i, from: n = 0, to: r = this.length } = e, o = e.mode || 0, l = (o & Y.IncludeAnonymous) > 0;
  ...
  */
  balance(e = {}) {
    return this.children.length <= 8 ? this : co(we.none, this.children, this.positions, 0, this.children.length, 0, this.length, (t, i, n) => new X(this.type, t, i, n, this.propValues), e.makeTree || ((t, i, n) => new X(we.none, t, i, n)));
  }
  /**
...
class vt {
  ...
  */
  findChild(e, t, i, n, r) {
    ...
    for (let a = e; a != t && !(Hh(r, n, o[a + 1], o[a + 2]) && (l = a, i > 0)); a = o[a + 3])
      ;
    return l;
  }
  /**
...
function Ei(s, e, t, i) {
  for (var n; s.from == s.to || (t < 1 ? s.from >= e : s.from > e) || (t > -1 ? s.to <= e : s.to < e); ) {
    let o = !i && s instanceof Le && s.index < 0 ? null : s.parent;
    if (!o)
      return s;
    s = o;
  }
  ...
  if (i)
    for (let o = s, l = o.parent; l; o = l, l = o.parent)
      o instanceof Le && o.index < 0 && ((n = l.enter(e, t, r)) === null || n === void 0 ? void 0 : n.from) != o.from && (s = l);
  for (; ; ) {
    let o = s.enter(e, t, r);
    if (!o)
      return s;
...
class Le extends Vh {
  ...
  nextChild(e, t, i, n, r = 0) {
    for (let o = this; ; ) {
      for (let { children: l, positions: a } = o._tree, h = t > 0 ? l.length : -1; e != h; e += t) {
        ...
        if (!(!(r & Y.EnterBracketed && c instanceof X && (u = Ai.get(c)) && !u.overlay && u.bracketed && i >= f && i <= f + c.length) && !Hh(n, i, f, f + c.length))) {
          if (c instanceof vt) {
            if (r & Y.ExcludeBuffers)
              continue;
            let d = c.findChild(0, c.buffer.length, t, i - f, n);
            if (d > -1)
              return new mt(new wp(o, c, e, f), null, d);
            ...
            return r & Y.IncludeAnonymous || !p.type.isAnonymous ? p : p.nextChild(t < 0 ? c.children.length - 1 : 0, t, i, n, r);
          }
        }
      }
  ...
  enter(e, t, i = 0) {
    let n;
    if (!(i & Y.IgnoreOverlays) && (n = Ai.get(this._tree)) && n.overlay) {
      let r = e - this.from, o = i & Y.EnterBracketed && n.bracketed;
      for (let { from: l, to: a } of n.overlay)
        if ((t > 0 || o ? l <= r : l < r) && (t < 0 || o ? a >= r : a > r))
          return new Le(n.tree, n.overlay[0].from + this.from, -1, this);
    }
...
class mt extends Vh {
  ...
  child(e, t, i) {
    ...
    return r < 0 ? null : new mt(this.context, this, r);
  }
  get firstChild() {
    return this.child(
      1,
  ...
  get nextSibling() {
    ...
    return t < (this._parent ? e.buffer[this._parent.index + 3] : e.buffer.length) ? new mt(this.context, this._parent, t) : this.externalSibling(1);
  }
  get prevSibling() {
    let { buffer: e } = this.context, t = this._parent ? this._parent.index + 4 : 0;
    return this.index == t ? this.externalSibling(-1) : new mt(this.context, this._parent, e.findChild(
      t,
      this.index,
      -1,
      0,
...
function zh(s) {
  ...
  let i = t instanceof Le && t.index < 0 ? null : t.parent, n = s.slice();
  return i ? n[e] = i : n.splice(e, 1), new vp(n, t);
}
class vp {
  constructor(e, t) {
  ...
  */
  get node() {
    ...
    for (let n = i; n < this.stack.length; n++)
      t = new mt(this.buffer, t, this.stack[n]);
    return this.bufferNode = new mt(this.buffer, t, this.index);
  }
  /**
...
function ho(s) {
  return s.children.some((e) => e instanceof vt || !e.type.isAnonymous || ho(e));
}
function Cp(s) {
  var e;
  let { buffer: t, nodeSet: i, maxBufferLength: n = Fh, reused: r = [], minRepeatType: o = i.types.length } = s, l = Array.isArray(t) ? new ao(t, t.length) : t, a = i.types, h = 0, c = 0;
  function f(w, A, S, L, W, $) {
    let { id: I, start: P, end: z, size: V } = l, U = c, ue = h;
    if (V < 0)
      if (l.next(), V == -1) {
        let nt = r[I];
        S.push(nt), L.push(P - w);
        return;
      } else if (V == -3) {
        h = I;
        return;
    ...
    let ve = a[I], qe, se, Oe = P - w;
    if (z - P <= n && (se = g(l.pos - A, W))) {
      let nt = new Uint16Array(se.size - se.skip), Te = l.pos - se.size, $e = nt.length;
      for (; l.pos > Te; )
        $e = y(se.start, nt, $e);
      qe = new vt(nt, z - se.start, i), Oe = se.start - w;
    } else {
      let nt = l.pos - V;
      l.next();
      let Te = [], $e = [], Mt = I >= o ? I : -1, zt = 0, Qi = z;
      for (; l.pos > nt; )
        Mt >= 0 && l.id == Mt && l.size >= 0 ? (l.end <= Qi - n && (p(Te, $e, P, zt, l.end, Qi, Mt, U, ue), zt = Te.length, Qi = l.end), l.next()) : $ > 2500 ? u(P, nt, Te, $e) : f(P, nt, Te, $e, Mt, $ + 1);
      if (Mt >= 0 && zt > 0 && zt < Te.length && p(Te, $e, P, zt, P, Qi, Mt, U, ue), Te.reverse(), $e.reverse(), Mt > -1 && zt > 0) {
        let Oo = d(ve, ue);
        qe = co(ve, Te, $e, 0, Te.length, 0, z - P, Oo, Oo);
      } else
        qe = m(ve, Te, $e, z - P, U - z, ue);
    }
    S.push(qe), L.push(Oe);
  }
  function u(w, A, S, L) {
    let W = [], $ = 0, I = -1;
    for (; l.pos > A; ) {
      let { id: P, start: z, end: V, size: U } = l;
      if (U > 4)
        l.next();
      else {
        if (I > -1 && z < I)
          break;
        I < 0 && (I = V - n), W.push(P, z, V), $++, l.next();
      }
    }
    if ($) {
      let P = new Uint16Array($ * 4), z = W[W.length - 2];
      for (let V = W.length - 3, U = 0; V >= 0; V -= 3)
        P[U++] = W[V], P[U++] = W[V + 1] - z, P[U++] = W[V + 2] - z, P[U++] = U;
      S.push(new vt(P, W[2] - z, i)), L.push(z - w);
    }
  }
  function d(w, A) {
    return (S, L, W) => {
      let $ = 0, I = S.length - 1, P, z;
      if (I >= 0 && (P = S[I]) instanceof X) {
        if (!I && P.type == w && P.length == W)
          return P;
        (z = P.prop(E.lookAhead)) && ($ = L[I] + P.length + z);
      }
      return m(w, S, L, W, $, A);
    };
  }
  function p(w, A, S, L, W, $, I, P, z) {
    let V = [], U = [];
    for (; w.length > L; )
      V.push(w.pop()), U.push(A.pop() + S - W);
    w.push(m(i.types[I], V, U, $ - W, P - $, z)), A.push(W - S);
  }
  function m(w, A, S, L, W, $, I) {
    if ($) {
      let P = [E.contextHash, $];
      I = I ? [P].concat(I) : [P];
    }
    ...
    return new X(w, A, S, L, I);
  }
  function g(w, A) {
    let S = l.fork(), L = 0, W = 0, $ = 0, I = S.end - n, P = { size: 0, start: 0, skip: 0 };
    e: for (let z = S.pos - w; S.pos > z; ) {
      let V = S.size;
      if (S.id == A && V >= 0) {
        P.size = L, P.start = W, P.skip = $, $ += 4, L += 4, S.next();
        continue;
      }
      let U = S.pos - V;
    ...
    return (A < 0 || L == w) && (P.size = L, P.start = W, P.skip = $), P.size > 4 ? P : void 0;
  }
  function y(w, A, S) {
    ...
    if (l.next(), I >= 0 && L < o) {
      ...
      A[--S] = P, A[--S] = $ - w, A[--S] = W - w, A[--S] = L;
    } else I == -3 ? h = L : I == -4 && (c = L);
    return S;
  }
  let x = [], k = [];
  for (; l.pos > 0; )
    f(s.start || 0, s.bufferStart || 0, x, k, -1, 0);
  let M = (e = s.length) !== null && e !== void 0 ? e : x.length ? k[0] + x[0].length : 0;
  return new X(a[s.topID], x.reverse(), k.reverse(), M);
}
const Dl = /* @__PURE__ */ new WeakMap();
function On(s, e) {
  if (!s.isAnonymous || e instanceof vt || e.type != s)
    return 1;
  let t = Dl.get(e);
  if (t == null) {
    t = 1;
  ...
  function d(p, m, g, y, x) {
    for (let k = g; k < y; ) {
      ...
      if (k == M + 1) {
        ...
        let S = m[k - 1] + p[k - 1].length - w;
        f.push(co(s, p, m, M, k, w, S, null, a));
      }
      u.push(w + x - r);
    }
  }
...
class Et {
  ...
  */
  static addTree(e, t = [], i = !1) {
    let n = [new Et(0, e.length, e, 0, !1, i)];
    for (let r of t)
...
class qh {
  ...
  */
  startParse(e, t, i) {
    return typeof e == "string" && (e = new Ap(e)), i = i ? i.length ? i.map((n) => new Is(n.from, n.to)) : [new Is(0, 0)] : [new Is(0, e.length)], this.createParse(e, t || [], i);
  }
  /**
...
class De {
  ...
  */
  constructor(e, t, i, n) {
    this.name = e, this.set = t, this.base = i, this.modified = n, this.id = Mp++;
  }
  toString() {
    let { name: e } = this;
  ...
  */
  static defineModifier(e) {
    let t = new zn(e);
    return (i) => i.modified.indexOf(t) > -1 ? i : zn.get(i.base || i, i.modified.concat(t).sort((n, r) => n.id - r.id));
  }
}
let Op = 0;
class zn {
  constructor(e) {
    this.name = e, this.instances = [], this.id = Op++;
  }
  static get(e, t) {
    if (!t.length)
      return e;
  ...
  combine(s, e) {
    ...
    for (; s || e; ) {
      if (!s || e && s.depth >= e.depth ? (n = e, e = e.next) : (n = s, s = s.next), t && t.mode == n.mode && !n.context && !t.context)
        continue;
      let r = new Ii(n.tags, n.mode, n.context);
      t ? t.next = r : i = r, t = r;
    }
    return i;
  }
...
function Pp(s, e, t, i = 0, n = s.length) {
...
class Rp {
  ...
  highlightRange(e, t, i, n, r) {
    ...
    let h = n, c = Lp(e) || Ii.empty, f = Bp(r, c.tags);
    ...
    if (u && u.overlay) {
      ...
      for (let g = 0, y = l; ; g++) {
        let x = g < u.overlay.length ? u.overlay[g] : null, k = x ? x.from + l : a, M = Math.max(t, y), w = Math.min(i, k);
        if (M < w && m)
          for (; e.from < w && (this.highlightRange(e, M, w, n, r), this.startSpan(Math.min(w, e.to), h), !(e.to >= k || !e.nextSibling())); )
            ;
        if (!x || k > i)
          break;
...
function Lp(s) {
  let e = s.type.prop(Kh);
  for (; e && e.context && !s.matchContext(e.context); )
    e = e.next;
  return e || null;
}
const C = De.define, fn = C(), ft = C(), Bl = C(ft), Pl = C(ft), ut = C(), un = C(ut), Ns = C(ut), Ge = C(), Ot = C(Ge), je = C(), Ue = C(), Rr = C(), ui = C(Rr), dn = C(), v = {
  /**
  A comment.
  */
  comment: fn,
...
class Fe {
  ...
  */
  constructor(e, t, i = [], n = "") {
    this.data = e, this.name = n, F.prototype.hasOwnProperty("tree") || Object.defineProperty(F.prototype, "tree", { get() {
      return ce(this);
...
function Rl(s, e, t) {
  let i = s.facet(St), n = ce(s).topNode;
  if (!i || i.allowsNesting)
    for (let r = n; r; r = r.enter(e, t, Y.ExcludeBuffers | Y.EnterBracketed))
      r.type.isTop && (n = r);
  return n;
}
class qn extends Fe {
...
class $n {
  ...
  */
  static create(e, t, i) {
    return new $n(e, t, [], X.empty, 0, i, [], null);
  }
  startParse() {
  ...
  work(e, t) {
    return t != null && t >= this.state.doc.length && (t = void 0), this.tree != X.empty && this.isDone(t ?? this.state.doc.length) ? (this.takeTree(), !0) : this.withContext(() => {
      ...
      for (this.parse || (this.parse = this.startParse()), t != null && (this.parse.stoppedAt == null || this.parse.stoppedAt > t) && t < this.state.doc.length && this.parse.stopAt(t); ; ) {
        ...
        if (n)
          if (this.fragments = this.withoutTempSkipped(Et.addTree(n, this.fragments, this.parse.stoppedAt != null)), this.treeLen = (i = this.parse.stoppedAt) !== null && i !== void 0 ? i : this.state.doc.length, this.tree = n, this.parse = null, this.treeLen < (t ?? this.state.doc.length))
  ...
  */
  changes(e, t) {
    ...
    if (this.takeTree(), !e.empty) {
      let a = [];
      if (e.iterChangedRanges((h, c, f, u) => a.push({ fromA: h, toA: c, fromB: f, toB: u })), i = Et.applyChanges(i, a), n = X.empty, r = 0, o = { from: e.mapPos(o.from, -1), to: e.mapPos(o.to, 1) }, this.skipped.length) {
        l = [];
    ...
    return new $n(this.parser, t, i, n, r, o, l, this.scheduleOn);
  }
  /**
  @internal
  */
  updateViewport(e) {
    ...
    for (let i = 0; i < this.skipped.length; i++) {
      ...
      n < e.to && r > e.from && (this.fragments = Ll(this.fragments, n, r), this.skipped.splice(i--, 1));
    }
      ...
      createParse(t, i, n) {
        ...
        return {
          ...
          advance() {
            ...
            return this.parsedPos = o, new X(we.none, [], [], o - r);
          },
          stoppedAt: null,
          stopAt() {
          }
...
function Ll(s, e, t) {
  return Et.applyChanges(s, [{ fromA: e, toA: t, fromB: e, toB: t }]);
}
class ri {
  constructor(e) {
...
Fe.state = /* @__PURE__ */ ae.define({
  create: ri.init,
  update(s, e) {
    for (let t of e.effects)
      if (t.is(Fe.setState))
        return t.value;
    return e.startState.facet(St) != e.state.facet(St) ? ri.init(e.state) : s.apply(e);
  }
});
let Uh = (s) => {
  let e = setTimeout(
...
const Fs = typeof navigator < "u" && (!((Ws = navigator.scheduling) === null || Ws === void 0) && Ws.isInputPending) ? () => navigator.scheduling.isInputPending() : null, Wp = /* @__PURE__ */ J.fromClass(class {
  constructor(e) {
  ...
  scheduleWork() {
    ...
    (t.tree != t.context.tree || !t.context.isDone(e.doc.length)) && (this.working = Uh(this.work));
  }
  work(e) {
    this.working = null;
    let t = Date.now();
    if (this.chunkEnd < t && (this.chunkEnd < 0 || this.view.hasFocus) && (this.chunkEnd = t + 3e4, this.chunkBudget = 3e3), this.chunkBudget <= 0)
      return;
    let { state: i, viewport: { to: n } } = this.view, r = i.field(Fe.state);
    if (r.tree == r.context.tree && r.context.isDone(
      n + 1e5
      /* Work.MaxParseAhead */
    ))
      return;
    let o = Date.now() + Math.min(this.chunkBudget, 100, e && !Fs ? Math.max(25, e.timeRemaining() - 5) : 1e9), l = r.context.treeLen < n && i.doc.length > n + 1e3, a = r.context.work(() => Fs && Fs() || Date.now() > o, n + (l ? 0 : 1e5));
  ...
  enables: (s) => [
    Fe.state,
    Wp,
    D.contentAttributes.compute([s], (e) => {
      let t = e.facet(s);
...
const Hp = /* @__PURE__ */ T.define(), fo = /* @__PURE__ */ T.define({
  combine: (s) => {
    if (!s.length)
      return "  ";
    let e = s[0];
...
function Ni(s, e) {
  let t = "", i = s.tabSize, n = s.facet(fo)[0];
  if (n == "	") {
    for (; e >= i; )
      t += "	", e -= i;
    n = " ";
...
function uo(s, e) {
  s instanceof F && (s = new fs(s));
  for (let i of s.state.facet(Hp)) {
    let n = i(s, e);
    if (n !== void 0)
      return n;
  }
  let t = ce(s.state);
  return t.length >= e ? Vp(s, t, e) : null;
}
class fs {
  /**
...
function qp(s) {
  let e = s.type.prop(Gh);
  if (e)
    return e;
  let t = s.firstChild, i;
  if (t && (i = t.type.prop(E.closedBy))) {
    let n = s.lastChild, r = n && i.indexOf(n.name) > -1;
    return (o) => Up(o, !0, 1, void 0, r && !zp(o) ? n.from : void 0);
  }
  return s.parent == null ? $p : null;
}
function $p() {
  return 0;
}
class po extends fs {
  ...
  */
  continue() {
    return Qh(this.context.next, this.base, this.pos);
  }
}
function Kp(s, e) {
...
function Up(s, e, t, i, n) {
  let r = s.textAfter, o = r.match(/^\s*/)[0].length, l = i && r.slice(o, o + i.length) == i || n == s.pos + o, a = jp(s);
  return a ? l ? s.column(a.from) : s.column(a.to) : s.baseIndent + (l ? 0 : s.unit * t);
}
function El({ except: s, units: e = 1 } = {}) {
  return (t) => {
...
const Yp = /* @__PURE__ */ T.define(), Yh = /* @__PURE__ */ new E();
function _p(s) {
...
function Xp(s, e, t) {
  ...
  for (let o = n; o; o = o.next) {
    ...
    if (r && l.from < e)
      break;
    let a = l.type.prop(Yh);
    if (a && (l.to < i.length - 50 || i.length == s.doc.length || !Jp(l))) {
      let h = a(l, s);
...
const us = /* @__PURE__ */ R.define({ map: _h }), ji = /* @__PURE__ */ R.define({ map: _h });
function Xh(s) {
  let e = [];
...
const Ht = /* @__PURE__ */ ae.define({
  create() {
    return B.none;
  },
  update(s, e) {
    e.isUserEvent("delete") && e.changes.iterChangedRanges((t, i) => s = Il(s, t, i)), s = s.map(e.changes);
    for (let t of e.effects)
      if (t.is(us) && !Zp(s, t.value.from, t.value.to)) {
        let { preparePlaceholder: i } = e.state.facet(ec), n = i ? B.replace({ widget: new om(i(e.state, t.value)) }) : Nl;
        s = s.update({ add: [n.range(t.value.from, t.value.to)] });
      } else t.is(ji) && (s = s.update({
        filter: (i, n) => t.value.from != i || t.value.to != n,
        filterFrom: t.value.from,
        filterTo: t.value.to
      }));
    return e.selection && (s = Il(s, e.selection.main.head)), s;
  },
...
function Un(s, e, t) {
  var i;
  let n = null;
  return (i = s.field(Ht, !1)) === null || i === void 0 || i.between(e, t, (r, o) => {
...
function Jh(s, e) {
  return s.field(Ht, !1) ? e : e.concat(R.appendConfig.of(tc()));
}
const em = (s) => {
  for (let e of Xh(s)) {
    let t = jn(s.state, e.from, e.to);
    if (t)
      return s.dispatch({ effects: Jh(s.state, [us.of(t), Zh(s, t)]) }), !0;
  }
  return !1;
}, tm = (s) => {
  if (!s.state.field(Ht, !1))
    return !1;
  let e = [];
  for (let t of Xh(s)) {
    let i = Un(s.state, t.from, t.to);
    i && e.push(ji.of(i), Zh(s, i, !1));
  }
  return e.length && s.dispatch({ effects: e }), e.length > 0;
};
function Zh(s, e, t = !0) {
  let i = s.state.doc.lineAt(e.from).number, n = s.state.doc.lineAt(e.to).number;
  return D.announce.of(`${s.state.phrase(t ? "Folded lines" : "Unfolded lines")} ${i} ${s.state.phrase("to")} ${n}.`);
}
const im = (s) => {
  let { state: e } = s, t = [];
  for (let i = 0; i < e.doc.length; ) {
    let n = s.lineBlockAt(i), r = jn(e, n.from, n.to);
    r && t.push(us.of(r)), i = (r ? s.lineBlockAt(r.to) : n).to + 1;
  }
  return t.length && s.dispatch({ effects: Jh(s.state, t) }), !!t.length;
}, nm = (s) => {
  let e = s.state.field(Ht, !1);
  if (!e || !e.size)
    return !1;
  let t = [];
  return e.between(0, s.state.doc.length, (i, n) => {
    t.push(ji.of({ from: i, to: n }));
...
function ic(s, e) {
  let { state: t } = s, i = t.facet(ec), n = (o) => {
    let l = s.lineBlockAt(s.posAtDOM(o.target)), a = Un(s.state, l.from, l.to);
    a && s.dispatch({ effects: ji.of(a) }), o.preventDefault();
  };
  if (i.placeholderDOM)
...
const Nl = /* @__PURE__ */ B.replace({ widget: /* @__PURE__ */ new class extends ct {
  toDOM(s) {
    return ic(s, null);
  }
}() });
...
function am(s = {}) {
  let e = { ...lm, ...s }, t = new Hs(e, !0), i = new Hs(e, !1), n = J.fromClass(class {
    constructor(o) {
      this.from = o.viewport.from, this.markers = this.buildMarkers(o);
    }
    update(o) {
      (o.docChanged || o.viewportChanged || o.startState.facet(St) != o.state.facet(St) || o.startState.field(Ht, !1) != o.state.field(Ht, !1) || ce(o.startState) != ce(o.state) || e.foldingChanged(o)) && (this.markers = this.buildMarkers(o.view));
    }
    buildMarkers(o) {
      let l = new ot();
  ...
  return [
    ...
    ap({
      ...
      markers(o) {
        var l;
        return ((l = o.plugin(n)) === null || l === void 0 ? void 0 : l.markers) || N.empty;
      },
      initialSpacer() {
        return new Hs(e, !1);
      },
...
class ds {
  constructor(e, t) {
    ...
    this.scope = o instanceof Fe ? (l) => l.prop(Ut) == o.data : o ? (l) => l == o : void 0, this.style = jh(e.map((l) => ({
      tag: l.tag,
...
const Lr = /* @__PURE__ */ T.define(), nc = /* @__PURE__ */ T.define({
  combine(s) {
    return s.length ? [s[0]] : null;
  }
});
function Vs(s) {
  let e = s.facet(Lr);
  return e.length ? e : s.facet(nc);
}
function cm(s, e) {
  let t = [um], i;
  return s instanceof ds && (s.module && t.push(D.styleModule.of(s.module)), i = s.themeType), e != null && e.fallback ? t.push(nc.of(s)) : i ? t.push(Lr.computeN([D.darkTheme], (n) => n.facet(D.darkTheme) == (i == "dark") ? [s] : [])) : t.push(Lr.of(s)), t;
}
class fm {
  constructor(e) {
    this.markCache = /* @__PURE__ */ Object.create(null), this.tree = ce(e.state), this.decorations = this.buildDeco(e, Vs(e.state)), this.decoratedTo = e.viewport.to;
  }
  update(e) {
    let t = ce(e.state), i = Vs(e.state), n = i != Vs(e.startState), { viewport: r } = e.view, o = e.changes.mapPos(this.decoratedTo, 1);
...
const um = /* @__PURE__ */ Vt.high(/* @__PURE__ */ J.fromClass(fm, {
  decorations: (s) => s.decorations
})), dm = /* @__PURE__ */ ds.define([
  {
    tag: v.meta,
    color: "#404740"
  },
...
}), sc = 1e4, rc = "()[]{}", oc = /* @__PURE__ */ T.define({
  combine(s) {
    return it(s, {
      afterCursor: !0,
      brackets: rc,
...
}), mm = /* @__PURE__ */ B.mark({ class: "cm-matchingBracket" }), gm = /* @__PURE__ */ B.mark({ class: "cm-nonmatchingBracket" });
function ym(s) {
  let e = [], t = s.matched ? mm : gm;
  return e.push(t.range(s.start.from, s.start.to)), s.end && e.push(t.range(s.end.from, s.end.to)), e;
}
const bm = /* @__PURE__ */ ae.define({
  create() {
    return B.none;
  },
  update(s, e) {
    if (!e.docChanged && !e.selection)
      return s;
    let t = [], i = e.state.facet(oc);
    for (let n of e.state.selection.ranges) {
      if (!n.empty)
        continue;
      let r = Je(e.state, n.head, -1, i) || n.head > 0 && Je(e.state, n.head - 1, 1, i) || i.afterCursor && (Je(e.state, n.head, 1, i) || n.head < e.state.doc.length && Je(e.state, n.head + 1, -1, i));
...
function Ir(s) {
  let e = s.type.prop(wm);
  return e ? e(s.node) : s;
}
function Je(s, e, t, i = {}) {
  let n = i.maxScanDistance || sc, r = i.brackets || rc, o = ce(s), l = o.resolveInner(e, t);
  for (let a = l; a; a = a.parent) {
    let h = Er(a.type, t, r);
    if (h && a.from < a.to) {
      let c = Ir(a);
      if (c && (t > 0 ? e >= c.from && e < c.to : e > c.from && e <= c.to))
        return vm(s, e, t, a, c, h, r);
    }
  }
  return Sm(s, e, t, o, l.type, n, r);
}
function vm(s, e, t, i, n, r, o) {
...
const Cm = /* @__PURE__ */ Object.create(null), Wl = [we.none], Fl = [], Hl = /* @__PURE__ */ Object.create(null), Am = /* @__PURE__ */ Object.create(null);
for (let [s, e] of [
  ...
  Am[s] = /* @__PURE__ */ Mm(Cm, e);
function zs(s, e) {
  Fl.indexOf(s) > -1 || (Fl.push(s), console.warn(e));
}
function Mm(s, e) {
  let t = [];
  ...
  if (!t.length)
    return 0;
  let i = e.replace(/ /g, "_"), n = i + " " + t.map((l) => l.id), r = Hl[n];
  if (r)
    return r.id;
  let o = Hl[n] = we.define({
    id: Wl.length,
    name: i,
    props: [$h({ [i]: t })]
  });
  return Wl.push(o), o.id;
}
j.RTL, j.LTR;
const Om = (s) => {
  let { state: e } = s, t = e.doc.lineAt(e.selection.main.from), i = go(s.state, t.from);
  return i.line ? Tm(s) : i.block ? Bm(s) : !1;
};
function mo(s, e) {
...
const pi = 50;
function Pm(s, { open: e, close: t }, i, n) {
  let r = s.sliceDoc(i - pi, i), o = s.sliceDoc(n, n + pi), l = /\s*$/.exec(r)[0].length, a = /^\s*/.exec(o)[0].length, h = r.length - l;
  ...
  let c, f;
  n - i <= 2 * pi ? c = f = s.sliceDoc(i, n) : (c = s.sliceDoc(i, i + pi), f = s.sliceDoc(n - pi, n));
...
function lc(s, e, t = e.selection.ranges) {
  let i = t.map((r) => go(e, r.from).block);
  if (!i.every((r) => r))
    return null;
  let n = t.map((r, o) => Pm(e, i[o], r.from, r.to));
  if (s != 2 && !n.every((r) => r))
...
function Lm(s, e, t = e.selection.ranges) {
  let i = [], n = -1;
...
const Nr = /* @__PURE__ */ ht.define(), Em = /* @__PURE__ */ ht.define(), Im = /* @__PURE__ */ T.define(), ac = /* @__PURE__ */ T.define({
  combine(s) {
    return it(s, {
      minDepth: 100,
      newGroupDelay: 500,
  ...
  update(s, e) {
    let t = e.state.facet(ac), i = e.annotation(Nr);
    if (i) {
      let a = ke.fromTransaction(e, i.selection), h = i.side, c = h == 0 ? s.undone : s.done;
      return a ? c = Gn(c, c.length, t.minDepth, a) : c = uc(c, e.startState.selection), new Ze(h == 0 ? i.rest : c, h == 0 ? c : i.rest);
    }
    let n = e.annotation(Em);
    if ((n == "full" || n == "before") && (s = s.isolate()), e.annotation(te.addToHistory) === !1)
      return e.changes.empty ? s : s.addMapping(e.changes.desc);
    let r = ke.fromTransaction(e), o = e.annotation(te.time), l = e.annotation(te.userEvent);
  ...
  fromJSON(s) {
    return new Ze(s.done.map(ke.fromJSON), s.undone.map(ke.fromJSON));
  }
});
function Nm(s = {}) {
  return [
    ...
    D.domEventHandlers({
      beforeinput(e, t) {
        let i = e.inputType == "historyUndo" ? cc : e.inputType == "historyRedo" ? Wr : null;
...
const cc = /* @__PURE__ */ ps(0, !1), Wr = /* @__PURE__ */ ps(1, !1), Wm = /* @__PURE__ */ ps(0, !0), Fm = /* @__PURE__ */ ps(1, !0);
class ke {
  constructor(e, t, i, n, r) {
  ...
  static fromJSON(e) {
    return new ke(e.changes && ee.fromJSON(e.changes), [], e.mapped && tt.fromJSON(e.mapped), e.startSelection && b.fromJSON(e.startSelection), e.selectionsAfter.map(b.fromJSON));
  }
  ...
  static fromTransaction(e, t) {
    let i = Pe;
    for (let n of e.startState.facet(Im)) {
      let r = n(e);
      r.length && (i = i.concat(r));
    }
    return !i.length && e.changes.empty ? null : new ke(e.changes.invert(e.startState.doc), i, void 0, t || e.startState.selection, Pe);
  }
  static selection(e) {
    return new ke(void 0, Pe, void 0, void 0, e);
  }
}
function Gn(s, e, t, i) {
...
function uc(s, e) {
  if (s.length) {
    let t = s[s.length - 1], i = t.selectionsAfter.slice(Math.max(0, t.selectionsAfter.length - zm));
...
function qs(s, e) {
  ...
  return i.length ? [ke.selection(i)] : Pe;
}
function $m(s, e, t) {
  let i = fc(s.selectionsAfter.length ? s.selectionsAfter.map((l) => l.map(e)) : Pe, t);
  if (!s.changes)
    return ke.selection(i);
  let n = s.changes.map(e), r = e.mapDesc(s.changes, !0), o = s.mapped ? s.mapped.composeDesc(r) : r;
  return new ke(n, R.mapEffects(s.effects, e), o, s.startSelection.map(r), i);
}
...
class Ze {
  ...
  addChanges(e, t, i, n, r) {
    ...
    return l && l.changes && !l.changes.empty && e.changes && (!i || Km.test(i)) && (!l.selectionsAfter.length && t - this.prevTime < n.newGroupDelay && n.joinToEvent(r, Hm(l.changes, e.changes)) || // For compose (but not compose.start) events, always join with previous event
    i == "input.type.compose") ? o = Gn(o, o.length - 1, n.minDepth, new ke(e.changes.compose(l.changes), fc(R.mapEffects(e.effects, l.changes), l.effects), l.mapped, l.startSelection, Pe)) : o = Gn(o, o.length, n.minDepth, e), new Ze(o, Pe, t, i);
  }
  addSelection(e, t, i, n) {
    let r = this.done.length ? this.done[this.done.length - 1].selectionsAfter : Pe;
    return r.length > 0 && t - this.prevTime < n && i == this.prevUserEvent && i && /^select($|\.)/.test(i) && Vm(r[r.length - 1], e) ? this : new Ze(uc(this.done, e), this.undone, t, i);
  }
  addMapping(e) {
  ...
  pop(e, t, i) {
    ...
    if (i && r.selectionsAfter.length)
      return t.update({
        ...
        annotations: Nr.of({ side: e, rest: qm(n), selection: o }),
        userEvent: e == 0 ? "select.undo" : "select.redo",
        scrollIntoView: !0
      });
    if (r.changes) {
      let l = n.length == 1 ? Pe : n.slice(0, n.length - 1);
...
const jm = [
  { key: "Mod-z", run: cc, preventDefault: !0 },
...
function ai(s, e) {
  return b.create(s.ranges.map(e), s.mainIndex);
}
function Ve(s, e) {
  return s.update({ selection: e, scrollIntoView: !0, userEvent: "select" });
}
function ze({ state: s, dispatch: e }, t) {
  let i = ai(s.selection, t);
  return i.eq(s.selection, !0) ? !1 : (e(Ve(s, i)), !0);
}
function ms(s, e) {
  return b.cursor(e ? s.to : s.from);
}
function dc(s, e) {
  return ze(s, (t) => t.empty ? s.moveByChar(t, e) : ms(t, e));
}
function fe(s) {
  return s.textDirectionAt(s.state.selection.main.head) == j.LTR;
}
const pc = (s) => dc(s, !fe(s)), mc = (s) => dc(s, fe(s));
function gc(s, e) {
  return ze(s, (t) => t.empty ? s.moveByGroup(t, e) : ms(t, e));
}
const Um = (s) => gc(s, !fe(s)), Gm = (s) => gc(s, fe(s));
function Qm(s, e, t) {
  if (e.type.prop(t))
    return !0;
  let i = e.to - e.from;
...
function gs(s, e, t) {
  let i = ce(s).resolveInner(e.head), n = t ? E.closedBy : E.openedBy;
  for (let a = e.head; ; ) {
    let h = t ? i.childAfter(a) : i.childBefore(a);
    if (!h)
      break;
    Qm(s, h, n) ? i = h : a = t ? h.to : h.from;
  }
  let r = i.type.prop(n), o, l;
  return r && (o = t ? Je(s, i.from, 1) : Je(s, i.to, -1)) && o.matched ? l = t ? o.end.to : o.end.from : l = t ? i.to : i.from, b.cursor(l, t ? -1 : 1);
}
const Ym = (s) => ze(s, (e) => gs(s.state, e, !fe(s))), _m = (s) => ze(s, (e) => gs(s.state, e, fe(s)));
function yc(s, e) {
  return ze(s, (t) => {
    if (!t.empty)
      return ms(t, e);
...
function wc(s, e) {
  let t = kc(s), { state: i } = s, n = ai(i.selection, (o) => o.empty ? s.moveVertically(o, e, t.height) : ms(o, e));
  if (n.eq(i.selection))
    return !1;
  let r;
  if (t.selfScroll) {
  ...
  return s.dispatch(Ve(i, n), { effects: r }), !0;
}
const Vl = (s) => wc(s, !1), Fr = (s) => wc(s, !0);
function At(s, e, t) {
  ...
  if (n.head == e.head && n.head != (t ? i.to : i.from) && (n = s.moveToLineBoundary(e, t, !1)), !t && n.head == i.from && i.length) {
    ...
    r && e.head != i.from + r && (n = b.cursor(i.from + r));
  }
  return n;
}
const Xm = (s) => ze(s, (e) => At(s, e, !0)), Jm = (s) => ze(s, (e) => At(s, e, !1)), Zm = (s) => ze(s, (e) => At(s, e, !fe(s))), eg = (s) => ze(s, (e) => At(s, e, fe(s))), tg = (s) => ze(s, (e) => b.cursor(s.lineBlockAt(e.head).from, 1)), ig = (s) => ze(s, (e) => b.cursor(s.lineBlockAt(e.head).to, -1));
function ng(s, e, t) {
  let i = !1, n = ai(s.selection, (r) => {
    let o = Je(s, r.head, -1) || Je(s, r.head, 1) || r.head > 0 && Je(s, r.head - 1, 1) || r.head < s.doc.length && Je(s, r.head + 1, -1);
    if (!o || !o.end)
      return r;
    i = !0;
  ...
  return i ? (e(Ve(s, n)), !0) : !1;
}
const sg = ({ state: s, dispatch: e }) => ng(s, e);
function Ie(s, e) {
  let t = ai(s.state.selection, (i) => {
    let n = e(i);
    return b.range(i.anchor, n.head, n.goalColumn, n.bidiLevel || void 0);
  });
  return t.eq(s.state.selection) ? !1 : (s.dispatch(Ve(s.state, t)), !0);
}
function vc(s, e) {
  return Ie(s, (t) => s.moveByChar(t, e));
}
const Sc = (s) => vc(s, !fe(s)), Cc = (s) => vc(s, fe(s));
function Ac(s, e) {
  return Ie(s, (t) => s.moveByGroup(t, e));
}
const rg = (s) => Ac(s, !fe(s)), og = (s) => Ac(s, fe(s)), lg = (s) => Ie(s, (e) => gs(s.state, e, !fe(s))), ag = (s) => Ie(s, (e) => gs(s.state, e, fe(s)));
function Mc(s, e) {
  return Ie(s, (t) => s.moveVertically(t, e));
}
const Oc = (s) => Mc(s, !1), Tc = (s) => Mc(s, !0);
function Dc(s, e) {
  return Ie(s, (t) => s.moveVertically(t, e, kc(s).height));
}
const zl = (s) => Dc(s, !1), ql = (s) => Dc(s, !0), hg = (s) => Ie(s, (e) => At(s, e, !0)), cg = (s) => Ie(s, (e) => At(s, e, !1)), fg = (s) => Ie(s, (e) => At(s, e, !fe(s))), ug = (s) => Ie(s, (e) => At(s, e, fe(s))), dg = (s) => Ie(s, (e) => b.cursor(s.lineBlockAt(e.head).from)), pg = (s) => Ie(s, (e) => b.cursor(s.lineBlockAt(e.head).to)), $l = ({ state: s, dispatch: e }) => (e(Ve(s, { anchor: 0 })), !0), Kl = ({ state: s, dispatch: e }) => (e(Ve(s, { anchor: s.doc.length })), !0), jl = ({ state: s, dispatch: e }) => (e(Ve(s, { anchor: s.selection.main.anchor, head: 0 })), !0), Ul = ({ state: s, dispatch: e }) => (e(Ve(s, { anchor: s.selection.main.anchor, head: s.doc.length })), !0), mg = ({ state: s, dispatch: e }) => (e(s.update({ selection: { anchor: 0, head: s.doc.length }, userEvent: "select" })), !0), gg = ({ state: s, dispatch: e }) => {
  let t = ys(s).map(({ from: i, to: n }) => b.range(i, Math.min(n + 1, s.doc.length)));
  return e(s.update({ selection: b.create(t), userEvent: "select" })), !0;
}, yg = ({ state: s, dispatch: e }) => {
  let t = ai(s.selection, (i) => {
    let n = ce(s), r = n.resolveStack(i.from, 1);
    if (i.empty) {
  ...
  return t.eq(s.selection) ? !1 : (e(Ve(s, t)), !0);
};
function Bc(s, e) {
  ...
  return n.length == i.ranges.length ? !1 : (s.dispatch(Ve(t, b.create(n, n.length - 1))), !0);
}
const bg = (s) => Bc(s, !1), xg = (s) => Bc(s, !0), kg = ({ state: s, dispatch: e }) => {
  let t = s.selection, i = null;
  return t.ranges.length > 1 ? i = b.create([t.main]) : t.main.empty || (i = b.create([b.cursor(t.main.head)])), i ? (e(Ve(s, i)), !0) : !1;
};
function Ui(s, e) {
  if (s.state.readOnly)
    return !1;
  let t = "delete.selection", { state: i } = s, n = i.changeByRange((r) => {
    ...
    if (o == l) {
      let a = e(r);
      a < o ? (t = "delete.backward", a = pn(s, a, !1)) : a > o && (t = "delete.forward", a = pn(s, a, !0)), o = Math.min(o, a), l = Math.max(l, a);
    } else
      o = pn(s, o, !1), l = pn(s, l, !0);
...
const Pc = (s, e, t) => Ui(s, (i) => {
  ...
  if (t && !e && n > o.from && n < o.from + 200 && !/[^ \t]/.test(l = o.text.slice(0, n - o.from))) {
    ...
    a = ne(o.text, n - o.from, e, e) + o.from, a == n && o.number != (e ? r.doc.lines : 1) ? a += e ? 1 : -1 : !e && /[\ufe00-\ufe0f]/.test(o.text.slice(a - o.from, n - o.from)) && (a = ne(o.text, a - o.from, !1, !1) + o.from);
  return a;
}), Hr = (s) => Pc(s, !1, !0), Rc = (s) => Pc(s, !0, !1), Lc = (s, e) => Ui(s, (t) => {
  ...
  return i;
}), Ec = (s) => Lc(s, !1), wg = (s) => Lc(s, !0), vg = (s) => Ui(s, (e) => {
...
}, Mg = ({ state: s, dispatch: e }) => {
  if (s.readOnly)
    return !1;
  let t = s.changeByRange((i) => {
    if (!i.empty || i.from == 0 || i.from == s.doc.length)
      return { range: i };
    let n = i.from, r = s.doc.lineAt(n), o = n == r.from ? n - 1 : ne(r.text, n - r.from, !1) + r.from, l = n == r.to ? n + 1 : ne(r.text, n - r.from, !0) + r.from;
    return {
...
const Og = ({ state: s, dispatch: e }) => Ic(s, e, !1), Tg = ({ state: s, dispatch: e }) => Ic(s, e, !0);
function Nc(s, e, t) {
  if (s.readOnly)
    return !1;
  let i = [];
...
const Dg = ({ state: s, dispatch: e }) => Nc(s, e, !1), Bg = ({ state: s, dispatch: e }) => Nc(s, e, !0), Pg = (s) => {
  if (s.state.readOnly)
    return !1;
  let { state: e } = s, t = e.changes(ys(e).map(({ from: n, to: r }) => (n > 0 ? n-- : r < e.doc.length && r++, { from: n, to: r }))), i = ai(e.selection, (n) => {
    let r;
    if (s.lineWrapping) {
...
function Rg(s, e) {
  if (/\(\)|\[\]|\{\}/.test(s.sliceDoc(e - 1, e + 1)))
    return { from: e, to: e };
  let t = ce(s).resolveInner(e), i = t.childBefore(e), n = t.childAfter(e), r;
...
const Gl = /* @__PURE__ */ Wc(!1), Lg = /* @__PURE__ */ Wc(!0);
function Wc(s) {
  return ({ state: e, dispatch: t }) => {
    if (e.readOnly)
      return !1;
    let i = e.changeByRange((n) => {
      let { from: r, to: o } = n, l = e.doc.lineAt(r), a = !s && r == o && Rg(e, r);
...
const Eg = ({ state: s, dispatch: e }) => {
  if (s.readOnly)
    return !1;
  let t = /* @__PURE__ */ Object.create(null), i = new fs(s, { overrideIndentation: (r) => {
    let o = t[r];
    return o ?? -1;
  } }), n = yo(s, (r, o, l) => {
    let a = uo(i, r.from);
    if (a == null)
      return;
    /\S/.test(r.text) || (a = 0);
    let h = /^\s*/.exec(r.text)[0], c = Ni(s, a);
...
}, Ig = ({ state: s, dispatch: e }) => s.readOnly ? !1 : (e(s.update(yo(s, (t, i) => {
  i.push({ from: t.from, insert: s.facet(fo) });
}), { userEvent: "input.indent" })), !0), Ng = ({ state: s, dispatch: e }) => s.readOnly ? !1 : (e(s.update(yo(s, (t, i) => {
  let n = /^\s*/.exec(t.text)[0];
  if (!n)
    return;
  let r = li(n, s.tabSize), o = 0, l = Ni(s, Math.max(0, r - Kn(s)));
  for (; o < n.length && o < l.length && n.charCodeAt(o) == l.charCodeAt(o); )
    o++;
  i.push({ from: t.from + o, to: t.from + n.length, insert: l.slice(o) });
}), { userEvent: "delete.dedent" })), !0), Wg = (s) => (s.setTabFocusMode(), !0), Fg = [
  { key: "Ctrl-b", run: pc, shift: Sc, preventDefault: !0 },
  { key: "Ctrl-f", run: mc, shift: Cc },
  { key: "Ctrl-p", run: bc, shift: Oc },
  { key: "Ctrl-n", run: xc, shift: Tc },
  ...
  { key: "ArrowLeft", run: pc, shift: Sc, preventDefault: !0 },
  { key: "Mod-ArrowLeft", mac: "Alt-ArrowLeft", run: Um, shift: rg, preventDefault: !0 },
  { mac: "Cmd-ArrowLeft", run: Zm, shift: fg, preventDefault: !0 },
  { key: "ArrowRight", run: mc, shift: Cc, preventDefault: !0 },
  { key: "Mod-ArrowRight", mac: "Alt-ArrowRight", run: Gm, shift: og, preventDefault: !0 },
  { mac: "Cmd-ArrowRight", run: eg, shift: ug, preventDefault: !0 },
  { key: "ArrowUp", run: bc, shift: Oc, preventDefault: !0 },
  { mac: "Cmd-ArrowUp", run: $l, shift: jl },
  { mac: "Ctrl-ArrowUp", run: Vl, shift: zl },
  { key: "ArrowDown", run: xc, shift: Tc, preventDefault: !0 },
  { mac: "Cmd-ArrowDown", run: Kl, shift: Ul },
  { mac: "Ctrl-ArrowDown", run: Fr, shift: ql },
  { key: "PageUp", run: Vl, shift: zl },
  { key: "PageDown", run: Fr, shift: ql },
  { key: "Home", run: Jm, shift: cg, preventDefault: !0 },
  { key: "Mod-Home", run: $l, shift: jl },
  { key: "End", run: Xm, shift: hg, preventDefault: !0 },
  { key: "Mod-End", run: Kl, shift: Ul },
  { key: "Enter", run: Gl, shift: Gl },
  { key: "Mod-a", run: mg },
  { key: "Backspace", run: Hr, shift: Hr, preventDefault: !0 },
  { key: "Delete", run: Rc, preventDefault: !0 },
...
].concat(/* @__PURE__ */ Fg.map((s) => ({ mac: s.key, run: s.run, shift: s.shift }))), Vg = /* @__PURE__ */ [
  { key: "Alt-ArrowLeft", mac: "Ctrl-ArrowLeft", run: Ym, shift: lg },
  { key: "Alt-ArrowRight", mac: "Ctrl-ArrowRight", run: _m, shift: ag },
  { key: "Alt-ArrowUp", run: Og },
  ...
  { key: "Mod-]", run: Ig },
  { key: "Mod-Alt-\\", run: Eg },
  { key: "Shift-Mod-k", run: Pg },
  { key: "Shift-Mod-\\", run: sg },
  { key: "Mod-/", run: Om },
  { key: "Alt-A", run: Dm },
  { key: "Ctrl-m", mac: "Shift-Alt-m", run: Wg }
].concat(Hg), Ql = typeof String.prototype.normalize == "function" ? (s) => s.normalize("NFKD") : (s) => s;
class oi {
  /**
  ...
  */
  constructor(e, t, i = 0, n = e.length, r, o) {
    this.test = o, this.value = { from: 0, to: 0 }, this.done = !1, this.matches = [], this.buffer = "", this.bufferPos = 0, this.iter = e.iterRange(i, n), this.bufferStart = i, this.normalize = r ? (l) => r(Ql(l)) : Ql, this.query = this.normalize(t);
  }
  peek() {
...
const Fc = { from: -1, to: -1, match: /* @__PURE__ */ /.*/.exec("") }, bo = "gm" + (/x/.unicode == null ? "" : "u");
class Hc {
  /**
  ...
  */
  constructor(e, t, i, n = 0, r = e.length) {
    if (this.text = e, this.to = r, this.curLine = "", this.done = !1, this.value = Fc, /\\[sWDnr]|\n|\r|\[\^/.test(t))
      return new Vc(e, t, i, n, r);
    this.re = new RegExp(t, bo + (i != null && i.ignoreCase ? "i" : "")), this.test = i == null ? void 0 : i.test, this.iter = e.iter();
    let o = e.lineAt(n);
    this.curLineStart = o.from, this.matchPos = Qn(e, n), this.getLine(this.curLineStart);
  }
  getLine(e) {
  ...
  next() {
    for (let e = this.matchPos - this.curLineStart; ; ) {
      ...
      if (t) {
        ...
        if (this.matchPos = Qn(this.text, n + (i == n ? 1 : 0)), i == this.curLineStart + this.curLine.length && this.nextLine(), (i < n || i > this.value.to) && (!this.test || this.test(i, n, t)))
...
class Jt {
  ...
  static get(e, t, i) {
    ...
    if (n.from == t && n.to == i)
      return n;
    let { text: r, from: o } = n;
    return o > t && (r = e.sliceString(t, o) + r, o = t), n.to < i && (r += e.sliceString(n.to, i)), $s.set(e, new Jt(o, r)), new Jt(t, r.slice(t - o, i - o));
  }
}
class Vc {
  constructor(e, t, i, n, r) {
    this.text = e, this.to = r, this.done = !1, this.value = Fc, this.matchPos = Qn(e, n), this.re = new RegExp(t, bo + (i != null && i.ignoreCase ? "i" : "")), this.test = i == null ? void 0 : i.test, this.flat = Jt.get(e, n, this.chunkEnd(
      n + 5e3
      /* Chunk.Base */
    ));
  }
    ...
    for (; ; ) {
      ...
      if (t && !t[0] && t.index == e && (this.re.lastIndex = e + 1, t = this.re.exec(this.flat.text)), t) {
        ...
        if ((this.flat.to >= this.to || t.index + t[0].length <= this.flat.text.length - 10) && (!this.test || this.test(i, n, t)))
          return this.value = { from: i, to: n, match: t }, this.matchPos = Qn(this.text, n + (i == n ? 1 : 0)), this;
      }
...
typeof Symbol < "u" && (Hc.prototype[Symbol.iterator] = Vc.prototype[Symbol.iterator] = function() {
  return this;
});
function zg(s) {
  try {
    return new RegExp(s, bo), !0;
  } catch {
    return !1;
  }
}
...
const qg = (s) => {
  let { state: e } = s, t = String(e.doc.lineAt(s.state.selection.main.head).number), { close: i, result: n } = sp(s, {
...
const Ug = /* @__PURE__ */ B.mark({ class: "cm-selectionMatch" }), Gg = /* @__PURE__ */ B.mark({ class: "cm-selectionMatch cm-selectionMatch-main" });
function Yl(s, e, t, i) {
  return (t == 0 || s(e.sliceDoc(t - 1, t)) != Q.Word) && (i == e.doc.length || s(e.sliceDoc(i, i + 1)) != Q.Word);
}
function Qg(s, e, t, i) {
  return s(e.sliceDoc(t, t + 1)) == Q.Word && s(e.sliceDoc(i - 1, i)) == Q.Word;
}
const Yg = /* @__PURE__ */ J.fromClass(class {
  constructor(s) {
    this.decorations = this.getDeco(s);
  }
  update(s) {
  ...
  getDeco(s) {
    let e = s.state.facet(Kg), { state: t } = s, i = t.selection;
    ...
    if (n.empty) {
      ...
      if (a < e.minSelectionLength || a > 200)
        return B.none;
      if (e.wholeWords) {
        if (r = t.sliceDoc(n.from, n.to), o = t.charCategorizer(n.head), !(Yl(o, t, n.from, n.to) && Qg(o, t, n.from, n.to)))
          return B.none;
    ...
    for (let a of s.visibleRanges) {
      ...
      for (; !h.next().done; ) {
        ...
        if ((!o || Yl(o, t, c, f)) && (n.empty && c <= n.from && f >= n.to ? l.push(Gg.range(c, f)) : (c >= n.to || f <= n.from) && l.push(Ug.range(c, f)), l.length > e.maxMatches))
          return B.none;
      }
    }
    return B.set(l);
  ...
  decorations: (s) => s.decorations
}), _g = /* @__PURE__ */ D.baseTheme({
  ".cm-selectionMatch": { backgroundColor: "#99ff7780" },
  ".cm-searchMatch .cm-selectionMatch": { backgroundColor: "transparent" }
}), Xg = ({ state: s, dispatch: e }) => {
  let { selection: t } = s, i = b.create(t.ranges.map((n) => s.wordAt(n.head) || b.cursor(n.head)), t.mainIndex);
  return i.eq(t) ? !1 : (e(s.update({ selection: i })), !0);
};
function Jg(s, e) {
  let { main: t, ranges: i } = s.selection, n = s.wordAt(t.head), r = n && n.from == t.from && n.to == t.to;
  for (let o = !1, l = new oi(s.doc, e, i[i.length - 1].to); ; )
    if (l.next(), l.done) {
      if (o)
        return null;
      l = new oi(s.doc, e, 0, Math.max(0, i[i.length - 1].from - 1)), o = !0;
    } else {
...
` : i == "r" ? "\r" : i == "t" ? "	" : "\\");
  ...
  */
  getCursor(e, t = 0, i) {
    let n = e.doc ? e : F.create({ doc: e });
    return i == null && (i = n.doc.length), this.regexp ? $t(this, n, t, i) : qt(this, n, t, i);
  }
}
class qc {
  constructor(e) {
...
function qt(s, e, t, i) {
  let n;
  return s.wholeWord && (n = t0(e.doc, e.charCategorizer(e.selection.main.head))), s.test && (n = e0(s.test, e, n)), new oi(e.doc, s.unquoted, t, i, s.caseSensitive ? void 0 : (r) => r.toLowerCase(), n);
}
function t0(s, e) {
  return (t, i, n, r) => ((r > t || r + n.length < i) && (r = Math.max(0, t - 2), n = s.sliceString(r, Math.min(s.length, i + 2))), (e(Yn(n, t - r)) != Q.Word || e(_n(n, t - r)) != Q.Word) && (e(_n(n, i - r)) != Q.Word || e(Yn(n, i - r)) != Q.Word));
}
class i0 extends qc {
  constructor(e) {
    super(e);
  ...
  nextMatch(e, t, i) {
    let n = qt(this.spec, e, i, e.doc.length).nextOverlapping();
    if (n.done) {
      let r = Math.min(e.doc.length, t + this.spec.unquoted.length);
      n = qt(this.spec, e, 0, r).nextOverlapping();
    }
  ...
  prevMatchInRange(e, t, i) {
    for (let n = i; ; ) {
      let r = Math.max(t, n - 1e4 - this.spec.unquoted.length), o = qt(this.spec, e, r, n), l = null;
  ...
  matchAll(e, t) {
    let i = qt(this.spec, e, 0, e.doc.length), n = [];
    for (; !i.next().done; ) {
      if (n.length >= t)
        return null;
      n.push(i.value);
...
function $t(s, e, t, i) {
  let n;
  return s.wholeWord && (n = s0(e.charCategorizer(e.selection.main.head))), s.test && (n = n0(s.test, e, n)), new Hc(e.doc, s.search, { ignoreCase: !s.caseSensitive, test: n }, t, i);
}
function Yn(s, e) {
  return s.slice(ne(s, e, !1), e);
}
function _n(s, e) {
  return s.slice(e, ne(s, e));
}
function s0(s) {
  return (e, t, i) => !i[0].length || (s(Yn(i.input, i.index)) != Q.Word || s(_n(i.input, i.index)) != Q.Word) && (s(_n(i.input, i.index + i[0].length)) != Q.Word || s(Yn(i.input, i.index + i[0].length)) != Q.Word);
}
class r0 extends qc {
  nextMatch(e, t, i) {
    let n = $t(this.spec, e, i, e.doc.length).next();
    return n.done && (n = $t(this.spec, e, 0, t).next()), n.done ? null : n.value;
  }
  prevMatchInRange(e, t, i) {
    for (let n = 1; ; n++) {
      let r = Math.max(
  ...
  matchAll(e, t) {
    let i = $t(this.spec, e, 0, e.doc.length), n = [];
    for (; !i.next().done; ) {
      if (n.length >= t)
        return null;
      n.push(i.value);
...
const Wi = /* @__PURE__ */ R.define(), xo = /* @__PURE__ */ R.define(), yt = /* @__PURE__ */ ae.define({
  create(s) {
    return new Ks(Vr(s).create(), null);
  },
  update(s, e) {
    for (let t of e.effects)
      t.is(Wi) ? s = new Ks(t.value.create(), s.panel) : t.is(xo) && (s = new Ks(s.query, t.value ? ko : null));
    return s;
  },
  provide: (s) => Li.from(s, (e) => e.panel)
});
class Ks {
  constructor(e, t) {
...
const o0 = /* @__PURE__ */ B.mark({ class: "cm-searchMatch" }), l0 = /* @__PURE__ */ B.mark({ class: "cm-searchMatch cm-searchMatch-selected" }), a0 = /* @__PURE__ */ J.fromClass(class {
  constructor(s) {
    this.view = s, this.decorations = this.highlight(s.state.field(yt));
  }
  update(s) {
    let e = s.state.field(yt);
    (e != s.startState.field(yt) || s.docChanged || s.selectionSet || s.viewportChanged) && (this.decorations = this.highlight(e));
  }
...
function Gi(s) {
  return (e) => {
    ...
    return t && t.query.spec.valid ? s(e, t) : jc(e);
  };
}
const Xn = /* @__PURE__ */ Gi((s, { query: e }) => {
  let { to: t } = s.state.selection.main, i = e.nextMatch(s.state, t, t);
  if (!i)
    return !1;
  let n = b.single(i.from, i.to), r = s.state.facet(hi);
  return s.dispatch({
    selection: n,
    effects: [wo(s, i), r.scrollToMatch(n.main, s)],
    userEvent: "select.search"
  }), Kc(s), !0;
}), Jn = /* @__PURE__ */ Gi((s, { query: e }) => {
  let { state: t } = s, { from: i } = t.selection.main, n = e.prevMatch(t, i, i);
  if (!n)
    return !1;
  let r = b.single(n.from, n.to), o = s.state.facet(hi);
  return s.dispatch({
    selection: r,
    effects: [wo(s, n), o.scrollToMatch(r.main, s)],
    userEvent: "select.search"
  }), Kc(s), !0;
}), h0 = /* @__PURE__ */ Gi((s, { query: e }) => {
  let t = e.matchAll(s.state, 1e3);
  return !t || !t.length ? !1 : (s.dispatch({
    selection: b.create(t.map((i) => b.range(i.from, i.to))),
    userEvent: "select.search.matches"
  }), !0);
}), c0 = ({ state: s, dispatch: e }) => {
  let t = s.selection;
  if (t.ranges.length > 1 || t.main.empty)
    return !1;
  let { from: i, to: n } = t.main, r = [], o = 0;
  for (let l = new oi(s.doc, s.sliceDoc(i, n)); !l.next().done; ) {
    if (r.length > 1e3)
      return !1;
  ...
  if (!r)
    return !1;
  let o = r, l = [], a, h, c = [];
  o.from == i && o.to == n && (h = t.toText(e.getReplacement(o)), l.push({ from: o.from, to: o.to, insert: h }), o = e.nextMatch(t, o.from, o.to), c.push(D.announce.of(t.phrase("replaced match on line $", t.doc.lineAt(i).number) + ".")));
  let f = s.state.changes(l);
  return o && (a = b.single(o.from, o.to).map(f), c.push(wo(s, o)), c.push(t.facet(hi).scrollToMatch(a.main, s))), s.dispatch({
    changes: f,
    selection: a,
    effects: c,
    userEvent: "input.replace"
  }), !0;
}), f0 = /* @__PURE__ */ Gi((s, { query: e }) => {
  if (s.state.readOnly)
    return !1;
...
function ko(s) {
  return s.state.facet(hi).createPanel(s);
}
function Vr(s, e) {
  var t, i, n, r, o;
...
const jc = (s) => {
  let e = s.state.field(yt, !1);
  if (e && e.panel) {
    let t = $c(s);
    if (t && t != s.root.activeElement) {
      let i = Vr(s.state, e.query.spec);
      i.valid && s.dispatch({ effects: Wi.of(i) }), t.focus(), t.select();
    }
  } else
    s.dispatch({ effects: [
      xo.of(!0),
      e ? Wi.of(Vr(s.state, e.query.spec)) : R.appendConfig.of(m0)
    ] });
  return !0;
}, Uc = (s) => {
  let e = s.state.field(yt, !1);
  if (!e || !e.panel)
    return !1;
  let t = oo(s, ko);
  return t && t.dom.contains(s.root.activeElement) && s.focus(), s.dispatch({ effects: xo.of(!1) }), !0;
}, u0 = [
  ...
  { key: "Escape", run: Uc, scope: "editor search-panel" },
  { key: "Mod-Shift-l", run: c0 },
  { key: "Mod-Alt-g", run: qg },
...
class d0 {
  constructor(e) {
    ...
    function i(n, r, o) {
      return q("button", { class: "cm-button", name: n, onclick: r, type: "button" }, o);
    }
    this.dom = q("div", { onkeydown: (n) => this.keydown(n), class: "cm-search" }, [
      this.searchField,
  ...
  keydown(e) {
    gd(this.view, e, "search-panel") ? e.preventDefault() : e.keyCode == 13 && e.target == this.searchField ? (e.preventDefault(), (e.shiftKey ? Jn : Xn)(this.view)) : e.keyCode == 13 && e.target == this.replaceField && (e.preventDefault(), _l(this.view));
  }
  update(e) {
    for (let t of e.transactions)
      for (let i of t.effects)
...
const mn = 30, gn = /[\s\.,:;?!]/;
function wo(s, { from: e, to: t }) {
  let i = s.state.doc.lineAt(e), n = s.state.doc.lineAt(t).to, r = Math.max(i.from, e - mn), o = Math.min(n, t + mn), l = s.state.sliceDoc(r, o);
  if (r != i.from) {
    for (let a = 0; a < mn; a++)
...
class Gc {
  ...
  */
  matchBefore(e) {
    let t = this.state.doc.lineAt(this.pos), i = Math.max(t.from, this.pos - 250), n = t.text.slice(i - t.from, this.pos - t.from), r = n.search(Qc(e, !1));
...
function y0(s) {
  let e = s.map((n) => typeof n == "string" ? { label: n } : n), [t, i] = e.every((n) => /^\w+$/.test(n.label)) ? [/\w*$/, /\w+$/] : g0(e);
  return (n) => {
...
class k0 {
  constructor(e) {
    ...
    for (let t = 0; t < e.length; ) {
      ...
      this.folded.push(ye(o == r ? r.toLowerCase() : o, 0)), t += n;
    }
  ...
  match(e) {
    ...
    if (t.length == 1) {
      let x = ye(e, 0), k = Ye(x), M = k == e.length ? 0 : -100;
      if (x != t[0]) if (x == i[0])
        M += -200;
      else
        return null;
      return this.ret(M, [0, k]);
    }
    ...
    let a = t.length, h = 0;
    if (l < 0) {
      for (let x = 0, k = Math.min(e.length, 200); x < k && h < a; ) {
        let M = ye(e, x);
        (M == t[h] || M == i[h]) && (n[h++] = x), x += Ye(M);
      }
      if (h < a)
        return null;
    }
    let c = 0, f = 0, u = !1, d = 0, p = -1, m = -1, g = /[a-z]/.test(e), y = !0;
    for (let x = 0, k = Math.min(e.length, 200), M = 0; x < k && f < a; ) {
      let w = ye(e, x);
      l < 0 && (c < a && w == t[c] && (r[c++] = x), d < a && (w == t[d] || w == i[d] ? (d == 0 && (p = x), m = x + 1, d++) : d = 0));
      let A, S = w < 255 ? w >= 48 && w <= 57 || w >= 97 && w <= 122 ? 2 : w >= 65 && w <= 90 ? 1 : 0 : (A = zr(w)) != A.toLowerCase() ? 1 : A != A.toUpperCase() ? 2 : 0;
      (!x || S == 1 && g || M == 0 && S != 0) && (t[f] == w || i[f] == w && (u = !0) ? o[f++] = x : o.length && (y = !1)), M = S, x += Ye(w);
    }
    return f == a && o[0] == 0 && y ? this.result(-100 + (u ? -200 : 0), o, e) : d == a && p == 0 ? this.ret(-200 - e.length + (m == e.length ? 0 : -100), [0, m]) : l > -1 ? this.ret(-700 - e.length, [l, l + this.pattern.length]) : d == a ? this.ret(-900 - e.length, [p, m]) : f == a ? this.result(-100 + (u ? -200 : 0) + -700 + (y ? 0 : -1100), o, e) : t.length == 2 ? null : this.result((n[0] ? -700 : 0) + -200 + -1100, n, e);
  }
  result(e, t, i) {
    let n = [], r = 0;
    for (let o of t) {
...
const ie = /* @__PURE__ */ T.define({
  combine(s) {
    return it(s, {
      ...
      closeOnBlur: (e, t) => e && t,
      icons: (e, t) => e && t,
      tooltipClass: (e, t) => (i) => ea(e(i), t(i)),
      optionClass: (e, t) => (i) => ea(e(i), t(i)),
...
function v0(s, e, t, i, n, r) {
  let o = s.textDirection == j.RTL, l = o, a = !1, h = "top", c, f, u = e.left - n.left, d = n.right - e.right, p = i.right - i.left, m = i.bottom - i.top;
  if (l && u < Math.min(p, d) ? l = !1 : !l && d < Math.min(p, u) && (l = !0), p <= (l ? u : d))
    c = Math.max(n.top, Math.min(t.top, n.bottom - m)) - e.top, f = Math.min(400, l ? u : d);
  else {
    a = !0, f = Math.min(
      400,
...
class C0 {
  constructor(e, t, i) {
    ...
    let n = e.state.field(t), { options: r, selected: o } = n.open, l = e.state.facet(ie);
    this.optionContent = S0(l), this.optionClass = l.optionClass, this.tooltipClass = l.tooltipClass, this.range = js(r.length, o, l.maxRenderedOptions), this.dom = document.createElement("div"), this.dom.className = "cm-tooltip-autocomplete", this.updateTooltipClass(e.state), this.dom.addEventListener("mousedown", (a) => {
  ...
  update(e) {
    ...
    if (this.updateTooltipClass(e.state), i != n) {
      ...
      (!n.open || n.open.options != r) && (this.range = js(r.length, o, e.state.facet(ie).maxRenderedOptions), this.showOptions(r, i.id)), this.updateSel(), l != ((t = n.open) === null || t === void 0 ? void 0 : t.disabled) && this.dom.classList.toggle("cm-tooltip-autocomplete-disabled", !!l);
    }
  }
  ...
  updateSel() {
    ...
    if (i) {
      ...
      }).catch((l) => me(this.view.state, l, "completion info")) : (this.addInfoPane(o, n), i.setAttribute("aria-describedby", this.info.id));
    }
  }
  addInfoPane(e, t) {
    this.destroyInfo();
  ...
  measureInfo() {
    ...
    return n.top > Math.min(r.bottom, t.bottom) - 10 || n.bottom < Math.max(r.top, t.top) + 10 ? null : this.view.state.facet(ie).positionInfo(this.view, t, n, i, r, this.dom);
  }
  placeInfo(e) {
...
function O0(s, e) {
  ...
  for (let c of s)
    if (c.hasResult()) {
      ...
      if (c.result.filter === !1)
        ...
        let u = e.sliceDoc(c.from, c.to), d, p = o.filterStrict ? new w0(u) : new k0(u);
  ...
  for (let c of t.sort((f, u) => u.score - f.score || h(f.completion, u.completion))) {
    let f = c.completion;
    !a || a.label != f.label || a.detail != f.detail || a.type != null && f.type != null && a.type != f.type || a.apply != f.apply || a.boost != f.boost ? l.push(c) : ta(c.completion) > ta(a) && (l[l.length - 1] = c), a = c.completion;
  }
  return l;
}
class Gt {
  ...
  setSelected(e, t) {
    return e == this.selected || e >= this.options.length ? this : new Gt(this.options, ia(t, e), this.tooltip, this.timestamp, e, this.disabled);
  }
...
class es {
  ...
  static start() {
    return new es(P0, "cm-ac-" + Math.floor(Math.random() * 2e6).toString(36), null);
  }
  update(e) {
    let { state: t } = e, i = t.facet(ie), r = (i.override || t.languageDataAt("autocomplete", It(t)).map(x0)).map((a) => (this.active.find((c) => c.source == a) || new Re(
      a,
      this.active.some(
        (c) => c.state != 0
        /* State.Inactive */
    ...
    o && e.docChanged && (o = o.map(e.changes)), e.selection || r.some((a) => a.hasResult() && e.changes.touchesRange(a.from, a.to)) || !T0(r, this.active) || l ? o = Gt.build(r, t, this.id, o, i, l) : o && o.disabled && !r.some((a) => a.isPending) && (o = null), !o && r.every((a) => !a.isPending) && r.some((a) => a.hasResult()) && (r = r.map((a) => a.hasResult() ? new Re(
      a.source,
      0
      /* State.Inactive */
    ) : a));
    for (let a of e.effects)
      a.is(Xc) && (o = o && o.setSelected(a.value, this.id));
  ...
  get attrs() {
    return this.open ? this.open.attrs : this.active.length ? D0 : B0;
  }
}
function T0(s, e) {
  if (s == e)
...
class Re {
  ...
  update(e, t) {
    let i = _c(e, t), n = this;
    (i & 8 || i & 16 && this.touches(e)) && (n = new Re(
      n.source,
      0
      /* State.Inactive */
    )), i & 4 && n.state == 0 && (n = new Re(
      this.source,
      1
      /* State.Pending */
    )), n = n.updateFor(e, i);
...
class Zt extends Re {
  ...
  updateFor(e, t) {
    ...
    if (l > o || !n || t & 2 && (It(e.startState) == this.from || l < this.limit))
      return new Re(
        this.source,
        t & 4 ? 1 : 0
        /* State.Inactive */
    ...
    return R0(n.validFor, e.state, r, o) ? new Zt(this.source, this.explicit, a, n, r, o) : n.update && (n = n.update(n, r, o, new Gc(e.state, l, !1))) ? new Zt(this.source, this.explicit, a, n, n.from, (i = n.to) !== null && i !== void 0 ? i : It(e.state)) : new Re(this.source, 1, this.explicit);
  }
  map(e) {
...
function R0(s, e, t, i) {
  ...
  return typeof s == "function" ? s(n, t, i, e) : Qc(s, !0).test(n);
}
const vo = /* @__PURE__ */ R.define({
  map(s, e) {
    return s.map((t) => t.map(e));
  }
}), Xc = /* @__PURE__ */ R.define(), be = /* @__PURE__ */ ae.define({
  create() {
    return es.start();
  },
  update(s, e) {
  ...
  provide: (s) => [
    ro.from(s, (e) => e.tooltip),
    D.contentAttributes.from(s, (e) => e.attrs)
  ]
});
function So(s, e) {
  const t = e.completion.apply || e.completion.label;
  let i = s.state.field(be).active.find((n) => n.source == e.source);
  return i instanceof Zt ? (typeof t == "string" ? s.dispatch({
    ...b0(s.state, t, i.from, i.to),
    annotations: Yc.of(e.completion)
  }) : t(s, e.completion, i.from, i.to), !0) : !1;
}
const L0 = /* @__PURE__ */ A0(be, So);
function yn(s, e = "option") {
  return (t) => {
    let i = t.state.field(be, !1);
    if (!i || !i.open || i.open.disabled || Date.now() - i.open.timestamp < t.state.facet(ie).interactionDelay)
      return !1;
    let n = 1, r;
    e == "page" && (r = Rh(t, i.open.tooltip)) && (n = Math.max(2, Math.floor(r.dom.offsetHeight / r.dom.querySelector("li").offsetHeight) - 1));
    let { length: o } = i.open.options, l = i.open.selected > -1 ? i.open.selected + n * (s ? 1 : -1) : s ? 0 : o - 1;
    return l < 0 ? l = e == "page" ? 0 : o - 1 : l >= o && (l = e == "page" ? o - 1 : 0), t.dispatch({ effects: Xc.of(l) }), !0;
  };
}
const E0 = (s) => {
  let e = s.state.field(be, !1);
  return s.state.readOnly || !e || !e.open || e.open.selected < 0 || e.open.disabled || Date.now() - e.open.timestamp < s.state.facet(ie).interactionDelay ? !1 : So(s, e.open.options[e.open.selected]);
}, Us = (s) => s.state.field(be, !1) ? (s.dispatch({ effects: Zn.of(!0) }), !0) : !1, I0 = (s) => {
  let e = s.state.field(be, !1);
  return !e || !e.active.some(
    (t) => t.state != 0
    /* State.Inactive */
  ) ? !1 : (s.dispatch({ effects: Fi.of(null) }), !0);
};
class N0 {
  constructor(e, t) {
...
const W0 = 50, F0 = 1e3, H0 = /* @__PURE__ */ J.fromClass(class {
  constructor(s) {
    this.view = s, this.debounceUpdate = -1, this.running = [], this.debounceAccept = -1, this.pendingStart = !1, this.composing = 0;
    for (let e of s.state.field(be).active)
      e.isPending && this.startQuery(e);
  }
  update(s) {
    let e = s.state.field(be), t = s.state.facet(ie);
    if (!s.selectionSet && !s.docChanged && s.startState.field(be) == e)
      return;
    ...
    for (let r = 0; r < this.running.length; r++) {
      ...
      if (i || o.context.abortOnDocChange && s.docChanged || o.updates.length + s.transactions.length > W0 && Date.now() - o.time > F0) {
    ...
    this.debounceUpdate > -1 && clearTimeout(this.debounceUpdate), s.transactions.some((r) => r.effects.some((o) => o.is(Zn))) && (this.pendingStart = !0);
  ...
  startUpdate() {
    ...
    let { state: s } = this.view, e = s.field(be);
  ...
  startQuery(s) {
    let { state: e } = this.view, t = It(e), i = new Gc(e, t, s.explicit, this.view), n = new N0(s, i);
  ...
  scheduleAccept() {
    this.running.every((s) => s.done !== void 0) ? this.accept() : this.debounceAccept < 0 && (this.debounceAccept = setTimeout(() => this.accept(), this.view.state.facet(ie).updateSyncTime));
  }
  ...
  accept() {
    ...
    for (let n = 0; n < this.running.length; n++) {
      ...
      if (this.running.splice(n--, 1), r.done) {
        let l = It(r.updates.length ? r.updates[0].startState : this.view.state), a = Math.min(l, r.done.from + (r.active.explicit ? 0 : 1)), h = new Zt(r.active.source, r.active.explicit, a, r.done, r.done.from, (s = r.done.to) !== null && s !== void 0 ? s : l);
  ...
  eventHandlers: {
    blur(s) {
      ...
      if (e && e.tooltip && this.view.state.facet(ie).closeOnBlur) {
        let t = e.open && Rh(this.view, e.open.tooltip);
        (!t || !t.dom.contains(s.relatedTarget)) && setTimeout(() => this.view.dispatch({ effects: Fi.of(null) }), 10);
      }
    },
    compositionstart() {
      this.composing = 1;
...
}), V0 = typeof navigator == "object" && /* @__PURE__ */ /Win/.test(navigator.platform), z0 = /* @__PURE__ */ Vt.highest(/* @__PURE__ */ D.domEventHandlers({
  keydown(s, e) {
    let t = e.state.field(be, !1);
    if (!t || !t.open || t.open.disabled || t.open.selected < 0 || s.key.length > 1 || s.ctrlKey && !(V0 && s.altKey) || s.metaKey)
      return !1;
    ...
    return r && r.indexOf(s.key) > -1 && So(e, i), !1;
  }
})), q0 = /* @__PURE__ */ D.baseTheme({
  ...
  map(s, e) {
    let t = e.mapPos(s, -1, pe.TrackAfter);
    return t ?? void 0;
  }
...
const Jc = /* @__PURE__ */ ae.define({
  ...
  update(s, e) {
    ...
    for (let t of e.effects)
      t.is(Lt) && (s = s.update({ add: [Co.range(t.value, t.value + 1)] }));
    return s;
  }
});
function $0() {
...
function Zc(s) {
  for (let e = 0; e < Gs.length; e += 2)
    if (Gs.charCodeAt(e) == s)
      return Gs.charAt(e + 1);
  return zr(s < 128 ? s : s + 1);
}
function ef(s, e) {
  return s.languageDataAt("closeBrackets", e)[0] || Hi;
}
const K0 = typeof navigator == "object" && /* @__PURE__ */ /Android\b/.test(navigator.userAgent), j0 = /* @__PURE__ */ D.inputHandler.of((s, e, t, i) => {
  if ((K0 ? s.composing : s.compositionStarted) || s.state.readOnly)
    return !1;
  let n = s.state.selection.main;
  if (i.length > 2 || i.length == 2 && Ye(ye(i, 0)) == 1 || e != n.from || t != n.to)
    return !1;
  let r = Q0(s.state, i);
  return r ? (s.dispatch(r), !0) : !1;
}), U0 = ({ state: s, dispatch: e }) => {
  if (s.readOnly)
    return !1;
  let i = ef(s, s.selection.main.head).brackets || Hi.brackets, n = null, r = s.changeByRange((o) => {
    if (o.empty) {
      let l = Y0(s.doc, o.head);
      for (let a of i)
        if (a == l && bs(s.doc, o.head) == Zc(ye(a, 0)))
          return {
  ...
  { key: "Backspace", run: U0 }
];
function Q0(s, e) {
  let t = ef(s, s.selection.main.head), i = t.brackets || Hi.brackets;
  for (let n of i) {
    let r = Zc(ye(n, 0));
    if (e == n)
      return r == n ? J0(s, n, i.indexOf(n + n + n) > -1, t) : _0(s, n, r, t.before || Hi.before);
    if (e == r && tf(s, s.selection.main.from))
      return X0(s, n, r);
  }
  return null;
}
function tf(s, e) {
  let t = !1;
  return s.field(Jc).between(0, s.doc.length, (i) => {
    i == e && (t = !0);
  }), t;
}
function bs(s, e) {
...
function X0(s, e, t) {
  let i = null, n = s.changeByRange((r) => r.empty && bs(s.doc, r.head) == t ? {
...
function J0(s, e, t, i) {
  let n = i.stringPrefixes || Hi.stringPrefixes, r = null, o = s.changeByRange((l) => {
    ...
    if (h == e) {
      ...
      if (t && s.sliceDoc(a - 2 * e.length, a) == e + e && (c = sa(s, a - 2 * e.length, n)) > -1 && na(s, c))
        return {
          changes: { insert: e + e + e + e, from: a },
          effects: Lt.of(a + e.length),
          range: b.cursor(a + e.length)
        };
      if (s.charCategorizer(a)(h) != Q.Word && sa(s, a, n) > -1 && !Z0(s, a, e, n))
        return {
          changes: { insert: e + e, from: a },
          effects: Lt.of(a + e.length),
          range: b.cursor(a + e.length)
...
function na(s, e) {
  let t = ce(s).resolveInner(e + 1);
  return t.parent && t.from == e;
}
function Z0(s, e, t, i) {
  let n = ce(s).resolveInner(e, -1), r = i.reduce((o, l) => Math.max(o, l.length), 0);
  for (let o = 0; o < 5; o++) {
    let l = s.sliceDoc(n.from, Math.min(n.to, n.from + t.length + r)), a = l.indexOf(t);
    if (!a || a > -1 && i.indexOf(l.slice(0, a)) > -1) {
      let c = n.firstChild;
      for (; c && c.from == n.from && c.to - c.from > t.length + a; ) {
        if (s.sliceDoc(c.to - t.length, c.to) == t)
          return !1;
        c = c.firstChild;
      }
      return !0;
...
function sa(s, e, t) {
  ...
  if (i(s.sliceDoc(e - 1, e)) != Q.Word)
    return e;
  for (let n of t) {
    let r = e - n.length;
    if (s.sliceDoc(r, e) == n && i(s.sliceDoc(r - 1, r)) != Q.Word)
      return r;
  }
  return -1;
}
...
const nf = [
  ...
  { key: "Enter", run: E0 }
], ty = /* @__PURE__ */ Vt.highest(/* @__PURE__ */ no.computeN([ie], (s) => s.facet(ie).defaultKeymap ? [nf] : []));
class ra {
  constructor(e, t, i) {
...
class Bt {
  ...
  static init(e, t, i) {
    let n = i.facet(et).markerFilter;
    n && (e = n(e, i));
    let r = e.slice().sort((d, p) => d.from - p.from || d.to - p.to), o = new ot(), l = [], a = 0, h = i.doc.iter(), c = 0, f = i.doc.length;
    for (let d = 0; ; ) {
      ...
      let m, g;
      if (l.length)
        m = a, g = l.reduce((k, M) => Math.min(k, M.to), p && p.from > m ? p.from : 1e8);
      else {
        if (m = p.from, m > f)
          break;
        g = p.to, l.push(p), d++;
      ...
      for (; d < r.length; ) {
        let k = r[d];
        if (k.from == m && (k.to > k.from || k.to == m))
          l.push(k), d++, g = Math.min(k.to, g);
        else {
          g = Math.min(k.from, g);
          break;
        }
      ...
      g = Math.min(g, f);
      let y = !1;
      if (l.some((k) => k.from == m && (k.to == g || g == f)) && (y = m == g, !y && g - m < 10)) {
      ...
      if (y)
        ...
        let k = l.reduce((M, w) => w.markClass ? M + " " + w.markClass : M, "");
        o.add(m, g, B.mark({
          class: "cm-lintRange cm-lintRange-" + x + k,
          diagnostics: l.slice(),
...
function Ct(s, e = null, t = 0) {
  let i = null;
  return s.between(t, 1e9, (n, r, { spec: o }) => {
    if (!(e && o.diagnostics.indexOf(e) < 0))
      if (!i)
        i = new ra(n, r, e || o.diagnostics[0]);
      else {
        if (o.diagnostics.indexOf(i.diagnostic) < 0)
          return !1;
        i = new ra(i.from, r, i.diagnostic);
      }
  }), i;
}
function iy(s, e) {
  let t = e.pos, i = e.end || t, n = s.state.facet(et).hideOn(s, t, i);
  if (n != null)
    return n;
  let r = s.startState.doc.lineAt(e.pos);
  return !!(s.effects.some((o) => o.is(Ao)) || s.changes.touchesRange(r.from, Math.max(r.to, i)));
}
function sf(s, e) {
  return s.field(Me, !1) ? e : e.concat(R.appendConfig.of(af));
}
function ny(s, e) {
  return {
    effects: sf(s, [Ao.of(e)])
  };
}
const Ao = /* @__PURE__ */ R.define(), Mo = /* @__PURE__ */ R.define(), rf = /* @__PURE__ */ R.define(), Me = /* @__PURE__ */ ae.define({
  create() {
    return new Bt(B.none, null, null);
  },
  update(s, e) {
    if (e.docChanged && s.diagnostics.size) {
      ...
      if (s.selected) {
        ...
        i = Ct(t, s.selected.diagnostic, r) || Ct(t, null, r);
      }
      !t.size && n && e.state.facet(et).autoPanel && (n = null), s = new Bt(t, n, i);
    }
    for (let t of e.effects)
      if (t.is(Ao)) {
        let i = e.state.facet(et).autoPanel ? t.value.length ? Vi.open : null : s.panel;
        s = Bt.init(t.value, i, e.state);
      } else t.is(Mo) ? s = new Bt(s.diagnostics, t.value ? Vi.open : null, s.selected) : t.is(rf) && (s = new Bt(s.diagnostics, s.panel, t.value));
    return s;
  },
  provide: (s) => [
    Li.from(s, (e) => e.panel),
    D.decorations.from(s, (e) => e.diagnostics)
  ]
}), sy = /* @__PURE__ */ B.mark({ class: "cm-lintRange cm-lintRange-active" });
function ry(s, e, t) {
  let { diagnostics: i } = s.state.field(Me), n, r = -1, o = -1;
  i.between(e - (t < 0 ? 1 : 0), e + (t > 0 ? 1 : 0), (a, h, { spec: c }) => {
    if (e >= a && e <= h && (a == h || (e > a || t > 0) && (e < h || t < 0)))
      return n = c.diagnostics, r = a, o = h, !1;
  });
  let l = s.state.facet(et).tooltipFilter;
...
function oy(s, e) {
  return q("ul", { class: "cm-tooltip-lint" }, e.map((t) => lf(s, t, !1)));
}
const ly = (s) => {
  let e = s.state.field(Me, !1);
  (!e || !e.panel) && s.dispatch({ effects: sf(s.state, [Mo.of(!0)]) });
  let t = oo(s, Vi.open);
  return t && t.dom.querySelector(".cm-panel-lint ul").focus(), !0;
}, oa = (s) => {
  let e = s.state.field(Me, !1);
  return !e || !e.panel ? !1 : (s.dispatch({ effects: Mo.of(!1) }), !0);
}, ay = (s) => {
  let e = s.state.field(Me, !1);
  if (!e)
    return !1;
  let t = s.state.selection.main, i = Ct(e.diagnostics, null, t.to + 1);
  return !i && (i = Ct(e.diagnostics, null, 0), !i || i.from == t.from && i.to == t.to) ? !1 : (s.dispatch({ selection: { anchor: i.from, head: i.to }, scrollIntoView: !0 }), !0);
}, hy = [
  { key: "Mod-Shift-m", run: ly, preventDefault: !0 },
  { key: "F8", run: ay }
], cy = /* @__PURE__ */ J.fromClass(class {
  constructor(s) {
    this.view = s, this.timeout = -1, this.set = !0;
    let { delay: e } = s.state.facet(et);
  ...
  run() {
    ...
    if (s < this.lintTime - 10)
      ...
      t.length && fy(t.map((i) => Promise.resolve(i(this.view))), (i) => {
        this.view.state.doc == e.doc && this.view.dispatch(ny(this.view.state, i.reduce((n, r) => n.concat(r))));
      }, (i) => {
  ...
  update(s) {
    let e = s.state.facet(et);
    (s.docChanged || e != s.startState.facet(et) || e.needsRefresh && e.needsRefresh(s)) && (this.lintTime = Date.now() + e.delay, this.set || (this.set = !0, this.timeout = setTimeout(this.run, e.delay)));
  }
  force() {
...
function fy(s, e, t) {
  ...
  for (let r of s)
    r.then((o) => {
      i.push(o), clearTimeout(n), i.length == s.length ? e(i) : n = setTimeout(() => e(i), 200);
    }, t);
}
...
function lf(s, e, t) {
  var i;
  let n = t ? of(e.actions) : [];
  return q("li", { class: "cm-diagnostic cm-diagnostic-" + e.severity }, q("span", { class: "cm-diagnosticText" }, e.renderMessage ? e.renderMessage(s) : e.message), (i = e.actions) === null || i === void 0 ? void 0 : i.map((r, o) => {
    let l = !1, a = (d) => {
      if (d.preventDefault(), l)
        return;
      l = !0;
      let p = Ct(s.state.field(Me).diagnostics, e);
...
class aa {
  constructor(e, t) {
    this.diagnostic = t, this.id = "item_" + Math.floor(Math.random() * 4294967295).toString(16), this.dom = lf(e, t, !0), this.dom.id = this.id, this.dom.setAttribute("role", "option");
  }
}
class Vi {
  constructor(e) {
    ...
    let t = (n) => {
      if (!(n.ctrlKey || n.altKey || n.metaKey)) {
        if (n.keyCode == 27)
          ...
          let { diagnostic: r } = this.items[this.selectedIndex], o = of(r.actions);
  ...
  update() {
    let { diagnostics: e, selected: t } = this.view.state.field(Me), i = 0, n = !1, r = null, o = /* @__PURE__ */ new Set();
    for (e.between(0, this.view.state.doc.length, (l, a, { spec: h }) => {
      for (let c of h.diagnostics) {
        ...
        f < 0 ? (u = new aa(this.view, c), this.items.splice(i, 0, u), n = !0) : (u = this.items[f], f > i && (this.items.splice(i, f - i), n = !0)), t && u.diagnostic == t.diagnostic ? u.dom.hasAttribute("aria-selected") || (u.dom.setAttribute("aria-selected", "true"), r = u) : u.dom.hasAttribute("aria-selected") && u.dom.removeAttribute("aria-selected"), i++;
      }
    }); i < this.items.length && !(this.items.length == 1 && this.items[0].diagnostic.from < 0); )
      n = !0, this.items.pop();
    this.items.length == 0 && (this.items.push(new aa(this.view, {
      from: -1,
      to: -1,
      severity: "info",
...
function py(s, e = 'viewBox="0 0 40 40"') {
  return `url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" ${e}>${encodeURIComponent(s)}</svg>')`;
}
function bn(s) {
  return py(`<path d="m0 2.5 l2 -1.5 l1 0 l2 1.5 l1 0" stroke="${s}" fill="none" stroke-width=".7"/>`, 'width="6" height="3"');
}
const my = /* @__PURE__ */ D.baseTheme({
  ".cm-diagnostic": {
...
const af = [
  Me,
  /* @__PURE__ */ D.decorations.compute([Me], (s) => {
    let { selected: e, panel: t } = s.field(Me);
    return !e || !t || e.from == e.to ? B.none : B.set([
      sy.range(e.from, e.to)
    ]);
  }),
  /* @__PURE__ */ ip(ry, { hideOn: iy }),
  my
], by = [
  mp(),
  bp(),
...
class ts {
  ...
  @internal
  */
  constructor(e, t, i, n, r, o, l, a, h, c = 0, f) {
    this.p = e, this.stack = t, this.state = i, this.reducePos = n, this.pos = r, this.score = o, this.buffer = l, this.bufferBase = a, this.curContext = h, this.lookAhead = c, this.parent = f;
  }
  /**
  @internal
  */
  ...
  */
  static start(e, t, i = 0) {
    ...
    return new ts(e, [], t, i, i, 0, [], 0, n ? new ha(n, n.start) : null, 0, null);
  }
  /**
  ...
  */
  reduce(e) {
    var t;
    let i = e >> 19, n = e & 65535, { parser: r } = this.p, o = this.reducePos < this.pos - 25 && this.setLookAhead(this.pos), l = r.dynamicPrecedence(n);
  ...
  */
  shift(e, t, i, n) {
    if (e & 131072)
      ...
      !l && (n > i || t <= o.maxNode) && (this.reducePos = n), this.pushState(r, l ? i : Math.min(i, this.reducePos)), this.shiftContext(t, i), t <= o.maxNode && this.buffer.push(t, i, n, 4);
    } else
  ...
  */
  split() {
    ...
    for (; e && n == e.bufferBase; )
      e = e.parent;
    return new ts(this.p, this.stack.slice(), this.state, this.reducePos, this.pos, this.score, i, n, this.curContext, this.lookAhead, e);
  }
  ...
  */
  ...
  updateContext(e) {
    if (e != this.curContext.context) {
      let t = new ha(this.curContext.tracker, e);
...
class ky {
  ...
  */
  constructor(e, t) {
    this.input = e, this.ranges = t, this.chunk = "", this.chunkOff = 0, this.chunk2 = "", this.chunk2Pos = 0, this.next = -1, this.token = ca, this.rangeIndex = 0, this.pos = this.chunkPos = t[0].from, this.range = t[0], this.end = t[t.length - 1].to, this.readNext();
  }
  /**
  @internal
  */
  ...
  */
  reset(e, t) {
    if (t ? (this.token = t, t.start = e, t.lookAhead = e + 1, t.value = t.extended = -1) : this.token = ca, this.pos != e) {
...
function wy(s, e, t, i, n, r) {
  ...
  e: for (; (l & s[o]) != 0; ) {
    ...
    for (let d = o + 3; d < h; d += 2)
      if ((s[d + 1] & l) > 0) {
        let p = s[d];
        if (a.allows(p) && (e.token.value == -1 || e.token.value == p || vy(p, e.token.value, n, r))) {
          e.acceptToken(p);
          break;
        }
      }
    let c = e.next, f = 0, u = s[o + 2];
    if (e.next < 0 && u > f && s[h + u * 3 - 3] == 65535) {
      o = s[h + u * 3 - 1];
      continue e;
    }
    for (; f < u; ) {
...
class Sy {
  ...
  nextFragment() {
    ...
    if (e) {
      for (this.safeFrom = e.openStart ? ua(e.tree, e.from + e.offset, 1) - e.offset : e.from, this.safeTo = e.openEnd ? ua(e.tree, e.to + e.offset, -1) - e.offset : e.to; this.trees.length; )
...
class Ay {
  constructor(e, t, i, n) {
    this.parser = e, this.input = t, this.ranges = n, this.recovering = 0, this.nextStackID = 9812, this.minStackPos = 0, this.reused = [], this.stoppedAt = null, this.lastBigReductionStart = -1, this.lastBigReductionSize = 0, this.bigReductionCount = 0, this.stream = new ky(t, n), this.tokens = new Cy(e, this.stream), this.topTerm = e.top[1];
    let { from: r } = n[0];
    this.stacks = [ts.start(this, e.top[0], r)], this.fragments = i.length && this.stream.end - r > e.bufferLength * 4 ? new Sy(i, e.nodeSet) : null;
  }
  get parsedPos() {
  ...
  advance() {
    ...
    if (!i.length) {
      ...
      if (this.parser.strict)
        throw Ce && n && console.log("Stuck with token " + (this.tokens.mainToken ? this.parser.getName(this.tokens.mainToken.value) : "none")), new SyntaxError("No parse at " + t);
  ...
  advanceStack(e, t, i) {
    let n = e.pos, { parser: r } = this, o = Ce ? this.stackID(e) + " -> " : "";
  ...
  runRecovery(e, t, i) {
    ...
    for (let o = 0; o < e.length; o++) {
      ...
      this.stream.end > l.pos ? (h == l.pos && (h++, a = 0), l.recoverByDelete(a, h), Ce && console.log(c + this.stackID(l) + ` (via recover-delete ${this.parser.getName(a)})`), da(l, i)) : (!n || n.score < f.score) && (n = f);
    }
    return n;
  }
...
class ns extends qh {
  ...
  */
  constructor(e) {
    ...
    this.nodeSet = new lo(t.map((l, a) => we.define({
    ...
    }))), e.propSources && (this.nodeSet = this.nodeSet.extend(...e.propSources)), this.strict = !1, this.bufferLength = Fh;
    let o = xn(e.tokenData);
    this.context = e.context, this.specializerSpecs = e.specialized || [], this.specialized = new Uint16Array(this.specializerSpecs.length);
    for (let l = 0; l < this.specializerSpecs.length; l++)
      this.specialized[l] = this.specializerSpecs[l].term;
    this.specializers = this.specializerSpecs.map(pa), this.states = xn(e.states, Uint32Array), this.data = xn(e.stateData), this.goto = xn(e.goto), this.maxTerm = e.maxTerm, this.tokenizers = e.tokenizers.map((l) => typeof l == "number" ? new ei(o, l) : l), this.topRules = e.topRules, this.dialects = e.dialects || {}, this.dynamicPrecedences = e.dynamicPrecedences || null, this.tokenPrecTable = e.tokenPrec, this.termNames = e.termNames || null, this.maxNode = this.nodeSet.types.length - 1, this.dialect = this.parseDialect(), this.top = this.topRules[Object.keys(this.topRules)[0]];
  }
  createParse(e, t, i) {
    let n = new Ay(this, e, t, i);
  ...
  */
  configure(e) {
    ...
    return e.tokenizers && (t.tokenizers = this.tokenizers.map((i) => {
      ...
      return t.specializers[n] = pa(o), o;
...
const Ty = $h({
  ...
  try {
    JSON.parse(s.state.doc.toString());
  } catch (e) {
    if (!(e instanceof SyntaxError))
      throw e;
    const t = Py(e, s.state.doc);
    return [{
      from: t,
      message: e.message,
      severity: "error",
...
function Py(s, e) {
  let t;
  return (t = s.message.match(/at position (\d+)/)) ? Math.min(+t[1], e.length) : (t = s.message.match(/at line (\d+) column (\d+)/)) ? Math.min(e.line(+t[1]).from + +t[2] - 1, e.length) : 0;
}
const Ry = /* @__PURE__ */ qn.define({
  name: "json",
  parser: /* @__PURE__ */ Dy.configure({
    props: [
      /* @__PURE__ */ Gh.add({
...
((s, e) => {
  s.behaviors.aiJsonSchemaEditor = {
    attach(t) {
      e(
        ...
        const r = n.getAttribute("data-ai-json-schema-editor"), o = document.querySelector(
        ...
        if (!o)
          return;
        l && (l.style.display = "none", l.removeAttribute("name")), n.style.display = "";
        let a = o.value || "";
        if (a)
          try {
